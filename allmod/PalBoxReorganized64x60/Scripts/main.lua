...
print(palConfig.palRedColorWrapperFront .. "[" .. palConfig.palModName .. "] Slots per box set to " .. palConfig.PalBoxSlotNumInPage .. palConfig.palRedColorWrapperBack)
    ...
    NotifyOnNewObject("/Script/Pal.PalPlayerDataPalStorage", function(Context)
            ExecuteWithDelay(5000,function()
                Context.PageNum  = palConfig.PalBoxPageNum
				Context.SlotNumInPage  = palConfig.PalBoxSlotNumInPage
            end)
        end)
end)

-- made by XxInvictus and Borchev
