...
| Ключ | Нужен? | Препятствия в зоне 2×2 → X=9 |
|---|---|---|
| Normal_0 | ★ да (базовый пак) | (1,1) |
| Easy_1 | ★ да | (0,1), (1,1) |
| Easy_2 | ★ да | — |
| Easy_3 | ★ да | (1,0) |
| Easy_4 | ★ да | (0,0) |
...
| Easy_14 | ★ да | (1,0) |
| Easy_15 | ★ да | — |
| остальные 14 (Easy_0, Normal_1–8, Hard_0, VeryEasy_0, VeryHard_0–2) | нет (паков с ними нет) | по тому же рецепту, для порядка |
