...
class UBP_ActionGeneralAttackBase_C : public UPalActionWazaBase
{
    ...
    TArray<FSkillEffectSpawnParameter> SkillEffectSpawnParameters;                    // 0x0188 (size: 0x10)
    TArray<FSkillEffectSpawnParameter> GeneralEffectSpawnParameters;                  // 0x0198 (size: 0x10)
    ...
    EPalGeneralMontageType ReadyAnimationType;                                        // 0x01E8 (size: 0x1)
    EPalGeneralMontageType ReadyLoopAnimationType;                                    // 0x01E9 (size: 0x1)
    EPalGeneralMontageType ProcessAnimationType;                                      // 0x01EA (size: 0x1)
    EPalGeneralMontageType ProcessLoopAnimationType;                                  // 0x01EB (size: 0x1)
    EPalGeneralMontageType AfterAnimationType;                                        // 0x01EC (size: 0x1)
    class UPalStaticCharacterParameterComponent* StaticCharacterComponent;            // 0x01F0 (size: 0x8)
    FName flagName;                                                                   // 0x01F8 (size: 0x8)
    bool IsDisableMovement;                                                           // 0x0200 (size: 0x1)
    double BeginMovementDisableTime;                                                  // 0x0208 (size: 0x8)
    double EndMovementDisableTimeFromEnd;                                             // 0x0210 (size: 0x8)
    double YawRate;                                                                   // 0x0218 (size: 0x8)
    double BreakActionBlendTime;                                                      // 0x0220 (size: 0x8)
    double MovementStartOffset;                                                       // 0x0228 (size: 0x8)
    double MovementTime;                                                              // 0x0230 (size: 0x8)
    double MovementTimer;                                                             // 0x0238 (size: 0x8)
    class UCurveFloat* MovementCurve;                                                 // 0x0240 (size: 0x8)
    double MovementPerSec;                                                            // 0x0248 (size: 0x8)
    bool IsUseMontageFacialNotify;                                                    // 0x0250 (size: 0x1)
    bool EnableShorteningAnimationTimeWhenPalRidden;                                  // 0x0251 (size: 0x1)
    bool IsFindTargetOnRiding;                                                        // 0x0252 (size: 0x1)
    double FindTargetHeight;                                                          // 0x0258 (size: 0x8)
    double FindTargetDegree;                                                          // 0x0260 (size: 0x8)
    double FindTargetDistance;                                                        // 0x0268 (size: 0x8)
    FBP_ActionGeneralAttackBase_COnProcess OnProcess;                                 // 0x0270 (size: 0x10)
    void OnProcess();
    ...
    void Shorten Animation Time when Pal Ridden();
