...
{
    class UBoxComponent* BackgroundCheckOverlapCollision;                             // 0x0770 (size: 0x8)
    class UBP_BuildObjectSimulateArrowComponent_C* BP_BuildObjectSimulateArrowComponent; // 0x0778 (size: 0x8)
    class UPalMapObjectMedicalPalBedPalLocationComponent* tMedicalPalBedPalLocation;  // 0x0780 (size: 0x8)
    class UPalMapObjectMedicalPalBedSleepOnSideLocationOffsetComponent* MedicalPalBedSleepOnSideLocationOffset; // 0x0788 (size: 0x8)
    class UPalMapObjectPlayerBedParameterSceneComponent* PlayerBedParameterScene;     // 0x0790 (size: 0x8)
    class USceneComponent* IndicatorOrigin;                                           // 0x0798 (size: 0x8)
    class UPalMapObjectMedicalPalBedParameterComponent* MedicalPalBedParameter;       // 0x07A0 (size: 0x8)
