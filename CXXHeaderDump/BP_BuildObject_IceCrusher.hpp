#ifndef UE4SS_SDK_BP_BuildObject_IceCrusher_HPP
#define UE4SS_SDK_BP_BuildObject_IceCrusher_HPP

class ABP_BuildObject_IceCrusher_C : public APalBuildObject
{
    ...
    class UPalMapObjectItemConverterParameterComponent* ItemConverterParameter;       // 0x07A8 (size: 0x8)
