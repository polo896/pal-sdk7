...
class UWBP_RaidBossMenuSelectItem_C : public UPalUserWidgetOverlayUI
{
    ...
    class UWBP_Altar_SelectItem_C* WBP_Altar_SelectItem;                              // 0x0488 (size: 0x8)
    class UWBP_Altar_SelectItem_Button_C* LastSelectedSlot;                           // 0x0490 (size: 0x8)
    TArray<FPalDataTableRowName_ItemData> WarningUltraRaidItemId;                     // 0x0498 (size: 0x10)
    FDataTableRowHandle WarningUltraRaidMsgId;                                        // 0x04A8 (size: 0x10)
