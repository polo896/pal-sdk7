...
class ABP_SquadNPCSpawner_C : public ABP_MonoNPCSpawner_C
{
    ...
    TArray<class UPalIndividualCharacterHandle*> SpawnedHandleList;                   // 0x0620 (size: 0x10)
    TArray<FF_NPCOnePointSpawnInfo> SpawnInfoList;                                    // 0x0630 (size: 0x10)
    bool IsLoadingFlag;                                                               // 0x0640 (size: 0x1)
    TArray<class UPalIndividualCharacterHandle*> SpawnedOtomoHandleList;              // 0x0648 (size: 0x10)
    int32 SpawnedCount;                                                               // 0x0658 (size: 0x4)
    FBP_SquadNPCSpawner_COnSquadSpawnedCharacter OnSquadSpawnedCharacter;             // 0x0660 (size: 0x10)
    void OnSquadSpawnedCharacter(class UPalIndividualCharacterHandle* NewParam);
    TArray<class UPalIndividualCharacterHandle*> Handles;                             // 0x0670 (size: 0x10)
