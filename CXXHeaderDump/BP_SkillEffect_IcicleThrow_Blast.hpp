...
class ABP_SkillEffect_IcicleThrow_Blast_C : public ABP_SkillEffectBase_C
{
    ...
    class UNiagaraComponent* Effect_Fragment;                                         // 0x0438 (size: 0x8)
    class UBoxComponent* AttackTrigger_Height;                                        // 0x0440 (size: 0x8)
    class USphereComponent* AttackTrigger_Inner;                                      // 0x0448 (size: 0x8)
    class USphereComponent* AttackTrigger_Outer;                                      // 0x0450 (size: 0x8)
    class USceneComponent* Group_Collision;                                           // 0x0458 (size: 0x8)
    class UNiagaraComponent* Effect_Blast;                                            // 0x0460 (size: 0x8)
    double ExpandSpeed;                                                               // 0x0468 (size: 0x8)
    TArray<class USphereComponent*> AttachedAttackCollisions;                         // 0x0470 (size: 0x10)
    TArray<class AActor*> ActorsInTrigger_Inner;                                      // 0x0480 (size: 0x10)
    TArray<class AActor*> ActorsInTrigger_Outer;                                      // 0x0490 (size: 0x10)
    TMap<class AActor*, class UPrimitiveComponent*> ActorsInTrigger_Height;           // 0x04A0 (size: 0x50)
    bool DrawDebugBlast;                                                              // 0x04F0 (size: 0x1)
    bool StartExpandInnerTrigger;                                                     // 0x04F1 (size: 0x1)
    class UCurveFloat* ExpandSpeedRateCurve;                                          // 0x04F8 (size: 0x8)
    double Timer;                                                                     // 0x0500 (size: 0x8)
    float CollisionLifetime;                                                          // 0x0508 (size: 0x4)
    TArray<class AActor*> AttackedActors;                                             // 0x0510 (size: 0x10)
