...
class ABP_BuildObject_BaseCampWorkHard_02_C : public APalBuildObject
{
    ...
    class UStaticMeshComponent* SM_SurveillanceTableAdvanced;                         // 0x0780 (size: 0x8)
    ...
    class UMaterialInstanceDynamic* WorkTypeMaterialInstance;                         // 0x07B8 (size: 0x8)
    class UPalMapObjectBaseCampPassiveWorkHardModel* WorkHardModel;                   // 0x07C0 (size: 0x8)
    class UPalBaseCampPassiveEffect_WorkHard* PassiveEffectWorkHard;                  // 0x07C8 (size: 0x8)
