...
class UWBP_CommonSelectNum_C : public UPalUISelectNumWidgetBase
{
    ...
    class UButton* Button_318;                                                        // 0x0488 (size: 0x8)
    class UCanvasPanel* CanvasPanel_58;                                               // 0x0490 (size: 0x8)
    class UEditableTextBox* EditableTextBox_0;                                        // 0x0498 (size: 0x8)
    class UImage* Image_454;                                                          // 0x04A0 (size: 0x8)
    class UButton* LeftButton;                                                        // 0x04A8 (size: 0x8)
    class UButton* rightButton;                                                       // 0x04B0 (size: 0x8)
    int64 NowCount;                                                                   // 0x04B8 (size: 0x8)
    int64 MaxCount;                                                                   // 0x04C0 (size: 0x8)
    FWBP_CommonSelectNum_COnRightButtonClicked OnRightButtonClicked;                  // 0x04C8 (size: 0x10)
    void OnRightButtonClicked();
    FWBP_CommonSelectNum_COnLeftButtonClicked OnLeftButtonClicked;                    // 0x04D8 (size: 0x10)
    void OnLeftButtonClicked();
    FWBP_CommonSelectNum_COnTextCommited OnTextCommited;                              // 0x04E8 (size: 0x10)
    void OnTextCommited(FString NewString);
    int32 MaxDigit;                                                                   // 0x04F8 (size: 0x4)
    class UPalUISelectNumParameter* Parameter;                                        // 0x0500 (size: 0x8)
