...
class UWBP_PalExpedition_C : public UPalUserWidgetOverlayUI
{
    ...
    class UWBP_Expedition_C* WBP_Expedition;                                          // 0x0498 (size: 0x8)
    class UWBP_PalCommonWindow_C* WBP_PalCommonWindow;                                // 0x04A0 (size: 0x8)
    FPalDataTableRowName_UIInputAction CancelActionHandle_Default;                    // 0x04A8 (size: 0x8)
    FPalDataTableRowName_UIInputAction CancelActionHandle_Escape;                     // 0x04B0 (size: 0x8)
    FPalDataTableRowName_UIInputAction CancelActionHandle_Tab;                        // 0x04B8 (size: 0x8)
    TArray<FPalUIMapObjectCharacterTeamMissionIndividual> CachedAssignInfo;           // 0x04C0 (size: 0x10)
    bool AlreadyInternalSetup;                                                        // 0x04D0 (size: 0x1)
    double RightStickAxisY;                                                           // 0x04D8 (size: 0x8)
    double ScrollPerSecond;                                                           // 0x04E0 (size: 0x8)
    FPalUIActionBindData FavoriteInputHandle;                                         // 0x04E8 (size: 0x4)
    FPalDataTableRowName_UIInputAction FavoriteShortcutInput;                         // 0x04EC (size: 0x8)
    class UPalIndividualCharacterSlot* CachedLastHoveredSlot;                         // 0x04F8 (size: 0x8)
