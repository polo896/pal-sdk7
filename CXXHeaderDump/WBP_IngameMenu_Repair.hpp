...
class UWBP_IngameMenu_Repair_C : public UUserWidget
{
    ...
    class UImage* Image_365;                                                          // 0x0290 (size: 0x8)
    class UImage* Image_1007;                                                         // 0x0298 (size: 0x8)
    class UImage* Image_Rarity;                                                       // 0x02A0 (size: 0x8)
    class UImage* Image_Rarity_1;                                                     // 0x02A8 (size: 0x8)
    class UImage* Image_TargetItemIcon;                                               // 0x02B0 (size: 0x8)
    class UOverlay* OverlayMaterialHead;                                              // 0x02B8 (size: 0x8)
    class UPalRetainerBox* PalRetainerBox_150;                                        // 0x02C0 (size: 0x8)
    class UProgressBar* ProgressBar_Durability;                                       // 0x02C8 (size: 0x8)
    class UBP_PalTextBlock_C* Text_RepairTargetItemName;                              // 0x02D0 (size: 0x8)
    class UVerticalBox* VerticalBox_TargetItemInfo;                                   // 0x02D8 (size: 0x8)
    class UWBP_IngameMenu_RepairAllButton_C* WBP_IngameMenu_RepairAllButton;          // 0x02E0 (size: 0x8)
    class UWBP_IngameMenu_RepairButton_C* WBP_IngameMenu_RepairButton;                // 0x02E8 (size: 0x8)
    class UWBP_IngameMenuConstruction_InfoItem_C* WBP_IngameMenuConstruction_InfoItem; // 0x02F0 (size: 0x8)
    class UWBP_IngameMenuConstruction_InfoItem_C* WBP_IngameMenuConstruction_InfoItem_1; // 0x02F8 (size: 0x8)
    class UWBP_IngameMenuConstruction_InfoItem_C* WBP_IngameMenuConstruction_InfoItem_2; // 0x0300 (size: 0x8)
    class UWBP_IngameMenuConstruction_InfoItem_C* WBP_IngameMenuConstruction_InfoItem_3; // 0x0308 (size: 0x8)
    class UWBP_IngameMenuConstruction_InfoItem_C* WBP_IngameMenuConstruction_InfoItem_4; // 0x0310 (size: 0x8)
    class UWBP_PalInGameMenuItemSlotButton_C* WBP_ItemSlotButton_BodyArmor;           // 0x0318 (size: 0x8)
    class UWBP_PalInGameMenuItemSlotButton_C* WBP_ItemSlotButton_HeadArmor;           // 0x0320 (size: 0x8)
    class UWBP_PalInGameMenuItemSlotButton_C* WBP_ItemSlotButton_Shield;              // 0x0328 (size: 0x8)
    class UWBP_PalInGameMenuItemSlotButton_C* WBP_ItemSlotButton_Weapon_00;           // 0x0330 (size: 0x8)
    class UWBP_PalInGameMenuItemSlotButton_C* WBP_ItemSlotButton_Weapon_01;           // 0x0338 (size: 0x8)
    class UWBP_PalInGameMenuItemSlotButton_C* WBP_ItemSlotButton_Weapon_02;           // 0x0340 (size: 0x8)
    class UWBP_PalInGameMenuItemSlotButton_C* WBP_ItemSlotButton_Weapon_03;           // 0x0348 (size: 0x8)
    class UWBP_PalInGameMenuItemSlotButton_C* WBP_ItemSlotButton_Weapon_04;           // 0x0350 (size: 0x8)
    class UWBP_PalInGameMenuItemSlotButton_C* WBP_ItemSlotButton_Weapon_05;           // 0x0358 (size: 0x8)
    class UWBP_Menu_btn_C* WBP_Menu_btn;                                              // 0x0360 (size: 0x8)
