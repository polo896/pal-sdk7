...
class UBP_Action_Coop_SpinningShell_C : public UPalActionBase
{
    ...
    class UAnimMontage* Montage_Start;                                                // 0x0168 (size: 0x8)
    class UAnimMontage* Montage_Loop;                                                 // 0x0170 (size: 0x8)
    class UAnimMontage* Montage_End;                                                  // 0x0178 (size: 0x8)
    class ABP_SkillEffect_Drillgame_SpiningShell_C* EffectActor;                      // 0x0180 (size: 0x8)
