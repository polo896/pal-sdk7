...
class UWBP_CharaCre_MenuButton_C : public UUserWidget
{
    ...
    TEnumAsByte<E_UICharacterMakeCategory::Type> BindCategory;                        // 0x02B8 (size: 0x1)
    TMap<TEnumAsByte<E_UICharacterMakeCategory::Type>, FDataTableRowHandle> MsgIDMap; // 0x02C0 (size: 0x50)
