#ifndef UE4SS_SDK_BP_DarkMechaDragon_HPP
#define UE4SS_SDK_BP_DarkMechaDragon_HPP

class ABP_DarkMechaDragon_C : public ABP_MonsterBase_C
{
    class UNiagaraComponent* WingEffect;                                              // 0x0D30 (size: 0x8)
