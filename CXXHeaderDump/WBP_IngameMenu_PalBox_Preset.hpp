...
class UWBP_IngameMenu_PalBox_Preset_C : public UPalUIOtomoLoadoutBase
{
    ...
    class UCanvasPanel* Canvas_MenuGuide;                                             // 0x0498 (size: 0x8)
    class UScrollBox* ScrollBox_0;                                                    // 0x04A0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_MenuGuide;                                         // 0x04A8 (size: 0x8)
    class UWBP_CommonSelectList_C* WBP_CommonSelectList;                              // 0x04B0 (size: 0x8)
    class UWBP_IngameMenu_PalBox_PalDetail_C* WBP_IngameMenu_PalBox_PalDetail;        // 0x04B8 (size: 0x8)
    class UWBP_PalKeyGuideIcon_C* WBP_PalKeyGuideIcon_1;                              // 0x04C0 (size: 0x8)
    int32 LastHoveredIndex;                                                           // 0x04C8 (size: 0x4)
    int32 LastPinedIndex;                                                             // 0x04CC (size: 0x4)
    FPalUIActionBindData RightClickDisplayAction;                                     // 0x04D0 (size: 0x4)
    class UWBP_IngameMenu_PalBox_PresetList_C* LastViewDetailLoadoutGroup;            // 0x04D8 (size: 0x8)
    TArray<FPalInstanceID> ReplicatedInstanceIds;                                     // 0x04E0 (size: 0x10)
    TMap<class FPalInstanceID, class UPalIndividualCharacterHandle*> ReplicateCharacterParameterMap; // 0x04F0 (size: 0x50)
    FPalInstanceID CurrentWaitSyncInstanceId;                                         // 0x0540 (size: 0x30)
