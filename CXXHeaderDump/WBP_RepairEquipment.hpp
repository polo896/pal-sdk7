...
class UWBP_RepairEquipment_C : public UPalUIRepairItemBase
{
    ...
    class UCircularThrobber* CircularThrobber_20;                                     // 0x0490 (size: 0x8)
    class UImage* Image_13;                                                           // 0x0498 (size: 0x8)
    class UOverlay* Overlay_Repairing;                                                // 0x04A0 (size: 0x8)
    class UWBP_IngameMenu_Repair_C* WBP_IngameMenu_Repair;                            // 0x04A8 (size: 0x8)
    TArray<class UPalItemSlot*> RepairTargetItemSlots;                                // 0x04B0 (size: 0x10)
    FDataTableRowHandle RepairFailedMsgID;                                            // 0x04C0 (size: 0x10)
    FTimerHandle RepairTimeoutTimerhandle;                                            // 0x04D0 (size: 0x8)
    FPalDataTableRowName_UIInputAction RepairAllInputAction;                          // 0x04D8 (size: 0x8)
    TArray<class UPalItemSlot*> CollectedAllRepairableSlotArray;                      // 0x04E0 (size: 0x10)
    TArray<FPalStaticItemIdAndNum> CollectedAllRepairMaterials;                       // 0x04F0 (size: 0x10)
    bool CanAllRepair;                                                                // 0x0500 (size: 0x1)
    FPalDataTableRowName_UIInputAction CancelActionHandle_Default;                    // 0x0504 (size: 0x8)
    FPalDataTableRowName_UIInputAction CancelActionHandle_Escape;                     // 0x050C (size: 0x8)
    FPalDataTableRowName_UIInputAction CancelActionHandle_Tab;                        // 0x0514 (size: 0x8)
