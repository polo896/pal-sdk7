...
class UBP_AIAction_CallBase_C : public UPalAIActionBase
{
    ...
    FName CallApproachSpeedName;                                                      // 0x0140 (size: 0x8)
    class APalCharacter* ApproachTarget;                                              // 0x0148 (size: 0x8)
    class APalCharacter* OwnerChara;                                                  // 0x0150 (size: 0x8)
    double WalkSpeedMulti;                                                            // 0x0158 (size: 0x8)
    bool IsSimpleMoveToActor;                                                         // 0x0160 (size: 0x1)
    FVector PrevTargetLocation;                                                       // 0x0168 (size: 0x18)
    TEnumAsByte<ECollisionChannel> CollisionChannel;                                  // 0x0180 (size: 0x1)
