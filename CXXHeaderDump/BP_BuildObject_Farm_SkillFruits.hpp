#ifndef UE4SS_SDK_BP_BuildObject_Farm_SkillFruits_HPP
#define UE4SS_SDK_BP_BuildObject_Farm_SkillFruits_HPP

class ABP_BuildObject_Farm_SkillFruits_C : public APalBuildObjectFarmSkillFruits
{
    class UBP_BuildObjectSimulateArrowComponent_C* BP_BuildObjectSimulateArrowComponent; // 0x0790 (size: 0x8)
    class UStaticMeshComponent* DebugTreeMesh;                                        // 0x0798 (size: 0x8)
    class UPalMapObjectFarmSkillFruitsParameterComponent* PalMapObjectFarmSkillFruitsParameter; // 0x07A0 (size: 0x8)
