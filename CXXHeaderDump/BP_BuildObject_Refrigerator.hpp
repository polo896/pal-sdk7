...
class ABP_BuildObject_Refrigerator_C : public APalBuildObject
{
    ...
    class UStaticMeshComponent* SM_FridgeLarge;                                       // 0x0778 (size: 0x8)
    class UPalMapObjectItemChestParameterComponent* PalMapObjectItemChestParameter;   // 0x0780 (size: 0x8)
