...
class UBP_AIAction_CombatPal_RaidBoss_LegendDeer_C : public UBP_AIAction_CombatPal_RaidBoss_C
{
    ...
    class UBP_Status_HPLock_C* HPLockStatus;                                          // 0x0280 (size: 0x8)
    TMap<TEnumAsByte<ENum_Raid_LegendDeer_CombatPhase::Type>, double> CombatPhaseMap; // 0x0288 (size: 0x50)
    TEnumAsByte<ENum_Raid_LegendDeer_CombatPhase::Type> CurrentPhase;                 // 0x02D8 (size: 0x1)
    bool ActPhaseChange;                                                              // 0x02D9 (size: 0x1)
    FTimerHandle PhaseCheckTimer;                                                     // 0x02E0 (size: 0x8)
    bool RandomBarrier_Grass;                                                         // 0x02E8 (size: 0x1)
    TArray<EPalWazaID> PhaseActWazaIds;                                               // 0x02F0 (size: 0x10)
