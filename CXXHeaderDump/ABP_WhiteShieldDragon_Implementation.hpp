#ifndef UE4SS_SDK_ABP_WhiteShieldDragon_Implementation_HPP
#define UE4SS_SDK_ABP_WhiteShieldDragon_Implementation_HPP
...
class UABP_WhiteShieldDragon_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_1;                                          // 0x1380 (size: 0x250)
    FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;       // 0x15D0 (size: 0x20)
    FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;       // 0x15F0 (size: 0x20)
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x1610 (size: 0x250)
    FAnimNode_Root AnimGraphNode_Root_2;                                              // 0x1860 (size: 0x20)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose_1;                        // 0x1880 (size: 0xC8)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose;                          // 0x1948 (size: 0xC8)
    FAnimNode_Root AnimGraphNode_Root_1;                                              // 0x1A10 (size: 0x20)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x1A30 (size: 0x20)
    double __CustomProperty_PositionAlpha_leg_front_03_l_Goal_1346B4824BDFB0B7275A14ACD718EFAE; // 0x1A50 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_front_03_r_Goal_1346B4824BDFB0B7275A14ACD718EFAE; // 0x1A58 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_back_04_l_Goal_1346B4824BDFB0B7275A14ACD718EFAE; // 0x1A60 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_back_04_r_Goal_1346B4824BDFB0B7275A14ACD718EFAE; // 0x1A68 (size: 0x8)
