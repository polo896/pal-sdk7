...
class UWBP_PalHUD_InGame_InputListener_C : public UPalUIInGameInputListener
{
    ...
    class UWBP_BulletChange_C* WBP_BulletChange;                                      // 0x0480 (size: 0x8)
    class UWBP_Ingame_Chat_Wrapper_C* WBP_Ingame_Chat_Wrapper;                        // 0x0488 (size: 0x8)
    class UWBP_InGame_Quest_StartClearSet_C* WBP_InGame_Quest_StartClearSet;          // 0x0490 (size: 0x8)
    class UWBP_Ingame_WeaponChange_C* WBP_Ingame_WeaponChange;                        // 0x0498 (size: 0x8)
    class UWBP_PalInteractiveObjectIndicatorCanvas_C* WBP_PalInteractiveObjectIndicatorCanvas; // 0x04A0 (size: 0x8)
    class UWBP_PlayerRadialMenu_C* WBP_PlayerRadialMenu;                              // 0x04A8 (size: 0x8)
    FPalDataTableRowName_UIInputAction EscapeActionName;                              // 0x04B0 (size: 0x8)
    FPalDataTableRowName_UIInputAction OpenCharacterMenuActionName;                   // 0x04B8 (size: 0x8)
    FPalDataTableRowName_UIInputAction OpenBuildMenuActionName;                       // 0x04C0 (size: 0x8)
    FPalDataTableRowName_UIInputAction OpenTechnologyMenuActionName;                  // 0x04C8 (size: 0x8)
    FPalDataTableRowName_UIInputAction OpenWorldMapActionName;                        // 0x04D0 (size: 0x8)
    FPalDataTableRowName_UIInputAction OpenPalStatusActionName;                       // 0x04D8 (size: 0x8)
    FPalUIActionBindData CharacterMenuActionHandle;                                   // 0x04E0 (size: 0x4)
    FPalDataTableRowName_UIInputAction OpenChatActionName;                            // 0x04E4 (size: 0x8)
    FPalUIActionBindData CharacterMenuAnotherActionHandle;                            // 0x04EC (size: 0x4)
    FPalUIActionBindData WorldMapActionHandle;                                        // 0x04F0 (size: 0x4)
    FPalUIActionBindData TechnologyMenuActionHandle;                                  // 0x04F4 (size: 0x4)
    FPalUIActionBindData PalStatusActionHandle;                                       // 0x04F8 (size: 0x4)
    FPalDataTableRowName_UIInputAction BeginAdminSpectateActionName;                  // 0x04FC (size: 0x8)
    FGuid SpectatorHudGuid;                                                           // 0x0504 (size: 0x10)
    FTimerHandle TimerHandleOnBeginSpectateNextTick;                                  // 0x0518 (size: 0x8)
    FPalUIActionBindData QuestCheckActionHandle;                                      // 0x0520 (size: 0x4)
    FPalDataTableRowName_UIInputAction QuestCheckActionName;                          // 0x0524 (size: 0x8)
    FTimerHandle TImerHandle_ClearQuestCheckAction;                                   // 0x0530 (size: 0x8)
    FName CurrentDisplayStartQuestId;                                                 // 0x0538 (size: 0x8)
    FTimerHandle TimerHandle_DisableWeaponChange;                                     // 0x0540 (size: 0x8)
    bool bIsDIsplayingWeaponList;                                                     // 0x0548 (size: 0x1)
    bool bLastEquipedLoadoutWeapon;                                                   // 0x0549 (size: 0x1)
    TSoftObjectPtr<APalWeaponBase> SoftLastEquipedWeapon;                             // 0x0550 (size: 0x30)
    FPalDataTableRowName_UIInputAction ThrowPalActionName;                            // 0x0580 (size: 0x8)
    FPalUIActionBindData ThworPalActionHandle;                                        // 0x0588 (size: 0x4)
    FPalUIActionBindData ThrowPalActionDUmmyPressConsumeHandle;                       // 0x058C (size: 0x4)
    FPalDataTableRowName_UIInputAction OpenCharacterMenuActionName_Another;           // 0x0590 (size: 0x8)
