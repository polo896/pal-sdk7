...
class UWBP_PalStatus_C : public UPalUICharacterStatus
{
    ...
    class UCanvasPanel* Canvas_CaptureImage;                                          // 0x0488 (size: 0x8)
    class UImage* Image_Floor;                                                        // 0x0490 (size: 0x8)
    class UImage* Image_Floor_1;                                                      // 0x0498 (size: 0x8)
    class UImage* Image_PalReflection;                                                // 0x04A0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_NothingPal;                                        // 0x04A8 (size: 0x8)
    class UWBP_MainMenu_Pal_00_C* WBP_MainMenu_Pal_00;                                // 0x04B0 (size: 0x8)
    class UWBP_PalMonsterInframeRender_C* WBP_PalInframeRender;                       // 0x04B8 (size: 0x8)
    TArray<class UPalIndividualCharacterHandle*> displayHandles;                      // 0x04C0 (size: 0x10)
    class UTextureRenderTarget2D* Render Target;                                      // 0x04D0 (size: 0x8)
    int32 lastShowHandleIndex;                                                        // 0x04D8 (size: 0x4)
    int32 lastShowRenderPalIndex;                                                     // 0x04DC (size: 0x4)
    FPalDataTableRowName_UIInputAction ToParameterDetailAction;                       // 0x04E0 (size: 0x8)
    FPalUIActionBindData ToParameterDetailActionHandle;                               // 0x04E8 (size: 0x4)
    FPalDataTableRowName_UIInputAction ToSkillDetailAction;                           // 0x04EC (size: 0x8)
    FPalUIActionBindData ToSkillDetailActionHandle;                                   // 0x04F4 (size: 0x4)
    bool IsOnePalModel;                                                               // 0x04F8 (size: 0x1)
    FPalDataTableRowName_UIInputAction FavoritePalAction;                             // 0x04FC (size: 0x8)
    FPalDataTableRowName_UIInputAction DropPalAction;                                 // 0x0504 (size: 0x8)
    FPalUIActionBindData FavoritePalActionHandle;                                     // 0x050C (size: 0x4)
    FPalUIActionBindData DropPalActionHandle;                                         // 0x0510 (size: 0x4)
    class UPalIndividualCharacterHandle* LastHoveredPalHandle;                        // 0x0518 (size: 0x8)
    FDataTableRowHandle DropPalDialogMsgID;                                           // 0x0520 (size: 0x10)
    FDataTableRowHandle CannotDropPalMsgID;                                           // 0x0530 (size: 0x10)
