...
class ABP_BuildObject_EnergyGenerator_Large_C : public APalBuildObjectGenerateEnergy
{
    ...
    class UPalMapObjectGenerateEnergyParameterComponent* GenerateEnergyParameter;     // 0x0788 (size: 0x8)
    class USceneComponent* EffectAttachment;                                          // 0x0790 (size: 0x8)
    class UStaticMeshComponent* StaticMesh;                                           // 0x0798 (size: 0x8)
    class UBP_InteractableBox_C* BP_InteractableBox;                                  // 0x07A0 (size: 0x8)
    class USceneComponent* Meshes;                                                    // 0x07A8 (size: 0x8)
