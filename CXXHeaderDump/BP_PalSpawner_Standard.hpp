...
class ABP_PalSpawner_Standard_C : public APalNPCSpawnerBase
{
    ...
    class UTextRenderComponent* DummyTextRender;                                      // 0x0540 (size: 0x8)
    class USkeletalMeshComponent* DummySkeletalMesh;                                  // 0x0548 (size: 0x8)
    class USphereComponent* SpawnCollision;                                           // 0x0550 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0558 (size: 0x8)
    bool NotSleepFlag;                                                                // 0x0560 (size: 0x1)
    class ABP_MonsterBase_C* tempSpawnedMonster;                                      // 0x0568 (size: 0x8)
    TArray<class UPalIndividualCharacterHandle*> IndividualHandleList;                // 0x0570 (size: 0x10)
    double ReturnTerritoryRadius;                                                     // 0x0580 (size: 0x8)
    double WanderingRadius;                                                           // 0x0588 (size: 0x8)
    TEnumAsByte<ELeashType::Type> Leash Type;                                         // 0x0590 (size: 0x1)
    FVector BattleStartLocation;                                                      // 0x0598 (size: 0x18)
    double SpawnRadius;                                                               // 0x05B0 (size: 0x8)
    TArray<FPalSpawnerGroupInfo> SpawnGroupList;                                      // 0x05B8 (size: 0x10)
    double RayStartUpOffset;                                                          // 0x05C8 (size: 0x8)
    FPalSpawnerGroupInfo tempSpawnGroupInfo;                                          // 0x05D0 (size: 0x30)
    double DespawnPlusDistance;                                                       // 0x0600 (size: 0x8)
    bool IsLoading;                                                                   // 0x0608 (size: 0x1)
    bool IsWorldLoadComplete;                                                         // 0x0609 (size: 0x1)
    FName SpawnerName;                                                                // 0x060C (size: 0x8)
    EPalSpawnedCharacterType SpawnerType;                                             // 0x0614 (size: 0x1)
    double ReturnRadiusRate_Combat;                                                   // 0x0618 (size: 0x8)
    bool IgnoreGroundRaycast;                                                         // 0x0620 (size: 0x1)
    TSubclassOf<class APalAIController> AIControllerClass;                            // 0x0628 (size: 0x8)
    TArray<FName> WorldTreeAuraPassiveSkillNames;                                     // 0x0630 (size: 0x10)
    bool HasWorldTreeAura;                                                            // 0x0640 (size: 0x1)
    bool bIsFixSpawnGroup;                                                            // 0x0641 (size: 0x1)
    EPalOneDayTimeType FixSpawnGroupTime;                                             // 0x0642 (size: 0x1)
    bool RarePalAble;                                                                 // 0x0643 (size: 0x1)
