#ifndef UE4SS_SDK_BP_SkillEffect_IceAge_HPP
#define UE4SS_SDK_BP_SkillEffect_IceAge_HPP

class ABP_SkillEffect_IceAge_C : public ABP_SkillEffectBase_C
{
    ...
    void OnExlosion();
    void StartInterval();
    void ExecuteUbergraph_BP_SkillEffect_IceAge(int32 EntryPoint);
}; // Size: 0x4B8
