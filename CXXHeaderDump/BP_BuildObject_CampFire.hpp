...
class ABP_BuildObject_CampFire_C : public APalBuildObject
{
    ...
    class UPalBurnBoxComponent* PalBurnBox;                                           // 0x0780 (size: 0x8)
    class UBP_BuildObjectSimulateArrowComponent_C* BP_BuildObjectSimulateArrowComponent; // 0x0788 (size: 0x8)
    class UBP_PalFirePointLightComponent_C* BP_PalFirePointLight;                     // 0x0790 (size: 0x8)
    class UBP_HeatSourceSphereComponent_C* BP_HeatSourceComponent;                    // 0x0798 (size: 0x8)
    class UNiagaraComponent* Fire;                                                    // 0x07A0 (size: 0x8)
