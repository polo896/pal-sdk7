...
class UWBP_OptionSettings_ListContent_C : public UPalUserWidget
{
    ...
    class UWidgetAnimation* Anm_NormalToFocus;                                        // 0x0458 (size: 0x8)
    class UImage* Base;                                                               // 0x0460 (size: 0x8)
    class UImage* Base_Focus;                                                         // 0x0468 (size: 0x8)
    class UBP_PalTextBlock_C* BP_PalTextBlock_Name;                                   // 0x0470 (size: 0x8)
    class UWBP_PalInvisibleButton_C* Button;                                          // 0x0478 (size: 0x8)
    class UCanvasPanel* CanvasPanel_0;                                                // 0x0480 (size: 0x8)
    class UWBP_OptionSettings_ClickableButton_C* WBP_OptionSettings_ClickableButton;  // 0x0488 (size: 0x8)
    class UWBP_OptionSettings_ListContentButton_C* WBP_OptionSettings_ListContentButton; // 0x0490 (size: 0x8)
    class UWBP_OptionSettings_ListContentLR_C* WBP_OptionSettings_ListContentLR;      // 0x0498 (size: 0x8)
    class UWBP_OptionSettings_ListContentSlider_C* WBP_OptionSettings_ListContentSlider; // 0x04A0 (size: 0x8)
    class UWBP_OptionSettings_ListContentSwitch_C* WBP_OptionSettings_ListContentSwitch; // 0x04A8 (size: 0x8)
    class UWBP_Title_WorldSettings_ListButton_C* WBP_Title_WorldSettings_ListButton;  // 0x04B0 (size: 0x8)
    FDataTableRowHandle SettingNameMsgId;                                             // 0x04B8 (size: 0x10)
    TArray<FString> ScreenSelections;                                                 // 0x04C8 (size: 0x10)
    int32 Current;                                                                    // 0x04D8 (size: 0x4)
    FPalUIActionBindData BackAction;                                                  // 0x04DC (size: 0x4)
    FPalUIActionBindData LeftPressed;                                                 // 0x04E0 (size: 0x4)
    FPalUIActionBindData LeftReleased;                                                // 0x04E4 (size: 0x4)
    FPalUIActionBindData RightPressed;                                                // 0x04E8 (size: 0x4)
    FPalUIActionBindData RightReleased;                                               // 0x04EC (size: 0x4)
    FName BackActionName;                                                             // 0x04F0 (size: 0x8)
    FName LeftActionName;                                                             // 0x04F8 (size: 0x8)
    FName RightActionName;                                                            // 0x0500 (size: 0x8)
    bool Editing;                                                                     // 0x0508 (size: 0x1)
    FTimerHandle SubtractTimer;                                                       // 0x0510 (size: 0x8)
    FTimerHandle AddTimer;                                                            // 0x0518 (size: 0x8)
    FLinearColor OriginalColor;                                                       // 0x0520 (size: 0x10)
    double ChangePercent;                                                             // 0x0530 (size: 0x8)
    bool BlockMouseClick;                                                             // 0x0538 (size: 0x1)
    FWBP_OptionSettings_ListContent_COnKeyConfigClicked OnKeyConfigClicked;           // 0x0540 (size: 0x10)
    void OnKeyConfigClicked(FName KeyName, ECommonInputType InputType, EPalKeyConfigAxisFilterType AxisType);
    FName ActionKeyName;                                                              // 0x0550 (size: 0x8)
    ECommonInputType Input Type;                                                      // 0x0558 (size: 0x1)
    EPalKeyConfigAxisFilterType Filter Type;                                          // 0x0559 (size: 0x1)
