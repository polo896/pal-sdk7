#ifndef UE4SS_SDK_ABP_VolcanoDragon_Implementation_HPP
#define UE4SS_SDK_ABP_VolcanoDragon_Implementation_HPP
...
class UABP_VolcanoDragon_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_LookAt AnimGraphNode_LookAt_3;                                          // 0x1610 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt_2;                                          // 0x1860 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt_1;                                          // 0x1AB0 (size: 0x250)
    ...
    double __CustomProperty_PositionAlpha_leg_back_03_l_Goal_D20C68FE4A26A0C884AA329960AE1665; // 0x2140 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_back_03_r_Goal_D20C68FE4A26A0C884AA329960AE1665; // 0x2148 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_front_03_l_Goal_D20C68FE4A26A0C884AA329960AE1665; // 0x2150 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_front_03_r_Goal_D20C68FE4A26A0C884AA329960AE1665; // 0x2158 (size: 0x8)
    ...
    void ExecuteUbergraph_ABP_VolcanoDragon_Implementation(int32 EntryPoint);
}; // Size: 0x2178
