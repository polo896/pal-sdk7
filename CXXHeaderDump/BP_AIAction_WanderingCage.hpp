...
class UBP_AIAction_WanderingCage_C : public UPalAIActionBaseCampCage
{
    ...
    class UObject* Sensor;                                                            // 0x0148 (size: 0x8)
    FVector SpawnedPosition;                                                          // 0x0150 (size: 0x18)
    FVector GoalPosition;                                                             // 0x0168 (size: 0x18)
    double ConstWalkSpeed;                                                            // 0x0180 (size: 0x8)
    class UPalDamageReactionComponent* DamageReaction;                                // 0x0188 (size: 0x8)
