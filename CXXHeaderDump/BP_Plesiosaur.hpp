#ifndef UE4SS_SDK_BP_Plesiosaur_HPP
#define UE4SS_SDK_BP_Plesiosaur_HPP

class ABP_Plesiosaur_C : public ABP_MonsterBase_C
{
    ...
    class UBP_PalRideMarkerSit_C* BP_PalRideMarkerSit;                                // 0x0D40 (size: 0x8)
