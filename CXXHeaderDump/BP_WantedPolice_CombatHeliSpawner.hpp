...
class ABP_WantedPolice_CombatHeliSpawner_C : public APalNPCSpawnerBase
{
    ...
    FName CharacterID;                                                                // 0x0548 (size: 0x8)
    int32 PoliceLevel;                                                                // 0x0550 (size: 0x4)
    double PoliceHate;                                                                // 0x0558 (size: 0x8)
    TArray<FVector> SpawnLocations;                                                   // 0x0560 (size: 0x10)
    int32 SpawnIndex;                                                                 // 0x0570 (size: 0x4)
    class UBP_WorldSecurityPoliceSpawner_C* PoliceSpawnerModel;                       // 0x0578 (size: 0x8)
    TArray<class UPalIndividualCharacterHandle*> OwnedHandles;                        // 0x0580 (size: 0x10)
    bool bShouldDropOff;                                                              // 0x0590 (size: 0x1)
    int32 SpawnedHeliCount;                                                           // 0x0594 (size: 0x4)
    int32 TotalHeliNum;                                                               // 0x0598 (size: 0x4)
    int32 TotalDropOffPoliceNum;                                                      // 0x059C (size: 0x4)
    int32 DropOffPoliceLevel;                                                         // 0x05A0 (size: 0x4)
    FName DropOffPoliceCharacterID;                                                   // 0x05A4 (size: 0x8)
