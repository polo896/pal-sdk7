...
class ABP_BuildObject_WeaponFactory_Dirty_02_C : public APalBuildObject
{
    ...
    class UPalWorkEffectSoundComponent* WorkSound_Flowing;                            // 0x0780 (size: 0x8)
    class UBP_BuildObjectFactoryConveyorComponent_C* FactoryConveyorComponent;        // 0x0788 (size: 0x8)
    class UPalWorkFacingComponent* WorkFacing1;                                       // 0x0790 (size: 0x8)
    class UPalWorkFacingComponent* WorkFacing2;                                       // 0x0798 (size: 0x8)
    class UPalWorkFacingComponent* WorkFacing;                                        // 0x07A0 (size: 0x8)
