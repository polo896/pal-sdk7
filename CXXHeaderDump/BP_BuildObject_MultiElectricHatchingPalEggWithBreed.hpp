...
class ABP_BuildObject_MultiElectricHatchingPalEggWithBreed_C : public APalBuildObject
{
    ...
    class UStaticMeshComponent* PalSphereLight1;                                      // 0x0778 (size: 0x8)
    class UStaticMeshComponent* PalSphereLight;                                       // 0x0780 (size: 0x8)
    class UPalBuildObjectHUDLocatorComponent* HUDLocator_Breed;                       // 0x0788 (size: 0x8)
    class UPalMapObjectMultiHatchingEggWithBreedParameterComponent* MultiHatchingEggWithBreedParameter; // 0x0790 (size: 0x8)
    class UBP_BuildObjectSimulateArrowComponent_C* BP_BuildObjectSimulateArrowComponent; // 0x0798 (size: 0x8)
    class UNiagaraComponent* NS_HatchingEggFinishGlow;                                // 0x07A0 (size: 0x8)
    class UChildActorComponent* PalEggChildActor;                                     // 0x07A8 (size: 0x8)
