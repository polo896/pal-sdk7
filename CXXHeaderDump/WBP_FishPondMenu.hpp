...
class UWBP_FishPondMenu_C : public UPalUserWidgetOverlayUI
{
    ...
    class UWBP_IngameMenu_FishPond_C* WBP_IngameMenu_FishPond;                        // 0x0488 (size: 0x8)
    FTimerHandle UpdateRecipeTimer;                                                   // 0x0490 (size: 0x8)
    TEnumAsByte<EUIFishPondMenuPhase::Type> Phase;                                    // 0x0498 (size: 0x1)
    FName InputActionName_Max;                                                        // 0x049C (size: 0x8)
    FName InputActionName_Start;                                                      // 0x04A4 (size: 0x8)
    FName InputActionName_Cancel;                                                     // 0x04AC (size: 0x8)
    class UWBP_IngameMenu_FishPond_ListButton_C* LastSelectedSlot;                    // 0x04B8 (size: 0x8)
