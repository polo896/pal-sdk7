...
class UWBP_IngameMenu_ChestManage_C : public UPalUserWidgetOverlayUI
{
    ...
    class UCanvasPanel* Canvas_TargetContainer;                                       // 0x0488 (size: 0x8)
    class UWBP_Common_Inventory_C* WBP_Common_Inventory;                              // 0x0490 (size: 0x8)
    class UWBP_IngameMenu_ChestManage_TakeOut_C* WBP_IngameMenu_ChestManage_TakeOut;  // 0x0498 (size: 0x8)
    class UWBP_IngameMenu_ItemSearchList_C* WBP_IngameMenu_ItemSearchList;            // 0x04A0 (size: 0x8)
    class UWBP_Menu_btn_C* WBP_Menu_btn;                                              // 0x04A8 (size: 0x8)
    class UBP_PalInventoryModel_C* InventoryModel;                                    // 0x04B0 (size: 0x8)
    FWBP_IngameMenu_ChestManage_COnClickedQuickMoveButton OnClickedQuickMoveButton;   // 0x04B8 (size: 0x10)
    void OnClickedQuickMoveButton();
    FWBP_IngameMenu_ChestManage_COnClickedPreferenceButton OnClickedPreferenceButton; // 0x04C8 (size: 0x10)
    void OnClickedPreferenceButton();
    class UPalUIBaseCampItemDispenserModel* DispenserModel;                           // 0x04D8 (size: 0x8)
    bool TakeOutPanelEnabled;                                                         // 0x04E0 (size: 0x1)
    TArray<FPalUIActionBindData> TakeOutBindedActions;                                // 0x04E8 (size: 0x10)
    bool LastFocusListSlot;                                                           // 0x04F8 (size: 0x1)
    bool Updateable;                                                                  // 0x04F9 (size: 0x1)
    FTimerHandle UpdateableTimer;                                                     // 0x0500 (size: 0x8)
    bool CurrentInFocusPath;                                                          // 0x0508 (size: 0x1)
    bool ForceReset;                                                                  // 0x0509 (size: 0x1)
    TArray<FPalItemSlotId> FillableSlotIds;                                           // 0x0510 (size: 0x10)
