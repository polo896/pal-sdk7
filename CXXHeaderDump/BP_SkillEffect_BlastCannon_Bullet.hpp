#ifndef UE4SS_SDK_BP_SkillEffect_BlastCannon_Bullet_HPP
#define UE4SS_SDK_BP_SkillEffect_BlastCannon_Bullet_HPP

class ABP_SkillEffect_BlastCannon_Bullet_C : public ABP_SkillEffectBase_C
{
    ...
    void ExecuteUbergraph_BP_SkillEffect_BlastCannon_Bullet(int32 EntryPoint);
}; // Size: 0x460
