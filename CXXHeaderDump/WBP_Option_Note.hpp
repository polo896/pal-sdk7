...
class UWBP_Option_Note_C : public UPalUserWidgetOverlayUI
{
    ...
    class UBP_PalTextBlock_C* BP_PalTextBlock_NoteCount;                              // 0x0490 (size: 0x8)
    class UWBP_NoData_C* WBP_NoData;                                                  // 0x0498 (size: 0x8)
    class UWBP_Option_NoteContent_C* WBP_Option_NoteContent;                          // 0x04A0 (size: 0x8)
    class UWBP_PalCommonScrollList_C* WBP_PalCommonScrollList;                        // 0x04A8 (size: 0x8)
    FName CurrentNoteTitle;                                                           // 0x04B0 (size: 0x8)
    class UWBP_PalInvisibleButton_C* FocusTarget;                                     // 0x04B8 (size: 0x8)
    bool InGameMenu;                                                                  // 0x04C0 (size: 0x1)
