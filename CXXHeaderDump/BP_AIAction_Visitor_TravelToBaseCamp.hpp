...
class UBP_AIAction_Visitor_TravelToBaseCamp_C : public UBP_AIAction_CanCombatBase_C
{
    ...
    bool DashMode;                                                                    // 0x0198 (size: 0x1)
    FBP_AIAction_Visitor_TravelToBaseCamp_COnArrivedTargetPoint OnArrivedTargetPoint; // 0x01A0 (size: 0x10)
    void OnArrivedTargetPoint();
    FVector PrevLocation;                                                             // 0x01B0 (size: 0x18)
    double StuckElapsedTime;                                                          // 0x01C8 (size: 0x8)
    FBP_AIAction_Visitor_TravelToBaseCamp_COnStuck OnStuck;                           // 0x01D0 (size: 0x10)
    void OnStuck();
    bool IsStuck;                                                                     // 0x01E0 (size: 0x1)
    bool RunWhileTraveling;                                                           // 0x01E1 (size: 0x1)
