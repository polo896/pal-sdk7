...
class UWBP_Map_Base_C : public UPalUIWorldMap
{
    ...
    class UWidgetAnimation* Anm_SelectMap_Loop;                                       // 0x0490 (size: 0x8)
    class UWidgetAnimation* Anm_Respawn_In;                                           // 0x0498 (size: 0x8)
    class UBackgroundBlur* BackgroundBlur_1;                                          // 0x04A0 (size: 0x8)
    class UCanvasPanel* BG;                                                           // 0x04A8 (size: 0x8)
    class UCanvasPanel* Canvas_Warning;                                               // 0x04B0 (size: 0x8)
    class UCanvasPanel* Canvas_Warning_UnderAttack;                                   // 0x04B8 (size: 0x8)
    class UHorizontalBox* HorizontalBox_Filter;                                       // 0x04C0 (size: 0x8)
    class UHorizontalBox* HorizontalBox_FocusToBaseCamp;                              // 0x04C8 (size: 0x8)
    class UHorizontalBox* HorizontalBox_Marker;                                       // 0x04D0 (size: 0x8)
    class UHorizontalBox* HorizontalBox_SelectMap;                                    // 0x04D8 (size: 0x8)
    class UImage* Image_1;                                                            // 0x04E0 (size: 0x8)
    class UImage* Image_QuestTrackingIcon_ChangeMapKeyGuide;                          // 0x04E8 (size: 0x8)
    class UOverlay* Overlay_RespawnMsg;                                               // 0x04F0 (size: 0x8)
    class UOverlay* Overlay_SelectMap;                                                // 0x04F8 (size: 0x8)
    class UBP_PalTextBlock_C* Text_CursorLocation;                                    // 0x0500 (size: 0x8)
    class UBP_PalTextBlock_C* Text_NextMapName;                                       // 0x0508 (size: 0x8)
    class UBP_PalTextBlock_C* Text_RemainTime_StartInvade;                            // 0x0510 (size: 0x8)
    class UWBP_Map_Body_C* WBP_Map_Body_MW5;                                          // 0x0518 (size: 0x8)
    class UWBP_MapFilter_Win_C* WBP_MapFilter_Win;                                    // 0x0520 (size: 0x8)
    class UWBP_MapMarker_Win_C* WBP_MapMarker_Win;                                    // 0x0528 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton;                          // 0x0530 (size: 0x8)
    class UWidgetSwitcher* WidgetSwitcher_97;                                         // 0x0538 (size: 0x8)
    FName CloseMapActionName;                                                         // 0x0540 (size: 0x8)
    FName FocusPlayerActionName;                                                      // 0x0548 (size: 0x8)
    FName CustomMarkActionName;                                                       // 0x0550 (size: 0x8)
    FName FilterActionName;                                                           // 0x0558 (size: 0x8)
    TMap<class FGuid, class UWBP_WorldMap_IconBase_NoDesign_C*> CreatedIconMap;       // 0x0560 (size: 0x50)
    TMap<class FGuid, class UWBP_Map_IconCustom_C*> CustomMarkerMap;                  // 0x05B0 (size: 0x50)
    TMap<class UPalLocationPoint*, class FGuid> DeathMarkMap;                         // 0x0600 (size: 0x50)
    TArray<class UWBP_Map_IconDeath_C*> DeathMarks;                                   // 0x0650 (size: 0x10)
    TArray<class UWBP_Map_IconTower_C*> BossTowerIcons;                               // 0x0660 (size: 0x10)
    TMap<class FGuid, class UWBP_Map_IconCustom_C*> GuildMarkerMap;                   // 0x0670 (size: 0x50)
    bool CustomMarkMode;                                                              // 0x06C0 (size: 0x1)
    bool FilterOpened;                                                                // 0x06C1 (size: 0x1)
    class UWBP_WorldMap_IconBase_NoDesign_C* CurrentSetupIcon;                        // 0x06C8 (size: 0x8)
    bool For Respawn;                                                                 // 0x06D0 (size: 0x1)
    TArray<class UWBP_Map_IconPlayer_C*> PlayerIcons;                                 // 0x06D8 (size: 0x10)
    bool Can Fast Travel;                                                             // 0x06E8 (size: 0x1)
    bool bIsInitSelect;                                                               // 0x06E9 (size: 0x1)
    FDataTableRowHandle FTMsgID;                                                      // 0x06F0 (size: 0x10)
    FDataTableRowHandle RespawnMsgID;                                                 // 0x0700 (size: 0x10)
    TArray<class UWBP_Map_IconBoss_C*> BossIcons;                                     // 0x0710 (size: 0x10)
    FName DismantalActionName;                                                        // 0x0720 (size: 0x8)
    FDataTableRowHandle InitSelectMsgID;                                              // 0x0728 (size: 0x10)
    class UWBP_WorldMap_IconBase_NoDesign_C* CurrentSelectedFTIcon;                   // 0x0738 (size: 0x8)
    FName ShowQuestActionName;                                                        // 0x0740 (size: 0x8)
    FWBP_Map_Base_COnRequestShowQuest OnRequestShowQuest;                             // 0x0748 (size: 0x10)
    void OnRequestShowQuest(FName QuestId);
    TArray<class UWBP_Map_IconBoss_C*> NewVar;                                        // 0x0758 (size: 0x10)
    class UPalUIWorldMapIcon* CurrentFocusIcon;                                       // 0x0768 (size: 0x8)
    class UWBP_Map_IconCustom_C* TempSettingCustomMarker;                             // 0x0770 (size: 0x8)
    double DefaultSearchIconBoxSize;                                                  // 0x0778 (size: 0x8)
    TMap<class EPalLocationType, class TSubclassOf<UPalUIWorldMapIcon>> IconClassMap; // 0x0780 (size: 0x50)
    TMap<class FName, class UWBP_Map_Body_C*> MapBodyMap;                             // 0x07D0 (size: 0x50)
    FName CurrentDisplayMapName;                                                      // 0x0820 (size: 0x8)
    TArray<FName> UnlockedMapNames;                                                   // 0x0828 (size: 0x10)
    FPalDataTableRowName_UIInputAction ChangeMapActionName;                           // 0x0838 (size: 0x8)
    class UWBP_Map_IconQuest_C* AlternativeTrackingQuestIcon;                         // 0x0840 (size: 0x8)
    FDataTableRowHandle ChangeMapTextId;                                              // 0x0848 (size: 0x10)
    TArray<class UPalUIWorldMapIcon*> NearestRespawnPointFastTravelIcon;              // 0x0858 (size: 0x10)
    FName HideNearestRespawnPointFastravelIconFlagName;                               // 0x0868 (size: 0x8)
    TArray<FName> NearestRespawnPointFastTravelIds;                                   // 0x0870 (size: 0x10)
    bool bWaitingInvade;                                                              // 0x0880 (size: 0x1)
    FTimerHandle TimerHandle_SyncStartInvadeTimer;                                    // 0x0888 (size: 0x8)
    float LocalRemainStartInvadeTime;                                                 // 0x0890 (size: 0x4)
    FPalDataTableRowName_UIInputAction FocusToBaseCampActionName;                     // 0x0894 (size: 0x8)
    FPalUIActionBindData ActionHandle_FocusToBaseCamp;                                // 0x089C (size: 0x4)
    TArray<class UWBP_Map_StandAloneBossIcon_C*> StandaloneBossIcons;                 // 0x08A0 (size: 0x10)
    class UPalGroupGuildBase* LastBelongGuild;                                        // 0x08B0 (size: 0x8)
    FGuid Current Base Camp Id;                                                       // 0x08B8 (size: 0x10)
