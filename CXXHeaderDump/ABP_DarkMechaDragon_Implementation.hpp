#ifndef UE4SS_SDK_ABP_DarkMechaDragon_Implementation_HPP
#define UE4SS_SDK_ABP_DarkMechaDragon_Implementation_HPP
...
class UABP_DarkMechaDragon_Implementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_DarkMechaDragon_Implementation(int32 EntryPoint);
}; // Size: 0x1558
