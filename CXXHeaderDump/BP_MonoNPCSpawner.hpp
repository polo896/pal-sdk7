...
class ABP_MonoNPCSpawner_C : public APalNPCSpawnerBase
{
    ...
    class UStaticMeshComponent* Debug_Mesh;                                           // 0x0548 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0550 (size: 0x8)
    FPalDataTableRowName_PalHumanData HumanName;                                      // 0x0558 (size: 0x8)
    bool Spawned;                                                                     // 0x0560 (size: 0x1)
    FPalDataTableRowName_NPCUniqueData UniqueName;                                    // 0x0564 (size: 0x8)
    FPalDataTableRowName_PalMonsterData OtomoName;                                    // 0x056C (size: 0x8)
    int32 Level;                                                                      // 0x0574 (size: 0x4)
    FName CharaName;                                                                  // 0x0578 (size: 0x8)
    class UPalIndividualCharacterHandle* SpawnedHandle;                               // 0x0580 (size: 0x8)
    TArray<FName> NameList;                                                           // 0x0588 (size: 0x10)
    double ReturnRadius;                                                              // 0x0598 (size: 0x8)
    TSubclassOf<class ABP_NPCAIController_C> ControllerClass;                         // 0x05A0 (size: 0x8)
    TSubclassOf<class UPalAIActionBase> DefaultActionClass;                           // 0x05A8 (size: 0x8)
    double DespawnPlusDistance;                                                       // 0x05B0 (size: 0x8)
    FName UniqueNPCID;                                                                // 0x05B8 (size: 0x8)
    FF_NPC_PathWalkArray PathWalkArray;                                               // 0x05C0 (size: 0x10)
    bool IsLoading;                                                                   // 0x05D0 (size: 0x1)
    bool IsWorldLoadComplete;                                                         // 0x05D1 (size: 0x1)
    bool Debug_Disable;                                                               // 0x05D2 (size: 0x1)
    TArray<class ABP_NPC_WalkPathPoint_1_C*> WalkPointRefarence;                      // 0x05D8 (size: 0x10)
    class UPalIndividualCharacterHandle* OtomoHandle;                                 // 0x05E8 (size: 0x8)
    int32 DespawnWaitCounter;                                                         // 0x05F0 (size: 0x4)
    bool IsBossSpawner;                                                               // 0x05F4 (size: 0x1)
    FName SaveKeyName;                                                                // 0x05F8 (size: 0x8)
    bool NotDeleteGroupByDespawn;                                                     // 0x0600 (size: 0x1)
    double RespawnTimer;                                                              // 0x0608 (size: 0x8)
    double RespawnTime;                                                               // 0x0610 (size: 0x8)

    void Is Sit(bool& IsSit);
    ...
    void Initialize Spawned Character(class UPalIndividualCharacterHandle* Handle, TSubclassOf<class UPalAIActionBase> DefaultAction, FF_NPC_PathWalkArray WalkPath, FName Otomo, bool AdjustToFloor);
    void SetCharaNames();
