enum class EDiscordActivityActionTypes {
    Invalid = 0,
    Join = 1,
    JoinRequest = 5,
...
enum class EDiscordActivityGamePlatforms {
...
enum class EDiscordActivityPartyPrivacy {
    Private = 0,
    Public = 1,
    EDiscordActivityPartyPrivacy_MAX = 2,
};

enum class EDiscordActivityTypes {
    Playing = 0,
    Streaming = 1,
    Listening = 2,
    Watching = 3,
...
enum class EDiscordAdditionalContentType {
    Other = 0,
    Attachment = 1,
    Poll = 2,
    VoiceMessage = 3,
...
enum class EDiscordAudioModeType {
    MODE_UNINIT = 0,
    MODE_VAD = 1,
    MODE_PTT = 2,
    MODE_MAX = 3,
...
enum class EDiscordAudioSystem {
    Standard = 0,
    Game = 1,
    EDiscordAudioSystem_MAX = 2,
};

enum class EDiscordAuthenticationCodeChallengeMethod {
    S256 = 0,
    EDiscordAuthenticationCodeChallengeMethod_MAX = 1,
};

enum class EDiscordAuthenticationExternalAuthType {
    OIDC = 0,
...
enum class EDiscordAuthorizationTokenType {
    User = 0,
    Bearer = 1,
    EDiscordAuthorizationTokenType_MAX = 2,
};

enum class EDiscordCallError {
    None = 0,
...
enum class EDiscordClientError {
    None = 0,
    ConnectionFailed = 1,
    UnexpectedClose = 2,
...
enum class EDiscordClientStatus {
    Disconnected = 0,
    Connecting = 1,
    Connected = 2,
    Ready = 3,
...
enum class EDiscordClientThread {
    Client = 0,
    Voice = 1,
    Network = 2,
...
enum class EDiscordDisclosureTypes {
    GeneratedUnknownValue__ = 0,
    MessageDataVisibleOnDiscord = 3,
    EDiscordDisclosureTypes_MAX = 4,
};

enum class EDiscordErrorType {
    None = 0,
    NetworkError = 1,
    HTTPError = 2,
    ClientNotReady = 3,
...
enum class EDiscordExternalIdentityProviderType {
    OIDC = 0,
...
enum class EDiscordIntegrationType {
    GuildInstall = 0,
    UserInstall = 1,
    EDiscordIntegrationType_MAX = 2,
};

enum class EDiscordLobbyMemberFlags {
    None = 0,
    CanLinkLobby = 1,
    EDiscordLobbyMemberFlags_MAX = 2,
};

enum class EDiscordLoggingSeverity {
    GeneratedUnknownValue__ = 0,
    Verbose = 1,
    Info = 2,
    Warning = 3,
...
enum class EDiscordRelationshipGroupType {
    OnlinePlayingGame = 0,
    OnlineElsewhere = 1,
    Offline = 2,
...
enum class EDiscordStatusDisplayTypes {
    Name = 0,
    State = 1,
    Details = 2,
...
enum class EDiscordUserHandleAvatarType {
    Gif = 0,
    Webp = 1,
    Png = 2,
    Jpeg = 3,
