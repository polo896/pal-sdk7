...
{
    class UWBP_GuildMemberGauge_C* WBP_GuildMemberGauge;                              // 0x04E0 (size: 0x8)
    class UPalIndividualCharacterHandle* targetHandle;                                // 0x04E8 (size: 0x8)
    class UBP_Status_Dying_C* Dying Status;                                           // 0x04F0 (size: 0x8)
    FPalInstanceID SyncId;                                                            // 0x04F8 (size: 0x30)
