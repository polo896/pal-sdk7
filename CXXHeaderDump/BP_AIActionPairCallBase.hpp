...
class UBP_AIActionPairCallBase_C : public UPalAIActionBase
{
    ...
    class AActor* Trainer;                                                            // 0x0140 (size: 0x8)
    bool Petting;                                                                     // 0x0148 (size: 0x1)
    TSubclassOf<class UBP_ActionPairBehaviorBase_C> PairBehaviorActionClass;          // 0x0150 (size: 0x8)
