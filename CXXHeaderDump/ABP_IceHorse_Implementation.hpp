...
class UABP_IceHorse_Implementation_C : public UPalAnimInstance
{
    ...
    double __CustomProperty_PositionAlpha_leg_back_04_r_Goal_B0AE29D5457210378ABC68930116E0F1; // 0x1800 (size: 0x8)
    double __CustomProperty_PositionAlpha_finger_r_Goal_B0AE29D5457210378ABC68930116E0F1; // 0x1808 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_back_04_l_Goal_B0AE29D5457210378ABC68930116E0F1; // 0x1810 (size: 0x8)
    double __CustomProperty_PositionAlpha_finger_l_Goal_B0AE29D5457210378ABC68930116E0F1; // 0x1818 (size: 0x8)
