...
---@field IgnoreFinalizeWhenDestruct boolean
local UWBP_PalMonsterInframeRender_C = {}

---@param CharacterID FName
---@param SkinName FName
function UWBP_PalMonsterInframeRender_C:RequestCaptureSkin(CharacterID, SkinName) end
function UWBP_PalMonsterInframeRender_C:Finalize() end
