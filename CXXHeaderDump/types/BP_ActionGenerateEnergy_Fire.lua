...
local UBP_ActionGenerateEnergy_Fire_C = {}

function UBP_ActionGenerateEnergy_Fire_C:Attach() end
function UBP_ActionGenerateEnergy_Fire_C:SpawnEffect() end
---@param Montage UAnimMontage
---@param Exist boolean
UBP_ActionGenerateEnergy_Fire_C['Find Cooking Montage'] = function(self, Montage, Exist) end
