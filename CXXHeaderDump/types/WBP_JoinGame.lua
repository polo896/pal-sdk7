...
UWBP_JoinGame_C['Password入力後'] = function(self, Param) end
...
---@param bResult boolean
UWBP_JoinGame_C['カスタムイベント'] = function(self, bResult) end
function UWBP_JoinGame_C:Construct() end
---@param bResult boolean
UWBP_JoinGame_C['カスタムイベント_0'] = function(self, bResult) end
...
---@param Param UPalHUDDispatchParameterBase
UWBP_JoinGame_C['パスワード手動入力'] = function(self, Param) end
...
function UWBP_JoinGame_C:OnChangedIgnoreVersionCheck(bChecked) end
function UWBP_JoinGame_C:BndEvt__WBP_JoinGame_WBP_Title_WorldSelect_K2Node_ComponentBoundEvent_0_OnClickedCloseButton__DelegateSignature() end
