...
local UWBP_CommonRadialMenuBase_C = {}
...
UWBP_CommonRadialMenuBase_C['Set Center Widget'] = function(self, Widget, CanvasSize, Offset) end
...
UWBP_CommonRadialMenuBase_C['Set Additional Widget'] = function(self, Index, AddWidget, Canvas) end
...
UWBP_CommonRadialMenuBase_C['Calc Image Angle'] = function(self, Index, OutAngle) end
