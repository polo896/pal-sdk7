...
---@field BP_PalTextBlock_C_177 UBP_PalTextBlock_C
---@field CircularThrobber_26 UCircularThrobber
---@field HorizontalBox_SavePassword UHorizontalBox
---@field IconShowHide UImage
---@field Line UImage
---@field Overlay_Wait UOverlay
---@field PalCheckBox_SavePassword UPalCheckBox
...
---@field WBP_PalInvisibleButton_SavePassword UWBP_PalInvisibleButton_C
...
---@field SavePasswordMsgID FDataTableRowHandle
local UWBP_Title_WorldSelect_OverlayWindow_InputCode_C = {}

---@param Navigation EUINavigation
---@return UWidget
function UWBP_Title_WorldSelect_OverlayWindow_InputCode_C:DoCustomNavi_ToSavePasswordOrEditableText(Navigation) end
---@param Navigation EUINavigation
---@return UWidget
function UWBP_Title_WorldSelect_OverlayWindow_InputCode_C:DoCustomNavi_ToSavePasswordOrConfirm(Navigation) end
...
UWBP_Title_WorldSelect_OverlayWindow_InputCode_C['On Cancel Action'] = function(self, ) end
---@return UWidget
...
---@param Button UCommonButtonBase
function UWBP_Title_WorldSelect_OverlayWindow_InputCode_C:BndEvt__WBP_Title_WorldSelect_OverlayWindow_InputCode_WBP_PalInvisibleButton_SavePassword_K2Node_ComponentBoundEvent_1_CommonButtonBaseClicked__DelegateSignature(Button) end
