...
local UWBP_IngameMenu_Repair_C = {}

function UWBP_IngameMenu_Repair_C:UpdateUnlockedWeaponSlots() end
...
function UWBP_IngameMenu_Repair_C:Construct() end
...
---@param Widget UWBP_PalItemSlotButtonBase_C
---@param PressType EPalItemSlotPressType
function UWBP_IngameMenu_Repair_C:BndEvt__WBP_IngameMenu_Repair_WBP_ItemSlotButton_Weapon_04_K2Node_ComponentBoundEvent_11_OnClickedButton__DelegateSignature(Widget, PressType) end
---@param Widget UWBP_PalItemSlotButtonBase_C
---@param PressType EPalItemSlotPressType
function UWBP_IngameMenu_Repair_C:BndEvt__WBP_IngameMenu_Repair_WBP_ItemSlotButton_Weapon_05_K2Node_ComponentBoundEvent_12_OnClickedButton__DelegateSignature(Widget, PressType) end
