...
local UBP_AIAction_Visitor_WaitInBaseCamp_C = {}

---@param CurrentState EPalAIResponseType
---@param OverrideIsDamage boolean
---@param Target AActor
---@param ResponseType EPalAIResponseType
UBP_AIAction_Visitor_WaitInBaseCamp_C['Sight Check'] = function(self, CurrentState, OverrideIsDamage, Target, ResponseType) end
