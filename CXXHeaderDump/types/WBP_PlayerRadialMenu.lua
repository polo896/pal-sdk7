...
---@field EmoteMsgID_8 FDataTableRowHandle
---@field SlaughterMsgID FDataTableRowHandle
---@field OnRequestOpenChat FWBP_PlayerRadialMenu_COnRequestOpenChat
---@field OpenChatMsgID FDataTableRowHandle
---@field RadialIgnoreTribeList TArray<FName>
---@field OtomoInstructionWidgetMap TMap<EPalOtomoPalOrderType, UWBP_PlayerRadialMenu_MenuContent_C>
local UWBP_PlayerRadialMenu_C = {}

function UWBP_PlayerRadialMenu_C:HiglightCurrentOrderWidget() end
function UWBP_PlayerRadialMenu_C:OpenBuildObjectList() end
---@param bShouldDisplay boolean
function UWBP_PlayerRadialMenu_C:ShouldDisplayOpenChatPanel(bShouldDisplay) end
---@param IsDying boolean
function UWBP_PlayerRadialMenu_C:IsPlayerDying(IsDying) end
...
UWBP_PlayerRadialMenu_C['Open Emote Menu'] = function(self, ) end
---@param RideActor AActor
function UWBP_PlayerRadialMenu_C:OnPlayerRideOn(RideActor) end
---@param ShouldClose boolean
UWBP_PlayerRadialMenu_C['On Decided Instruction Care'] = function(self, ShouldClose) end
---@param ShouldClose boolean
function UWBP_PlayerRadialMenu_C:OnDecidedInstruction_Feed(ShouldClose) end
---@param Index int32
...
UWBP_PlayerRadialMenu_C['Can Open Player Action Menu'] = function(self, Result) end
...
function UWBP_PlayerRadialMenu_C:OnRequestOpenChat__DelegateSignature() end
