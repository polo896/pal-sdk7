...
UWBP_PalWorkerInfo_C['Set Work Suitability'] = function(self, WorkSuitabilities) end
---@param InWorkSuitability EPalWorkSuitability
---@param IsValid boolean
---@param OutWorkSuitability EPalWorkSuitability
UWBP_PalWorkerInfo_C['Check Valid Work Suitability'] = function(self, InWorkSuitability, IsValid, OutWorkSuitability) end
