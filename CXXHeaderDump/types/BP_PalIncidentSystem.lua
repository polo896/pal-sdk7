...
local UBP_PalIncidentSystem_C = {}

---@param Weights TArray<double>
---@param Index int32
UBP_PalIncidentSystem_C['Lottery Index by Weights'] = function(self, Weights, Index) end
...
---@param TargetNPC APalCharacter
---@param CunstomFuncParam UDataTable
function UBP_PalIncidentSystem_C:TalkCustomFunction_Duel(TalkPlayer, TargetNPC, CunstomFuncParam) end
