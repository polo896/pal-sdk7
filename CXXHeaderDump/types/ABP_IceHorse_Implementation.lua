...
---@class UABP_IceHorse_Implementation_C : UPalAnimInstance
...
---@field __CustomProperty_PositionAlpha_leg_back_04_r_Goal_B0AE29D5457210378ABC68930116E0F1 double
---@field __CustomProperty_PositionAlpha_finger_r_Goal_B0AE29D5457210378ABC68930116E0F1 double
---@field __CustomProperty_PositionAlpha_leg_back_04_l_Goal_B0AE29D5457210378ABC68930116E0F1 double
---@field __CustomProperty_PositionAlpha_finger_l_Goal_B0AE29D5457210378ABC68930116E0F1 double
---@field LookAtWorldLocation FVector
local UABP_IceHorse_Implementation_C = {}

---@param InPose_0 FPoseLink
---@param FootIKOverride FPoseLink
function UABP_IceHorse_Implementation_C:FootIKOverride(InPose_0, FootIKOverride) end
---@param InPose_3 FPoseLink
---@param LeaningVelocity FVector2D
---@param SwimLeaningOverride FPoseLink
function UABP_IceHorse_Implementation_C:SwimLeaningOverride(InPose_3, LeaningVelocity, SwimLeaningOverride) end
---@param InPose_2 FPoseLink
---@param LeaningVelocity FVector2D
---@param WalkLeaningOverride FPoseLink
function UABP_IceHorse_Implementation_C:WalkLeaningOverride(InPose_2, LeaningVelocity, WalkLeaningOverride) end
---@param InPose_1 FPoseLink
---@param LeaningVelocity FVector2D
---@param FlyLeaningOverride FPoseLink
function UABP_IceHorse_Implementation_C:FlyLeaningOverride(InPose_1, LeaningVelocity, FlyLeaningOverride) end
---@param PrePose FPoseLink
---@param CustomData FPalCustomAnimOverrideData
---@param CustomOverride FPoseLink
function UABP_IceHorse_Implementation_C:CustomOverride(PrePose, CustomData, CustomOverride) end
---@param DefaultPose FPoseLink
---@param AimRotator FRotator
---@param AimingOverride FPoseLink
function UABP_IceHorse_Implementation_C:AimingOverride(DefaultPose, AimRotator, AimingOverride) end
---@param InPose FPoseLink
---@param LookAtWorldLocation FVector
---@param LookAtOverride FPoseLink
function UABP_IceHorse_Implementation_C:LookAtOverride(InPose, LookAtWorldLocation, LookAtOverride) end
---@param NativePose FPoseLink
---@param ActionPose FPoseLink
---@param UpperOverride FPoseLink
function UABP_IceHorse_Implementation_C:UpperOverride(NativePose, ActionPose, UpperOverride) end
---@param AnimGraph FPoseLink
function UABP_IceHorse_Implementation_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UABP_IceHorse_Implementation_C:ExecuteUbergraph_ABP_IceHorse_Implementation(EntryPoint) end
