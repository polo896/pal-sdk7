...
---@field VerticalBox_GP_Action UVerticalBox
---@field VerticalBox_GP_UI UVerticalBox
---@field VerticalBox_KM UVerticalBox
---@field VerticalBox_KM_Action UVerticalBox
---@field VerticalBox_KM_UI UVerticalBox
...
---@field UIActionsMap_KM TMap<FName, UWBP_OptionSettings_ListContent_C>
---@field UIActionsMap_GP TMap<FName, UWBP_OptionSettings_ListContent_C>
...
---@field UIKeyConflict_KM boolean
---@field KeyConflict_GP boolean
---@field UIKeyConflict_GP boolean
---@field MultiKeyMap TMap<FName, FName>
local UWBP_Key_Settings_C = {}

function UWBP_Key_Settings_C:SetDefault() end
---@param FilterType EPalKeyConfigCategory
UWBP_Key_Settings_C['UI Key Conflict Check'] = function(self, FilterType) end
---@param ActionName FName
---@param NewKey FKey
---@param InputType EPalKeyConfigCategory
---@param AxisType EPalKeyConfigAxisFilterType
UWBP_Key_Settings_C['On UI Action Key Changed'] = function(self, ActionName, NewKey, InputType, AxisType) end
---@param KeyName FName
---@param InputType ECommonInputType
---@param AxisType EPalKeyConfigAxisFilterType
UWBP_Key_Settings_C['On UI Key Config Changing'] = function(self, KeyName, InputType, AxisType) end
---@param TargetMap TMap<FName, FPalKeyConfigKeys>
---@param ActionName FName
---@param Key FPalKeyConfigKeys
UWBP_Key_Settings_C['Multi Key Setting'] = function(self, TargetMap, ActionName, Key) end
---@param FilterType EPalKeyConfigCategory
UWBP_Key_Settings_C['Key Conflict Check'] = function(self, FilterType) end
...
UWBP_Key_Settings_C['Get Actions By Key'] = function(self, Key, InputType, KeyActions) end
---@param Key FPalKeyAction
---@param InputType ECommonInputType
---@return boolean
function UWBP_Key_Settings_C:IsSetableAction(Key, InputType) end
---@param CheckingAction FName
---@param FilterType EPalKeyConfigCategory
---@param KeyActions TArray<FName>
UWBP_Key_Settings_C['Get UI Conflict Actions'] = function(self, CheckingAction, FilterType, KeyActions) end
---@param ActionName FName
---@param NewKey FKey
---@param InputType EPalKeyConfigCategory
---@param AxisType EPalKeyConfigAxisFilterType
UWBP_Key_Settings_C['On Action Key Changed'] = function(self, ActionName, NewKey, InputType, AxisType) end
---@param CheckingAction FPalKeyAction
---@param FilterType EPalKeyConfigCategory
---@param KeyActions TArray<FPalKeyAction>
UWBP_Key_Settings_C['Get Conflict Actions'] = function(self, CheckingAction, FilterType, KeyActions) end
---@param KeyName FName
---@param InputType ECommonInputType
---@param AxisType EPalKeyConfigAxisFilterType
UWBP_Key_Settings_C['On Key Config Changing'] = function(self, KeyName, InputType, AxisType) end
