...
local EPlatformIconDisplayRule = {
    Always = 0,
    AlwaysIfDifferent = 1,
...
local ESocialPartyInviteFailureReason = {
    Success = 0,
    NotOnline = 1,
...
local ESocialPartyInviteMethod = {
    Other = 0,
    Notification = 1,
    Custom1 = 2,
