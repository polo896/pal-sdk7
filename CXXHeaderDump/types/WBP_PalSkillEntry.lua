...
---@field OverridePadActionName_Additional FName
local UWBP_PalSkillEntry_C = {}
...
function UWBP_PalSkillEntry_C:AdditionalBind() end
function UWBP_PalSkillEntry_C:ResetBind() end
