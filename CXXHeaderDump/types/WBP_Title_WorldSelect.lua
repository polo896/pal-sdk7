...
---@field WBP_Menu_btn_JoinGame UWBP_Menu_btn_C
---@field WBP_Menu_btn_LocalWorldSelect UWBP_Menu_btn_C
---@field WBP_NextButton UWBP_GuildHeadButton_C
---@field WBP_PalCommonScrollList UWBP_PalCommonScrollList_C
---@field WBP_PalInvisibleButton_IgnoreVersion UWBP_PalInvisibleButton_C
---@field WBP_PalInvisibleButton_OpenDirectory UWBP_PalInvisibleButton_C
---@field WBP_PalInvisibleButton_Password UWBP_PalInvisibleButton_C
...
---@field OnCheckStateChanged_IgnoreVersionCheck FWBP_Title_WorldSelect_COnCheckStateChanged_IgnoreVersionCheck
---@field OnClickedCloseButton FWBP_Title_WorldSelect_COnClickedCloseButton
local UWBP_Title_WorldSelect_C = {}

function UWBP_Title_WorldSelect_C:ShowHideIPAddress() end
...
UWBP_Title_WorldSelect_C['Update Local World List Content'] = function(self, WorldPathName, DisplayData) end
...
UWBP_Title_WorldSelect_C['Close Local World Menu'] = function(self, ) end
...
function UWBP_Title_WorldSelect_C:BndEvt__WBP_Title_WorldSelect_PalEditableTextBox_IP_K2Node_ComponentBoundEvent_3_OnEditableTextBoxCommittedEvent__DelegateSignature(Text, CommitMethod) end
function UWBP_Title_WorldSelect_C:BndEvt__WBP_Title_WorldSelect_WBP_Menu_btn_K2Node_ComponentBoundEvent_8_OnButtonClicked__DelegateSignature() end
function UWBP_Title_WorldSelect_C:BndEvt__WBP_Title_WorldSelect_WBP_Menu_btn_LocalWorldSelect_K2Node_ComponentBoundEvent_9_OnButtonClicked__DelegateSignature() end
---@param IsDesignTime boolean
function UWBP_Title_WorldSelect_C:PreConstruct(IsDesignTime) end
...
---@param Button UCommonButtonBase
function UWBP_Title_WorldSelect_C:BndEvt__WBP_Title_WorldSelect_WBP_PalInvisibleButton_Password_K2Node_ComponentBoundEvent_8_CommonButtonBaseClicked__DelegateSignature(Button) end
---@param Button UCommonButtonBase
function UWBP_Title_WorldSelect_C:BndEvt__WBP_Title_WorldSelect_WBP_PalInvisibleButton_K2Node_ComponentBoundEvent_9_CommonButtonBaseClicked__DelegateSignature(Button) end
---@param Button UCommonButtonBase
function UWBP_Title_WorldSelect_C:BndEvt__WBP_Title_WorldSelect_WBP_PalInvisibleButton_ShoiwHideInviteCode_K2Node_ComponentBoundEvent_10_CommonButtonBaseClicked__DelegateSignature(Button) end
---@param EntryPoint int32
function UWBP_Title_WorldSelect_C:ExecuteUbergraph_WBP_Title_WorldSelect(EntryPoint) end
function UWBP_Title_WorldSelect_C:OnClickedCloseButton__DelegateSignature() end
---@param bChecked boolean
function UWBP_Title_WorldSelect_C:OnCheckStateChanged_IgnoreVersionCheck__DelegateSignature(bChecked) end
