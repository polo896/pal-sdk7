...
local FSkyCreatorBackgroundCloudSettings = {}
...
local FSkyCreatorExponentialHeightFogSettings = {}
...
local FSkyCreatorLightningParameters = {}
...
local FSkyCreatorMoonLightSettings = {}
...
local FSkyCreatorPostProcessSettings = {}
...
local FSkyCreatorSkyAtmosphereSettings = {}
...
local FSkyCreatorSkyLightSettings = {}
...
local FSkyCreatorStarMapSettings = {}
...
---@field CloudShadowOnAtmosphereStrength float
---@field CloudShadowOnSurfaceStrength float
local FSkyCreatorSunLightSettings = {}
...
local FSkyCreatorVolumetricCloudSettings = {}
...
local FSkyCreatorWeatherFXSettings = {}
...
local FSkyCreatorWeatherMaterialFXSettings = {}
...
local FSkyCreatorWeatherSettings = {}
...
local FSkyCreatorWindSettings = {}



---@class USkyCreatorFunctionLibrary : UBlueprintFunctionLibrary
local USkyCreatorFunctionLibrary = {}
...
---@field WindSettings FSkyCreatorWindSettings
---@field PostProcessSettings FSkyCreatorPostProcessSettings
local USkyCreatorWeatherPreset = {}
