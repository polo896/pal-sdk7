...
---@field WBP_Title_MenuButton_GlobalPalBox UWBP_Title_MenuButton_C
...
local UWBP_TitleMenu_C = {}

---@param bEnableAttention boolean
function UWBP_TitleMenu_C:SetEnableGlobalPalStorageAttention(bEnableAttention) end
...
function UWBP_TitleMenu_C:BndEvt__WBP_TitleMenu_WBP_Title_MenuButton_GlobalPalBox_K2Node_ComponentBoundEvent_9_OnClicked__DelegateSignature() end
