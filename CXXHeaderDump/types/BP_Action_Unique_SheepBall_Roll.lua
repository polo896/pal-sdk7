...
local UBP_Action_Unique_SheepBall_Roll_C = {}

---@param MoveEnable boolean
function UBP_Action_Unique_SheepBall_Roll_C:SetMovementSetting(MoveEnable) end
UBP_Action_Unique_SheepBall_Roll_C['Break Action'] = function(self, ) end
...
UBP_Action_Unique_SheepBall_Roll_C['Get Target Rotation'] = function(self, DeltaTime, TargetRotation) end
---@param DeltaTime double
