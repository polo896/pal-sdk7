...
---@field bActiveChat boolean
local UWBP_Ingame_Chat_Wrapper_C = {}

---@param Param UPalHUDDispatchParameterBase
function UWBP_Ingame_Chat_Wrapper_C:OnClosedChatControl(Param) end
---@param bNewInputType ECommonInputType
function UWBP_Ingame_Chat_Wrapper_C:OnChangedInputMethod(bNewInputType) end
...
function UWBP_Ingame_Chat_Wrapper_C:Construct() end
...
function UWBP_Ingame_Chat_Wrapper_C:Destruct() end
