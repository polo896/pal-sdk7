...
local UWBP_PalKeyGuideIcon_C = {}

---@param PrevSettings FPalOptionUISettings
---@param NewSettings FPalOptionUISettings
function UWBP_PalKeyGuideIcon_C:OnUISettingChanged(PrevSettings, NewSettings) end
...
function UWBP_PalKeyGuideIcon_C:PreConstruct(IsDesignTime) end
