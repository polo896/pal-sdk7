...
local UWBP_Map_IconTower_C = {}

function UWBP_Map_IconTower_C:UpdateIcon() end
---@param OutLocation FVector
---@return boolean
function UWBP_Map_IconTower_C:GetLocationOnLandscape(OutLocation) end
---@param Button UWidget
function UWBP_Map_IconTower_C:GetInvisibleButton(Button) end
