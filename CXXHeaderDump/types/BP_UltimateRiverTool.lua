...
local ABP_UltimateRiverTool_C = {}

---@param SplineMesh USplineMeshComponent
---@param ProfileName FCollisionProfileName
function ABP_UltimateRiverTool_C:SetupCollision(SplineMesh, ProfileName) end
...
function ABP_UltimateRiverTool_C:GenerateSplineMesh(Collision, CastShadow, Material, TargetSpline, SplineStartOffset, Offset, Scale, TangetScale, Spacing, Rotation, StaticMesh, PathDeform, PathDeformDistance, isTriggerVolume, TranslucentSortPriority, ProfileName, bVisible) end
