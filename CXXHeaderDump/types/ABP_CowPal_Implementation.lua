...
---@class UABP_CowPal_Implementation_C : UPalAnimInstance
...
local UABP_CowPal_Implementation_C = {}

---@param DefaultPose FPoseLink
---@param AimRotator FRotator
---@param AimingOverride FPoseLink
function UABP_CowPal_Implementation_C:AimingOverride(DefaultPose, AimRotator, AimingOverride) end
---@param InPose FPoseLink
---@param LookAtWorldLocation FVector
---@param LookAtOverride FPoseLink
function UABP_CowPal_Implementation_C:LookAtOverride(InPose, LookAtWorldLocation, LookAtOverride) end
---@param NativePose FPoseLink
---@param ActionPose FPoseLink
---@param UpperOverride FPoseLink
function UABP_CowPal_Implementation_C:UpperOverride(NativePose, ActionPose, UpperOverride) end
---@param AnimGraph FPoseLink
function UABP_CowPal_Implementation_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UABP_CowPal_Implementation_C:ExecuteUbergraph_ABP_CowPal_Implementation(EntryPoint) end
