...
local ABP_SkillEffect_GhostFlame_Bullet_C = {}
...
ABP_SkillEffect_GhostFlame_Bullet_C['OnHitDelegate_イベント'] = function(self, MyHitComponent, OtherHitActor, OtherHitComponent, FoliageIndex, HitLocation, HitCount) end
