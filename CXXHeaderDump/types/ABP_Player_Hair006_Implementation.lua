...
---@field __StructProperty_78 FAnimNodeFunctionRef
...
---@class UABP_Player_Hair006_Implementation_C : UAnimInstance
...
---@field Alpha double
local UABP_Player_Hair006_Implementation_C = {}

---@param InPose FPoseLink
---@param HairLayer FPoseLink
function UABP_Player_Hair006_Implementation_C:HairLayer(InPose, HairLayer) end
---@param AnimGraph FPoseLink
function UABP_Player_Hair006_Implementation_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UABP_Player_Hair006_Implementation_C:ExecuteUbergraph_ABP_Player_Hair006_Implementation(EntryPoint) end
