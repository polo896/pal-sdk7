...
local ABP_PalRandomIncidentSpawner_C = {}
...
ABP_PalRandomIncidentSpawner_C['Create Walk Path'] = function(self, PointArray, PathArray) end
---@param SceneRoot USceneComponent
---@param Actors TArray<AActor>
ABP_PalRandomIncidentSpawner_C['Collect Walk Path Point'] = function(self, SceneRoot, Actors) end
...
---@param Delta float
function ABP_PalRandomIncidentSpawner_C:ReceiveDrawDebugShape(Delta) end
