...
---@field WBP_IngameMenu_Monitoring_WorkButton1 UWBP_IngameMenu_Monitoring_WorkButton_C
---@field WBP_IngameMenu_Monitoring_WorkButton2 UWBP_IngameMenu_Monitoring_WorkButton_C
---@field WBP_IngameMenu_Monitoring_WorkButton3 UWBP_IngameMenu_Monitoring_WorkButton_C
...
local UWBP_IngameMenu_Monitoring_C = {}

function UWBP_IngameMenu_Monitoring_C:UpdateWorkHardInfoPermission() end
