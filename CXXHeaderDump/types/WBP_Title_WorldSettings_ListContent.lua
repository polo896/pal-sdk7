...
---@field BP_PalRichTextBlock_C_106 UBP_PalRichTextBlock_C
...
---@field OnClickedPlatformButton FWBP_Title_WorldSettings_ListContent_COnClickedPlatformButton
---@field OnHovered FWBP_Title_WorldSettings_ListContent_COnHovered
local UWBP_Title_WorldSettings_ListContent_C = {}

---@param newText FText
function UWBP_Title_WorldSettings_ListContent_C:AddText(newText) end
---@param bEditable boolean
function UWBP_Title_WorldSettings_ListContent_C:CanEditable(bEditable) end
---@param bVisible boolean
function UWBP_Title_WorldSettings_ListContent_C:SetVisibilityCaution(bVisible) end
---@param Text FText
...
---@param Index int32
UWBP_Title_WorldSettings_ListContent_C['Set Name Select Index'] = function(self, Index) end
...
---@param IsPS5 boolean
---@param IsMac boolean
function UWBP_Title_WorldSettings_ListContent_C:SetupFlag(IsSteam, IsXbox, IsPS5, IsMac) end
...
UWBP_Title_WorldSettings_ListContent_C['Initialize Internal'] = function(self, ) end
...
function UWBP_Title_WorldSettings_ListContent_C:BndEvt__WBP_Title_WorldSettings_ListContent_WBP_OptionSettings_ListContentCheckbox_K2Node_ComponentBoundEvent_9_OnClickedCheckButton__DelegateSignature() end
...
function UWBP_Title_WorldSettings_ListContent_C:OnHovered__DelegateSignature(Widget) end
function UWBP_Title_WorldSettings_ListContent_C:OnClickedPlatformButton__DelegateSignature() end
