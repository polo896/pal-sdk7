...
---@class ABP_BuildObject_Factory_Hard_4_C : APalBuildObject
...
local ABP_BuildObject_Factory_Hard_4_C = {}

function ABP_BuildObject_Factory_Hard_4_C:OnAvailable_BlueprintImpl() end
---@param Model UPalMapObjectConcreteModelBase
function ABP_BuildObject_Factory_Hard_4_C:OnSetConcreteModel(Model) end
function ABP_BuildObject_Factory_Hard_4_C:ReceiveBeginPlay() end
---@param EntryPoint int32
function ABP_BuildObject_Factory_Hard_4_C:ExecuteUbergraph_BP_BuildObject_Factory_Hard_4(EntryPoint) end
