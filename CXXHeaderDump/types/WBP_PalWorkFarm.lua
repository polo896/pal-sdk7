...
---@field Canvas_Text_Progress_Aft UCanvasPanel
---@field Canvas_Text_Progress_Pre UCanvasPanel
---@field Canvas_Text_Progress_Simple UCanvasPanel
...
local UWBP_PalWorkFarm_C = {}

---@param NewValue float
function UWBP_PalWorkFarm_C:CREATEDELEGATE_PROXYFUNCTION_0(NewValue) end
---@param Model UPalMapObjectFarmBlockV2Model
function UWBP_PalWorkFarm_C:SetFarmCropInfo(Model) end
---@param Work UPalWorkBase
UWBP_PalWorkFarm_C['On Updated Worker Pal'] = function(self, Work) end
