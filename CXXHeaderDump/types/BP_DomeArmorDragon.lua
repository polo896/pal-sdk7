...
---@class ABP_DomeArmorDragon_C : ABP_MonsterBase_C
...
local ABP_DomeArmorDragon_C = {}

---@param OutComponent TArray<USceneComponent>
function ABP_DomeArmorDragon_C:GetVisual_ExceptMainMesh_SyncAnyway(OutComponent) end
