...
UWBP_Buildup_Pal_C['Refresh Info'] = function(self, ) end
function UWBP_Buildup_Pal_C:InvokeReset() end
---@param StatusMap TMap<EPalCharacterStatusOperationName, int32>
UWBP_Buildup_Pal_C['Invoke Rankup'] = function(self, StatusMap) end
function UWBP_Buildup_Pal_C:CloseAction() end
---@param Handle UPalIndividualCharacterHandle
UWBP_Buildup_Pal_C['On Click Pal List'] = function(self, Handle) end
