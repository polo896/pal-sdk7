...
---@field LackPower boolean
local UWBP_Ingame_Incubator_C = {}

---@param Module UPalMapObjectEnergyModule
function UWBP_Ingame_Incubator_C:UpdatePowerSuffcient(Module) end
---@param Ratio double
---@param Persent FText
...
UWBP_Ingame_Incubator_C['Set Second'] = function(self, RemainingSecond) end
...
UWBP_Ingame_Incubator_C['On Update Work Amount'] = function(self, WorkProgress) end
