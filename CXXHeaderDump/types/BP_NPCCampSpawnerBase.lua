...
local ABP_NPCCampSpawnerBase_C = {}
...
---@param EnemyCampStatus FPalEnemyCampStatus
function ABP_NPCCampSpawnerBase_C:EnemyCampClearSetting(EnemyCampStatus) end
function ABP_NPCCampSpawnerBase_C:OnOpenMainTreasureBox() end
---@return FName
function ABP_NPCCampSpawnerBase_C:GetRewardName() end
...
function ABP_NPCCampSpawnerBase_C:RandomLottery(ResultClass, SelectedIndex) end
