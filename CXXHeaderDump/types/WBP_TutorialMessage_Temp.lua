...
local UWBP_TutorialMessage_Temp_C = {}

---@param MsgID FDataTableRowHandle
function UWBP_TutorialMessage_Temp_C:GetCurrentMsgId(MsgID) end
---@param InText FText
---@param OutText FText
function UWBP_TutorialMessage_Temp_C:CreateGuideText(InText, OutText) end
---@param InputType ECommonInputType
UWBP_TutorialMessage_Temp_C['On Input Method Changed'] = function(self, InputType) end
