...
---@field WBP_PalInvisibleButton_CancelMenu UWBP_PalInvisibleButton_C
...
---@field ChangeRoleDialogMsgID FDataTableRowHandle
...
---@field ReservedChangePermissionTargetRole EPalGuildRole
---@field ChangeAdminDialogMsgID FDataTableRowHandle
---@field ReservedChangePermissionTargetPlayerUId FGuid
---@field LastClickedPlayerUId FGuid
local UWBP_Guild_ForDisplay_C = {}

---@param CanCloseFlag boolean
function UWBP_Guild_ForDisplay_C:CanClose(CanCloseFlag) end
function UWBP_Guild_ForDisplay_C:OnTimer_CheckChangeRole() end
function UWBP_Guild_ForDisplay_C:OnTimer_TimeoutChangeRole() end
...
UWBP_Guild_ForDisplay_C['On Close Change Role Dialog'] = function(self, bResult) end
---@param Role EPalGuildRole
UWBP_Guild_ForDisplay_C['Open Change Role Dialog'] = function(self, Role) end
---@param bResult boolean
...
function UWBP_Guild_ForDisplay_C:CloseMemberSettingList() end
...
function UWBP_Guild_ForDisplay_C:BndEvt__WBP_Guild_ForDisplay_WBP_GuildMemberMenu_K2Node_ComponentBoundEvent_1_OnClickedMenuCancel__DelegateSignature() end
function UWBP_Guild_ForDisplay_C:BndEvt__WBP_Guild_ForDisplay_WBP_Guild_K2Node_ComponentBoundEvent_5_OnClickedGuildSettingButton__DelegateSignature() end
---@param Button UCommonButtonBase
function UWBP_Guild_ForDisplay_C:BndEvt__WBP_Guild_ForDisplay_WBP_PalInvisibleButton_K2Node_ComponentBoundEvent_8_CommonButtonBaseClicked__DelegateSignature(Button) end
function UWBP_Guild_ForDisplay_C:BndEvt__WBP_Guild_ForDisplay_WBP_GuildMemberMenu_K2Node_ComponentBoundEvent_9_OnClickedChangeSubMaster__DelegateSignature() end
function UWBP_Guild_ForDisplay_C:BndEvt__WBP_Guild_ForDisplay_WBP_GuildMemberMenu_K2Node_ComponentBoundEvent_10_OnClickedChangeMember__DelegateSignature() end
function UWBP_Guild_ForDisplay_C:BndEvt__WBP_Guild_ForDisplay_WBP_GuildMemberMenu_K2Node_ComponentBoundEvent_11_OnClickedChangeGuest__DelegateSignature() end
