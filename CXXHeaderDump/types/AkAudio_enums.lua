...
local EAkAudioSessionCategoryOptions = {
    MixWithOthers = 0,
    DuckOthers = 1,
    AllowBluetooth = 2,
    DefaultToSpeaker = 3,
...
---@enum EAkUnrealAudioRouting
local EAkUnrealAudioRouting = {
    Custom = 0,
    Separate = 1,
    AudioLink = 2,
    AudioMixer = 3,
