...
---@field DebugType int32
local UBP_AIAction_OtomoFollow_C = {}

---@param IsFishing boolean
function UBP_AIAction_OtomoFollow_C:IsFishing(IsFishing) end
...
---@param Location FVector
function UBP_AIAction_OtomoFollow_C:GetTargetLocationInFishing(Location) end
---@param Location FVector
...
UBP_AIAction_OtomoFollow_C['Speed Control'] = function(self, DeltaTime) end
