...
local UWBP_OptionSettings_ListContentButton_C = {}

---@param PrevSettings FPalOptionUISettings
---@param NewSettings FPalOptionUISettings
function UWBP_OptionSettings_ListContentButton_C:OnUISettingChanged(PrevSettings, NewSettings) end
...
function UWBP_OptionSettings_ListContentButton_C:OnInitialized() end
