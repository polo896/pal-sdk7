...
---@field bIsInitiallyConflicted boolean
local UWBP_OptionSettings_C = {}

function UWBP_OptionSettings_C:ResetInnerSettingWidgets() end
---@param bResult boolean
function UWBP_OptionSettings_C:OnClosedKeyConflictWarning(bResult) end
function UWBP_OptionSettings_C:OpenKeyConflictWarning() end
---@param bConflicted boolean
function UWBP_OptionSettings_C:IsConflictAnyKey(bConflicted) end
