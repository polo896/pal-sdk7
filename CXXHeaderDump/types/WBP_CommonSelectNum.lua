...
---@param OutString FString
UWBP_CommonSelectNum_C['Check Numeric'] = function(self, checkString, OutString) end
...
---@param inMaxCount int64
---@param defaultCount int64
