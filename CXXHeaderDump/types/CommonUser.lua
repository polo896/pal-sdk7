...
local FCommonUserInitializeParams = {}
...
local FOnlineResultInformation = {}
...
local UAsyncAction_CommonUserInitialize = {}
...
local UCommonSession_HostSessionRequest = {}



---@class UCommonSession_SearchResult : UObject
local UCommonSession_SearchResult = {}
...
local UCommonSession_SearchSessionRequest = {}
