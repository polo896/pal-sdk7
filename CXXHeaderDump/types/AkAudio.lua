...
---@field DefaultAkComponentClass TSoftClassPtr<UAkComponent>
---@field LoadedDefaultAkComponentClass TSubclassOf<UAkComponent>
local UAkSettings = {}
...
local UAkXSXInitializationSettings = {}
