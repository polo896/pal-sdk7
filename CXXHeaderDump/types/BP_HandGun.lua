...
---@field IsCoolTime_0 boolean
---@field MagazineEmptyAnim UAnimMontage
local ABP_HandGun_C = {}
...
---@param isUse boolean
ABP_HandGun_C['Is UseEjectionPort'] = function(self, isUse) end
...
function ABP_HandGun_C:OnReleaseTrigger(bCanShootOnRelease) end
