...
local UWBP_IngameMenu_Mission_C = {}

function UWBP_IngameMenu_Mission_C:SequenceEvent__ENTRYPOINTWBP_IngameMenu_Mission() end
---@return UWidget
...
function UWBP_IngameMenu_Mission_C:SequenceEvent() end
