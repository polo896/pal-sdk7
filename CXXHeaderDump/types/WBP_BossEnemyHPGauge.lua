...
---@field UpdateDetailTimer FTimerHandle
local UWBP_BossEnemyHPGauge_C = {}

function UWBP_BossEnemyHPGauge_C:UpdateStatusEffect() end
function UWBP_BossEnemyHPGauge_C:OnTimerEvent_UpdateDetail() end
...
UWBP_BossEnemyHPGauge_C['On Update Level'] = function(self, addLevel, nowLevel) end
