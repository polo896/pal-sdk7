...
local ESkyCreatorEditorWeatherType = {
...
local ESkyCreatorMoonPositionType = {
...
local ESkyCreatorStarMapRotationType = {
...
local ESkyCreatorSunPositionType = {
...
local EVolumetricCloudNoiseDetailResolution = {
...
local EVolumetricCloudNoiseShapeResolution = {
...
local EVolumetricCloudRenderTargetMode = {
