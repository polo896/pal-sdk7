...
---@class ABP_BuildObject_SphereFactory_Black_04_C : APalBuildObject
...
local ABP_BuildObject_SphereFactory_Black_04_C = {}

function ABP_BuildObject_SphereFactory_Black_04_C:OnAvailable_BlueprintImpl() end
---@param Model UPalMapObjectConcreteModelBase
function ABP_BuildObject_SphereFactory_Black_04_C:OnSetConcreteModel(Model) end
function ABP_BuildObject_SphereFactory_Black_04_C:ReceiveBeginPlay() end
---@param EntryPoint int32
function ABP_BuildObject_SphereFactory_Black_04_C:ExecuteUbergraph_BP_BuildObject_SphereFactory_Black_04(EntryPoint) end
