...
local UBP_HitEffectSlot_Player_C = {}
...
UBP_HitEffectSlot_Player_C['Spawn Elemental Hit Effect Far'] = function(self, Element, Location, EffectScale, IsPoison, OverrideEffect) end
