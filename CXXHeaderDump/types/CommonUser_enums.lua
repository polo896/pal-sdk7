...
local ECommonSessionOnlineMode = {
    Offline = 0,
    LAN = 1,
    Online = 2,
...
local ECommonUserInitializationState = {
    Unknown = 0,
    DoingInitialLogin = 1,
    DoingNetworkLogin = 2,
    FailedtoLogin = 3,
...
local ECommonUserOnlineContext = {
    Game = 0,
    Default = 1,
    Service = 2,
    ServiceOrDefault = 3,
...
local ECommonUserPrivilegeResult = {
    Unknown = 0,
    Available = 1,
    UserNotLoggedIn = 2,
    LicenseInvalid = 3,
