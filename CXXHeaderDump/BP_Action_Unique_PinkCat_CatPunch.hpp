...
class UBP_Action_Unique_PinkCat_CatPunch_C : public UBP_ActionUniqueAttackBase_C
{
    ...
    double AttackTime;                                                                // 0x02A0 (size: 0x8)
    TEnumAsByte<EAction_PinkCat_CatPunch::Type> State;                                // 0x02A8 (size: 0x1)
    double MoveSpeed;                                                                 // 0x02B0 (size: 0x8)
    double HomingOffTrigger;                                                          // 0x02B8 (size: 0x8)
    double Max Speed Multiply;                                                        // 0x02C0 (size: 0x8)
    FTimerHandle TimerHandle1;                                                        // 0x02C8 (size: 0x8)
    FTimerHandle TimerHandle2;                                                        // 0x02D0 (size: 0x8)
