#ifndef UE4SS_SDK_BP_MushroomDragon_HPP
#define UE4SS_SDK_BP_MushroomDragon_HPP

class ABP_MushroomDragon_C : public ABP_MonsterBase_C
{
    class UPalBodyPartsCapsuleComponent* PalBodyPartsCapsule7;                        // 0x0D30 (size: 0x8)
    class UBP_PalRideMarkerSaddle_C* BP_PalRideMarkerSaddle;                          // 0x0D38 (size: 0x8)
