...
class UWBP_MainMenu_PalSkillSwap_C : public UPalUserWidgetOverlayUI
{
    ...
    class UImage* BaseBlack;                                                          // 0x0490 (size: 0x8)
    class UBP_PalTextBlock_C* BP_PalTextBlock_Title;                                  // 0x0498 (size: 0x8)
    class UScrollBox* ScrollBox_141;                                                  // 0x04A0 (size: 0x8)
    class UVerticalBox* VerticalBox_SkillList;                                        // 0x04A8 (size: 0x8)
    class UWBP_MainMenu_Pal_Skill_Active_C* WBP_MainMenu_Pal_Skill_Active;            // 0x04B0 (size: 0x8)
    class UWBP_MainMenu_Pal_Skill_Active_C* WBP_MainMenu_Pal_Skill_Active_1;          // 0x04B8 (size: 0x8)
    class UWBP_MainMenu_PalSkillInfo_C* WBP_MainMenu_PalSkillInfo;                    // 0x04C0 (size: 0x8)
    FWBP_MainMenu_PalSkillSwap_COnSelected OnSelected;                                // 0x04C8 (size: 0x10)
    void OnSelected(EPalWazaID SelectedWazaId);
    FDataTableRowHandle SkillSwapMsgID;                                               // 0x04D8 (size: 0x10)
    FDataTableRowHandle SkillSwapNothingMsgID;                                        // 0x04E8 (size: 0x10)
