#ifndef UE4SS_SDK_ABP_BlueSkyDragon_Implementation_HPP
#define UE4SS_SDK_ABP_BlueSkyDragon_Implementation_HPP
...
class UABP_BlueSkyDragon_Implementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_BlueSkyDragon_Implementation(int32 EntryPoint);
}; // Size: 0x1308
