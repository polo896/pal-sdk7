...
class ABP_PalSphere_Body_C : public ABP_PalCaptureBodyBase_C
{
    ...
    TEnumAsByte<EPalCaptureSphereState::Type> PalSphereState;                         // 0x0368 (size: 0x1)
    ...
    TMap<TEnumAsByte<E_PalCaptureSphereBouncedReason::Type>, UNiagaraSystem*> BounceEffectMap; // 0x0418 (size: 0x50)
    ...
    void CalculateCaptureRate(int32 CaptureLevel, bool SneakBonus, TArray<double>& rateArray);
