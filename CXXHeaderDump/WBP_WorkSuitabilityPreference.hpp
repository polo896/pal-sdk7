...
class UWBP_WorkSuitabilityPreference_C : public UPalUIWorkSuitabilitySelect
{
    ...
    class UWidgetAnimation* Default_In;                                               // 0x0490 (size: 0x8)
    class UWBP_WorkSuitabilityPreferenceMenu_C* WBP_WorkSuitabilityPreferenceMenu;    // 0x0498 (size: 0x8)
    FPalDataTableRowName_UIInputAction ToggleWorkerDetailInputAction;                 // 0x04A0 (size: 0x8)
    bool IsDisplayDetail;                                                             // 0x04A8 (size: 0x1)
