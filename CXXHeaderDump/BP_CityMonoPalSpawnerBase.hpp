...
class ABP_CityMonoPalSpawnerBase_C : public APalNPCSpawnerBase
{
    ...
    class UStaticMeshComponent* DebugMesh;                                            // 0x0540 (size: 0x8)
    class USphereComponent* SpawnCollision;                                           // 0x0548 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0550 (size: 0x8)
    bool NotSleepFlag;                                                                // 0x0558 (size: 0x1)
    class ABP_MonsterBase_C* tempSpawnedMonster;                                      // 0x0560 (size: 0x8)
    TArray<class UPalIndividualCharacterHandle*> IndividualHandleList;                // 0x0568 (size: 0x10)
    double ReturnTerritoryRadius;                                                     // 0x0578 (size: 0x8)
    double WanderingRadius;                                                           // 0x0580 (size: 0x8)
    FVector BattleStartLocation;                                                      // 0x0588 (size: 0x18)
    double SpawnRadius;                                                               // 0x05A0 (size: 0x8)
    double RayStartUpOffset;                                                          // 0x05A8 (size: 0x8)
    double WildLifeWalkingAreaRadius;                                                 // 0x05B0 (size: 0x8)
    TEnumAsByte<ELeashType::Type> LeashType;                                          // 0x05B8 (size: 0x1)
    double DespawnPlusDistance;                                                       // 0x05C0 (size: 0x8)
    bool IsLoading;                                                                   // 0x05C8 (size: 0x1)
    bool IsWorldLoadComplete;                                                         // 0x05C9 (size: 0x1)
    FName SpawnerName;                                                                // 0x05CC (size: 0x8)
    EPalSpawnedCharacterType SpawnerType;                                             // 0x05D4 (size: 0x1)
    double ReturnRadiusRate_Combat;                                                   // 0x05D8 (size: 0x8)
    int32 Level;                                                                      // 0x05E0 (size: 0x4)
    FPalDataTableRowName_PalMonsterData PalName;                                      // 0x05E4 (size: 0x8)
    TSubclassOf<class UPalActionBase> DefaultAction;                                  // 0x05F0 (size: 0x8)
    EPalFacialEyeType StartFacial;                                                    // 0x05F8 (size: 0x1)
    EPalOrganizationType OverridePalOrganizationType;                                 // 0x05F9 (size: 0x1)
