...
class ABP_MapObject_CommonDropItem3D_C : public APalMapObjectCommonDropItem3D
{
    ...
    class UPalInteractableSphereComponentNative* BP_InteractableSphere;               // 0x04B0 (size: 0x8)
    double ReleasePower;                                                              // 0x04B8 (size: 0x8)
    double ObtainDelayTime;                                                           // 0x04C0 (size: 0x8)
    bool bObtainableByProgress;                                                       // 0x04C8 (size: 0x1)
    TSubclassOf<class AActor> VisualActorClass;                                       // 0x04D0 (size: 0x8)
