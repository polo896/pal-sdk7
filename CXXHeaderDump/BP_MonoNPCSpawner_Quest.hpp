...
class ABP_MonoNPCSpawner_Quest_C : public ABP_MonoNPCSpawner_C
{
    ...
    FDataTableRowHandle QuestId;                                                      // 0x0620 (size: 0x10)
    FBP_MonoNPCSpawner_Quest_COnSpawned OnSpawned;                                    // 0x0630 (size: 0x10)
    void OnSpawned();
    bool DefaultAI Active;                                                            // 0x0640 (size: 0x1)
    UClass* QuestBlockClass;                                                          // 0x0648 (size: 0x8)
    TArray<FName> BattleTargetCharacterId;                                            // 0x0650 (size: 0x10)
    class USphereComponent* Sphere_ForceProgressQuest;                                // 0x0660 (size: 0x8)
