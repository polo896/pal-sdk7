...
{
    FWBP_CharaCre_ScrollBoxContentBase_COnNotifyOpenSelectColorWindow OnNotifyOpenSelectColorWindow; // 0x0450 (size: 0x10)
    void OnNotifyOpenSelectColorWindow();
    FWBP_CharaCre_ScrollBoxContentBase_COnNotifyCloseSelectColorWIndow OnNotifyCloseSelectColorWIndow; // 0x0460 (size: 0x10)
