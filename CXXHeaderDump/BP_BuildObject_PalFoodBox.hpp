...
class ABP_BuildObject_PalFoodBox_C : public APalBuildObject
{
    ...
    class UPalMapObjectStaticMeshComponentHiddenInNoItem* PalManger_Food;             // 0x0778 (size: 0x8)
    class UPalMapObjectFoodBoxParameterComponent* FoodBoxParameter;                   // 0x0780 (size: 0x8)
    class USphereComponent* CheckOverlapCollision;                                    // 0x0788 (size: 0x8)
    class UBP_InteractableBox_C* BP_InteractableBox;                                  // 0x0790 (size: 0x8)
    class UStaticMeshComponent* PalManger;                                            // 0x0798 (size: 0x8)
