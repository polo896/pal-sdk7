...
class ABP_FishingSpotPalSpawner_C : public APalNPCSpawnerBase
{
    ...
    class UStaticMeshComponent* Debug_Mesh;                                           // 0x0540 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0548 (size: 0x8)
    TArray<class UPalIndividualCharacterHandle*> IndividualHandleList;                // 0x0550 (size: 0x10)
    double SpawnRadius;                                                               // 0x0560 (size: 0x8)
    bool IsWorldLoadComplete;                                                         // 0x0568 (size: 0x1)
    bool IsSpawnRequested;                                                            // 0x0569 (size: 0x1)
    double DespawnPlusDistance;                                                       // 0x0570 (size: 0x8)
    double ReturnTerritoryRadius;                                                     // 0x0578 (size: 0x8)
    double WildLifeWalkingAreaRadius;                                                 // 0x0580 (size: 0x8)
    double ReturnRadiusRate_Combat;                                                   // 0x0588 (size: 0x8)
    TEnumAsByte<ELeashType::Type> Leash Type;                                         // 0x0590 (size: 0x1)
    double WanderingRadius;                                                           // 0x0598 (size: 0x8)
