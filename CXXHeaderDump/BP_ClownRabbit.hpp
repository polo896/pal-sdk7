#ifndef UE4SS_SDK_BP_ClownRabbit_HPP
#define UE4SS_SDK_BP_ClownRabbit_HPP

class ABP_ClownRabbit_C : public ABP_MonsterBase_C
{
    class UPalBodyPartsCapsuleComponent* PalBodyPartsCapsule13;                       // 0x0D30 (size: 0x8)
    class UPalBodyPartsCapsuleComponent* PalBodyPartsCapsule12;                       // 0x0D38 (size: 0x8)
    class UPalBodyPartsCapsuleComponent* PalBodyPartsCapsule11;                       // 0x0D40 (size: 0x8)
