...
class UBP_AIAction_AttackToReticleTarget_C : public UPalAIActionBase
{
    ...
    class APawn* ControlledPawn;                                                      // 0x0140 (size: 0x8)
    ...
    class APalCharacter* PlayerCharacter;                                             // 0x0158 (size: 0x8)
    bool IsAborted;                                                                   // 0x0160 (size: 0x1)
    class APalCharacter* TargetCharacter;                                             // 0x0168 (size: 0x8)
    double FindTargetElapedTime;                                                      // 0x0170 (size: 0x8)
    double FindTargetTimeLimit;                                                       // 0x0178 (size: 0x8)
    bool IsTargetFound;                                                               // 0x0180 (size: 0x1)
    FName flagName;                                                                   // 0x0184 (size: 0x8)
