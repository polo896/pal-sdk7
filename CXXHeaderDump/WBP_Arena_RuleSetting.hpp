...
class UWBP_Arena_RuleSetting_C : public UPalUserWidgetOverlayUI
{
    ...
    class UBP_PalTextBlock_C* BP_PalTextBlock_RestrictOtomo;                          // 0x0488 (size: 0x8)
    class UBP_PalTextBlock_C* BP_PalTextBlock_Title;                                  // 0x0490 (size: 0x8)
    class UCanvasPanel* CanvasPanel_Matching;                                         // 0x0498 (size: 0x8)
    class UImage* Image_RankIcon;                                                     // 0x04A0 (size: 0x8)
    class UScrollBox* ScrollBox;                                                      // 0x04A8 (size: 0x8)
    class UBP_PalTextBlock_C* Text_PlayerName_Lv;                                     // 0x04B0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_PlayerName_P1;                                     // 0x04B8 (size: 0x8)
    class UWBP_Arena_PalIcon_C* WBP_Arena_PalIcon;                                    // 0x04C0 (size: 0x8)
    class UWBP_Arena_PalIcon_C* WBP_Arena_PalIcon_1;                                  // 0x04C8 (size: 0x8)
    class UWBP_Arena_PalIcon_C* WBP_Arena_PalIcon_2;                                  // 0x04D0 (size: 0x8)
    class UWBP_Arena_PalIcon_C* WBP_Arena_PalIcon_3;                                  // 0x04D8 (size: 0x8)
    class UWBP_Arena_PalIcon_C* WBP_Arena_PalIcon_4;                                  // 0x04E0 (size: 0x8)
    class UWBP_Arena_Rule_ListGroup_C* WBP_Arena_Rule_ListGroup;                      // 0x04E8 (size: 0x8)
    class UWBP_Arena_RuleSetting_Pal_C* WBP_Arena_RuleSetting_Pal;                    // 0x04F0 (size: 0x8)
    class UWBP_CommonButton_C* WBP_CommonButton;                                      // 0x04F8 (size: 0x8)
    class UWBP_IngameMenu_PalBox_PalDetail_C* WBP_IngameMenu_PalBox_PalDetail;        // 0x0500 (size: 0x8)
    class UWBP_MainMenu_PalSkillInfo_C* WBP_MainMenu_PalSkillInfo;                    // 0x0508 (size: 0x8)
    class UWBP_Menu_btn_C* WBP_Menu_btn;                                              // 0x0510 (size: 0x8)
    class UPalHUDDispatchParameter_ArenaRule* ArenaRuleParamter;                      // 0x0518 (size: 0x8)
    FPalArenaRule CurrentRule;                                                        // 0x0520 (size: 0x38)
    TArray<class UWBP_Arena_PalIcon_C*> OtomoPalIcons;                                // 0x0558 (size: 0x10)
    FPalUIActionBindData SaveRuleAction;                                              // 0x0568 (size: 0x4)
    FPalUIActionBindData DefaultRuleAction;                                           // 0x056C (size: 0x4)
