#ifndef UE4SS_SDK_WBP_OptionSettings_MenuButton_S_HPP
#define UE4SS_SDK_WBP_OptionSettings_MenuButton_S_HPP

class UWBP_OptionSettings_MenuButton_S_C : public UUserWidget
{
    ...
    FWBP_OptionSettings_MenuButton_S_COnClicked OnClicked;                            // 0x02A8 (size: 0x10)
    void OnClicked();
