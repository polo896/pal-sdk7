#ifndef UE4SS_SDK_BP_BuildObject_SphereFactory_Black_04_HPP
#define UE4SS_SDK_BP_BuildObject_SphereFactory_Black_04_HPP

class ABP_BuildObject_SphereFactory_Black_04_C : public APalBuildObject
{
    ...
    void ExecuteUbergraph_BP_BuildObject_SphereFactory_Black_04(int32 EntryPoint);
}; // Size: 0x820
