...
class UWBP_InventoryEquipment_TabList_C : public UWBP_PanelWidgetChildrenSelectorBase_C
{
    ...
    class UCanvasPanel* Canvas_InventoryTab;                                          // 0x04B0 (size: 0x8)
    class UCanvasPanel* Canvas_SortButton;                                            // 0x04B8 (size: 0x8)
    class UHorizontalBox* HorizontalBox_1;                                            // 0x04C0 (size: 0x8)
    class UImage* TabIconBase;                                                        // 0x04C8 (size: 0x8)
    class UWBP_InventoryEquipment_InventoryTabButton_C* WBP_InventoryEquipment_InventoryTabButton_Essential; // 0x04D0 (size: 0x8)
    class UWBP_InventoryEquipment_InventoryTabButton_C* WBP_InventoryEquipment_InventoryTabButton_Inventory; // 0x04D8 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton_Sort;                     // 0x04E0 (size: 0x8)
    FWBP_InventoryEquipment_TabList_COnClickedSortButton OnClickedSortButton;         // 0x04E8 (size: 0x10)
