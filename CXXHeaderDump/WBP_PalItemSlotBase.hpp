...
class UWBP_PalItemSlotBase_C : public UPalUserWidget
{
    ...
    class UWBP_PalItemIconBase_C* myIconWidget;                                       // 0x0458 (size: 0x8)
    class UPalItemSlot* TargetSlot;                                                   // 0x0460 (size: 0x8)
    FWBP_PalItemSlotBase_COnUpdateSlot OnUpdateSlot;                                  // 0x0468 (size: 0x10)
    void OnUpdateSlot(class UPalItemSlot* TargetSlot);
    FWBP_PalItemSlotBase_COnSetEmpty OnSetEmpty;                                      // 0x0478 (size: 0x10)
    void OnSetEmpty();
    FWBP_PalItemSlotBase_COnSetValidSlot OnSetValidSlot;                              // 0x0488 (size: 0x10)
    void OnSetValidSlot();
    bool IsDisplayEmpty;                                                              // 0x0498 (size: 0x1)
    FWBP_PalItemSlotBase_COnLiftedSlot OnLiftedSlot;                                  // 0x04A0 (size: 0x10)
    void OnLiftedSlot(int32 LiftedItemNum);
    FWBP_PalItemSlotBase_COnFinishedLiftSlot OnFinishedLiftSlot;                      // 0x04B0 (size: 0x10)
    void OnFinishedLiftSlot();
    FTimerHandle CheckDurabilityTimerHandle;                                          // 0x04C0 (size: 0x8)
    FWBP_PalItemSlotBase_COnNotifyDurability OnNotifyDurability;                      // 0x04C8 (size: 0x10)
    void OnNotifyDurability(double MaxDurability, double NowDurability);
    FWBP_PalItemSlotBase_COnCorruptionUpdate OnCorruptionUpdate;                      // 0x04D8 (size: 0x10)
