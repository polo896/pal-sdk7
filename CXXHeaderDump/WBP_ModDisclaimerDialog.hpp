...
class UWBP_ModDisclaimerDialog_C : public UPalUserWidgetOverlayUI
{
    ...
    class UBP_PalTextBlock_C* BP_PalTextBlock_C_47;                                   // 0x0488 (size: 0x8)
    class UWBP_CommonButton_C* WBP_CommonButton;                                      // 0x0490 (size: 0x8)
    class UWBP_CommonButton_1_C* WBP_CommonButton_Guideline;                          // 0x0498 (size: 0x8)
