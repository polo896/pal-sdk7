#ifndef UE4SS_SDK_BP_SkillEffect_ChargeCanon_HPP
#define UE4SS_SDK_BP_SkillEffect_ChargeCanon_HPP

class ABP_SkillEffect_ChargeCanon_C : public ABP_SkillEffectBase_C
{
    ...
    void ExecuteUbergraph_BP_SkillEffect_ChargeCanon(int32 EntryPoint);
}; // Size: 0x460
