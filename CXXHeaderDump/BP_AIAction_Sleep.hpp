...
class UBP_AIAction_Sleep_C : public UBP_AIAction_CanCombatBase_C
{
    ...
    bool DeepSleep;                                                                   // 0x0180 (size: 0x1)
    class UPalActionComponent* ActionComp;                                            // 0x0188 (size: 0x8)
    class APawn* PawnSelf;                                                            // 0x0190 (size: 0x8)
    class UPalActionBase* SleepAction;                                                // 0x0198 (size: 0x8)
