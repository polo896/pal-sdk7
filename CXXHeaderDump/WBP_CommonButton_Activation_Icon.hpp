#ifndef UE4SS_SDK_WBP_CommonButton_Activation_Icon_HPP
#define UE4SS_SDK_WBP_CommonButton_Activation_Icon_HPP

class UWBP_CommonButton_Activation_Icon_C : public UUserWidget
{
    ...
    class UOverlay* Overlay_Activation;                                               // 0x02A0 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton;                          // 0x02A8 (size: 0x8)
    FWBP_CommonButton_Activation_Icon_COnClicked OnClicked;                           // 0x02B0 (size: 0x10)
    void OnClicked();
    bool Is First Focus Target;                                                       // 0x02C0 (size: 0x1)
    FWBP_CommonButton_Activation_Icon_COnHovered OnHovered;                           // 0x02C8 (size: 0x10)
    void OnHovered();
    FWBP_CommonButton_Activation_Icon_COnUnhovered OnUnhovered;                       // 0x02D8 (size: 0x10)
    void OnUnhovered();
    ...
    void OnInitialized();
    void ExecuteUbergraph_WBP_CommonButton_Activation_Icon(int32 EntryPoint);
