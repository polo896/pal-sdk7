...
class UWBP_OperatingTable_C : public UPalUserWidgetOverlayUI
{
    ...
    class UCanvasPanel* Canvas_ItemList;                                              // 0x0488 (size: 0x8)
    class UCanvasPanel* CanvasPanel_1;                                                // 0x0490 (size: 0x8)
    class UHorizontalBox* HorizontalBox_Tab;                                          // 0x0498 (size: 0x8)
    class UImage* Select;                                                             // 0x04A0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_GuildMenberHead;                                   // 0x04A8 (size: 0x8)
    class UWBP_Buildup_TabButton_C* WBP_Buildup_TabButton_Gender;                     // 0x04B0 (size: 0x8)
    class UWBP_Buildup_TabButton_C* WBP_Buildup_TabButton_Passive;                    // 0x04B8 (size: 0x8)
    class UWBP_IngameMenu_PalBox_PalDetail_C* WBP_IngameMenu_PalBox_PalDetail;        // 0x04C0 (size: 0x8)
    class UWBP_MainMenu_PalSkillInfo_C* WBP_MainMenu_PalSkillInfo;                    // 0x04C8 (size: 0x8)
    class UWBP_Menu_btn_C* WBP_Menu_btn_Close;                                        // 0x04D0 (size: 0x8)
    class UWBP_Menu_btn_C* WBP_Menu_btn_ListClose;                                    // 0x04D8 (size: 0x8)
    ...
    class UWBP_OperatingTable_TabPage_C* WBP_OperatingTable_TabPage;                  // 0x0508 (size: 0x8)
    class UWBP_PalCommonScrollList_C* WBP_PalCommonScrollList_Item;                   // 0x0510 (size: 0x8)
    class UWBP_PalCommonWindow_C* WBP_PalCommonWindow;                                // 0x0518 (size: 0x8)
    class UWBP_PalKeyGuideIcon_C* WBP_PalKeyGuideIcon_1;                              // 0x0520 (size: 0x8)
    TArray<class UWBP_Menu_PalList_C*> PalList;                                       // 0x0528 (size: 0x10)
    class UPalMapObjectOperatingTableModel* OperatingTableModel;                      // 0x0538 (size: 0x8)
    bool Hovering;                                                                    // 0x0540 (size: 0x1)
    class UPalIndividualCharacterHandle* CurrentHandle;                               // 0x0548 (size: 0x8)
    bool PinDetail;                                                                   // 0x0550 (size: 0x1)
    bool Requested;                                                                   // 0x0551 (size: 0x1)
    int32 CurrentTab;                                                                 // 0x0554 (size: 0x4)
    bool ParamUpdated;                                                                // 0x0558 (size: 0x1)
    bool Notified;                                                                    // 0x0559 (size: 0x1)
    class UPalIndividualCharacterParameter* BindedCharacterParam;                     // 0x0560 (size: 0x8)
    bool Updated;                                                                     // 0x0568 (size: 0x1)
    FName CachedConsumeItemId;                                                        // 0x056C (size: 0x8)
    FTimerHandle RefreshTimer;                                                        // 0x0578 (size: 0x8)
