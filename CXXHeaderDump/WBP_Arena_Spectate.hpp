...
class UWBP_Arena_Spectate_C : public UPalUserWidgetOverlayUI
{
    ...
    class UWBP_NoData_C* WBP_NoData;                                                  // 0x0498 (size: 0x8)
    class UWBP_PalKeyGuideIconAndText_C* WBP_PalKeyGuideIconAndText;                  // 0x04A0 (size: 0x8)
    class UWBP_PalKeyGuideIconAndText_C* WBP_PalKeyGuideIconAndText_1;                // 0x04A8 (size: 0x8)
    class APalArenaEntrance* Entrance;                                                // 0x04B0 (size: 0x8)
    TArray<FPalArenaSpectateRoomInfo> CachedInfo;                                     // 0x04B8 (size: 0x10)
    FPalUIActionBindData RuleActionInput;                                             // 0x04C8 (size: 0x4)
    FPalUIActionBindData SpecActionInput;                                             // 0x04CC (size: 0x4)
    int32 LastHoveredIndex;                                                           // 0x04D0 (size: 0x4)
