...
class ABP_MapObject_DroppedCharacter_C : public APalMapObject
{
    ...
    class UBP_InteractableCapsule_C* BP_InteractableCapsule;                          // 0x0420 (size: 0x8)
    ...
    double ReleasePower;                                                              // 0x0440 (size: 0x8)
    class AActor* InteractOther;                                                      // 0x0448 (size: 0x8)
    bool Auto Picked Up;                                                              // 0x0450 (size: 0x1)
    bool bEnableInteract;                                                             // 0x0451 (size: 0x1)
