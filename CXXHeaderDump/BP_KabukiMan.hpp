#ifndef UE4SS_SDK_BP_KabukiMan_HPP
#define UE4SS_SDK_BP_KabukiMan_HPP

class ABP_KabukiMan_C : public ABP_MonsterBase_C
{
    ...
    class UPalBodyPartsSphereComponent* PalBodyPartsSphere1;                          // 0x0D78 (size: 0x8)
