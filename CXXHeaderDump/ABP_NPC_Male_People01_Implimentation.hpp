...
class UABP_NPC_Male_People01_Implimentation_C : public UAnimInstance
{
    ...
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics;                              // 0x03D0 (size: 0x840)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose;                          // 0x0C10 (size: 0xC8)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x0CD8 (size: 0x20)
