...
class ABP_BuildObject_Fountain_C : public APalBuildObject
{
    ...
    class UNiagaraComponent* NS_Fountain;                                             // 0x0778 (size: 0x8)
    class UBP_InteractableBox_C* BP_InteractableBox;                                  // 0x0780 (size: 0x8)
    class UPalMapObjectBaseCampPassiveEffectWorkSpeedParameterComponent* BaseCampPassiveEffectWorkSpeedParameter; // 0x0788 (size: 0x8)
