...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_Skill_ThunderFunnel_Bullet_C;    // 0x0430(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UNiagaraComponent*                      NS_CommonSkill_ThunderFunnel_Bullet;               // 0x0438(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	double                                        LifeTimeAfterDestroyFunnel;                        // 0x0450(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_Skill_ThunderFunnel_Bullet_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_Skill_ThunderFunnel_Bullet_C")
	}
...
DUMPER7_ASSERTS_ABP_Skill_ThunderFunnel_Bullet_C;
