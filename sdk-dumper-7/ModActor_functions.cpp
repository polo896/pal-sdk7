...
void ModActor::AModActor_C::SaveToJson()
{
...
class FString ModActor::AModActor_C::PushedStackableUI(class APalHUDInGame** AsPal_HUDIn_Game, class UPalUserWidgetStackableUI** StackableWidget)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::PreBeginPlay()
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::PickUpAllEggs()
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::OnUpdatePalEggArray()
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::OnUpdateHatchedCharacterDelegate_Event(class UPalMapObjectHatchingEggModel* Model)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::OnReflectWorkAmountDelegate_Event(class UPalWorkProgress* WorkProgress)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::OnRecievedChatMessageDelegate_Event(const struct FPalChatMessage& Message)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::OnPushedStackableUI_Event(const struct FGuid& pushedWidgetID)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::OnCreateMapObject(class UPalMapObjectModel* MapObjectModel, const struct FVector& Vector)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::OnChangeSprintDelegate_Event(class UPalCharacterMovementComponent* Component, bool IsInSprint)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::OnAncientHatcheryReflectWorkAmount(class UPalWorkProgress* WorkProgress)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// class ModActor::AModActor_C**           Mod_Actor                                              (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ModActor::AModActor_C::Lua_ModInitialized(class ModActor::AModActor_C** Mod_Actor)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::LoadPlayerSettings(const class FString& UId, bool Enabled)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::GivePlayerID(int32 ID, int32* PlayerId)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::GetPlayerStateFromLua(const class FString& PlayerUId, class APalPlayerState* PlayerState)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::GetPlayerManagerFromLua(class UPalPlayerManager* Player_Manager_0)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::GetPalFromPaldexID()
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::GetObjectManagerFromLua(class UPalMapObjectManager* Object_Manager_0)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::GetLoggedInPlayerUId(const struct FGuid& ModelPlayerUId, struct FGuid* PlayerUId)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::GetIncubatorsOnLaunch()
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::GetGameStateFromLua(class APalGameStateInGame* Game_State_0)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::GetEggOwnerUIdSingle(class UPalMapObjectHatchingEggModel* PalMapObjectHatchingEggModel, struct FGuid* OwnerUId)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::GetEggOwnerUIdMulti(class UPalMapObjectMultiHatchingEggModel* PalMapObjectMultiHatchingEggModel, int32 Index_0, struct FGuid* OwnerUId)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::GetBytes(uint8 Byte)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::GetBreedFarms()
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::FinishInit(class APalCharacter* InCharacter)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::FindBreedFarmBelongTo(const struct FGuid& InstanceId)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::EggCleanUp(class UPalMapObjectModel* Target_Breed_Farm)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::ChatReceived(EPalChatCategory Category, const class FString& Sender, const class FString& Sender_Player_UId, const class FString& Message)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::BP_OnWidgetDeactivated_Event()
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::AutoPickUpEgg(class UPalMapObjectModel* Target_Egg, const struct FGuid& PlayerUId_In, struct FGuid* PlayerUId, class UPalMapObjectModel** TargetBreedFarm, class UPalMapObjectModel** Egg)
{
	static class UFunction* Func = nullptr;
...
void ModActor::AModActor_C::AutoHatch(const struct FGuid& PlayerUId)
{
	static class UFunction* Func = nullptr;
