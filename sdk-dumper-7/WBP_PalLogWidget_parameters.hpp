...
public:
	...
	struct FPalLogAdditionalData                  AdditionalData;                                    // 0x0020(0x0078)(BlueprintVisible, BlueprintReadOnly, Parm)
	class UPalLogWidgetBase*                      createdWidget;                                     // 0x0098(0x0008)(Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UPalLogWidgetBase*                      CallFunc_Create_ReturnValue;                       // 0x00A8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	struct FPalLogAdditionalData                  logAdditionalData;                                 // 0x0018(0x0078)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	int32                                         EnableLogCount;                                    // 0x0090(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_94[0x4];                                       // 0x0094(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalLogWidgetBase*                      createdWidget;                                     // 0x0098(0x0008)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UPalLogWidgetBase*                      CallFunc_Array_Get_Item;                           // 0x00E8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                   CallFunc_CreateSphereRecoveryLogText_ReturnValue;  // 0x00F8(0x0018)()
	class FText                                   CallFunc_CreateItemGetLogText_ReturnValue;         // 0x0110(0x0018)()
	...
	bool                                          CallFunc_LessEqual_ByteByte_ReturnValue;           // 0x0129(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UScrollBoxSlot*                         CallFunc_SlotAsScrollBoxSlot_ReturnValue;          // 0x0130(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UPalLogWidgetBase*                      CallFunc_CreateLogWidget_createdWidget;            // 0x0150(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UPalLogWidgetBase*                      CallFunc_CreateLogWidget_createdWidget_1;          // 0x0158(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UPalLogWidgetBase*                      CallFunc_Array_Get_Item_1;                         // 0x0168(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UPalLogWidgetBase*                      CallFunc_Array_Get_Item_2;                         // 0x0170(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
public:
	class FText                                   LogText;                                           // 0x0000(0x0018)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	struct FPalLogAdditionalData                  logAdditionalData;                                 // 0x0018(0x0078)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	class UPalLogWidgetBase*                      CreatedLogWidget;                                  // 0x0090(0x0008)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UPalLogWidgetBase*                      CallFunc_CreateLogWidget_createdWidget;            // 0x0098(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UPalLogWidgetBase*                      CallFunc_CreateLogWidget_createdWidget_1;          // 0x00A0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	struct FPalLogAdditionalData                  logAdditionalData;                                 // 0x0028(0x0078)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	class UPalLogWidgetBase*                      NewLocalVar_0;                                     // 0x00A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UPalLogWidgetBase*                      CallFunc_CreateLogWidget_createdWidget;            // 0x00A8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
