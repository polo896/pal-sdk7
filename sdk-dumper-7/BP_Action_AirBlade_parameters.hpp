...
struct BP_Action_AirBlade_C_ExecuteUbergraph_BP_Action_AirBlade final
{
public:
	...
	class ABP_SkillEffect_AirBlade_Blade_C*       CallFunc_FinishSpawningActor_ReturnValue;          // 0x0108(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_BP_Action_AirBlade_C_ExecuteUbergraph_BP_Action_AirBlade;
