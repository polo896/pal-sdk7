...
// BlueprintGeneratedClass BP_BuildObject_MultiElectricHatchingPalEggWithBreed.BP_BuildObject_MultiElectricHatchingPalEggWithBreed_C
// 0x0170 (0x08E0 - 0x0770)
class ABP_BuildObject_MultiElectricHatchingPalEggWithBreed_C final : public APalBuildObject
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame;                                    // 0x0770(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UStaticMeshComponent*                   PalSphereLight1;                                   // 0x0778(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UStaticMeshComponent*                   PalSphereLight;                                    // 0x0780(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UPalBuildObjectHUDLocatorComponent*     HUDLocator_Breed;                                  // 0x0788(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UPalMapObjectMultiHatchingEggWithBreedParameterComponent* MultiHatchingEggWithBreedParameter; // 0x0790(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	class UNiagaraComponent*                      NS_HatchingEggFinishGlow;                          // 0x07A0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UChildActorComponent*                   PalEggChildActor;                                  // 0x07A8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void OnLoaded_527A9D01425B6535179E52B955C08E9C(TSubclassOf<class UObject> Loaded);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_BuildObject_MultiElectricHatchingPalEggWithBreed_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_BuildObject_MultiElectricHatchingPalEggWithBreed_C")
	}
	static class ABP_BuildObject_MultiElectricHatchingPalEggWithBreed_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_BuildObject_MultiElectricHatchingPalEggWithBreed_C>();
	}
};
DUMPER7_ASSERTS_ABP_BuildObject_MultiElectricHatchingPalEggWithBreed_C;
