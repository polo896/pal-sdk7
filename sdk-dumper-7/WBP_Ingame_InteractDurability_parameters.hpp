...
public:
	...
	struct FPalOptionWorldSettings                CallFunc_GetOptionWorldSettings_ReturnValue;       // 0x0218(0x0210)(ConstParm)
	...
	TDelegate<void(bool bSuccess, const struct FGuid& PlayerUId, const class FString& PlayerName, const struct FGuid& GroupId, const class FString& GuildName)> K2Node_CreateDelegate_OutputDelegate; // 0x0430(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
