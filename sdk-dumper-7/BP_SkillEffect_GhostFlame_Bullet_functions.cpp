...
#include "BP_SkillEffect_GhostFlame_Bullet_classes.hpp"
#include "BP_SkillEffect_GhostFlame_Bullet_parameters.hpp"
...
void ABP_SkillEffect_GhostFlame_Bullet_C::OnHitDelegate_イベント(class UPrimitiveComponent* MyHitComponent, class AActor* OtherHitActor, class UPrimitiveComponent* OtherHitComponent, const TArray<int32>& FoliageIndex, const struct FVector& HitLocation, int32 HitCount)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkillEffect_GhostFlame_Bullet_C_OnHitDelegate_イベント Parms{};
