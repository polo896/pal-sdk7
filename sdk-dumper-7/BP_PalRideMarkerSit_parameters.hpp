...
public:
	...
	bool                                          K2Node_CustomEvent_IsEnable;                       // 0x000C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(bool IsEnable)>                K2Node_CreateDelegate_OutputDelegate;              // 0x002C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_SetMaterialProgress_progress_ImplicitCast; // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_PalRideMarkerSit_C_ExecuteUbergraph_BP_PalRideMarkerSit;

// Function BP_PalRideMarkerSit.BP_PalRideMarkerSit_C.OnChangeRiding_イベント_0
// 0x0001 (0x0001 - 0x0000)
struct BP_PalRideMarkerSit_C_OnChangeRiding_イベント_0 final
{
public:
...
DUMPER7_ASSERTS_BP_PalRideMarkerSit_C_OnChangeRiding_イベント_0;
...
DUMPER7_ASSERTS_BP_PalRideMarkerSit_C_ReceiveTick;
...
DUMPER7_ASSERTS_BP_PalRideMarkerSit_C_ResetMaterial;
...
DUMPER7_ASSERTS_BP_PalRideMarkerSit_C_SetMaterialProgress;
