...
// Function WBP_PlayerUI.WBP_PlayerUI_C.OnChangeAimFishingSpot
// 0x0003 (0x0003 - 0x0000)
struct WBP_PlayerUI_C_OnChangeAimFishingSpot final
{
public:
	bool                                          bIsSpotAiming;                                     // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Not_PreBool_ReturnValue;                  // 0x0001(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BooleanOR_ReturnValue;                    // 0x0002(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_WBP_PlayerUI_C_OnChangeAimFishingSpot;
...
public:
	...
	struct FPalLogAdditionalData                  K2Node_MakeStruct_PalLogAdditionalData;            // 0x01D0(0x0078)()
	class FText                                   CallFunc_Format_ReturnValue;                       // 0x0248(0x0018)()
	class UPalLogManager*                         CallFunc_GetLogManager_ReturnValue;                // 0x0260(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGuid                                  CallFunc_AddLog_ReturnValue;                       // 0x0268(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	TDelegate<void(class UPalBuilderComponent* Self)> K2Node_CreateDelegate_OutputDelegate;          // 0x0008(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_1;            // 0x0018(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class UPalItemContainer* Container)> K2Node_CreateDelegate_OutputDelegate_2;      // 0x0028(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FTimerHandle                           CallFunc_K2_SetTimerDelegate_ReturnValue;          // 0x0038(0x0008)(NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class UPalBuilderComponent* Self)> K2Node_CreateDelegate_OutputDelegate_3;        // 0x0040(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class APalCharacter* TargetCharacter, bool AlwaysDisplay)> K2Node_CreateDelegate_OutputDelegate_6; // 0x0070(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_11;           // 0x0108(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class UPalBuilderComponent* Self)> K2Node_CreateDelegate_OutputDelegate_12;       // 0x0118(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(bool bVisible)>                K2Node_CreateDelegate_OutputDelegate_13;           // 0x0128(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalHUDService*                         CallFunc_GetHUDService_ReturnValue;                // 0x0138(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const struct FVector& AttackerLocation, bool IsEnable, const struct FGuid& AttackerID)> K2Node_CreateDelegate_OutputDelegate_14; // 0x0140(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class APalPlayerController*                   CallFunc_GetLocalPalPlayerController_ReturnValue;  // 0x0158(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalPlayerController*                   K2Node_DynamicCast_AsPal_Player_Controller;        // 0x0160(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class APalCharacter* TargetCharacter, bool AlwaysDisplay)> K2Node_CreateDelegate_OutputDelegate_15; // 0x016C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(int32 WantedLevel)>            K2Node_CreateDelegate_OutputDelegate_16;           // 0x017C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class APalCharacter*>                  CallFunc_GetForceWarningLoupeList_List;            // 0x01A0(0x0010)(ReferenceParm)
	...
	bool                                          CallFunc_IsValid_ReturnValue_4;                    // 0x01B5(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class UPalArenaSequencer* ArenaSequencer)> K2Node_CreateDelegate_OutputDelegate_17; // 0x01C4(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class APalInvaderInfo* SelfInvaderInfo, int32 NewWaveCount)> K2Node_CreateDelegate_OutputDelegate_18; // 0x01E0(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class APalInvaderInfo* SelfInvaderInfo, int32 EndWaveCount)> K2Node_CreateDelegate_OutputDelegate_19; // 0x01F8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(bool CancelEnable)>            K2Node_CreateDelegate_OutputDelegate_20;           // 0x020C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_21;           // 0x021C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(bool IsSleep)>                 K2Node_CreateDelegate_OutputDelegate_22;           // 0x022C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_23C[0x4];                                      // 0x023C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class APalPlayerCharacter*                    CallFunc_GetPalmi_ReturnValue_3;                   // 0x0240(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_23;           // 0x0248(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class APalCharacter* LiftingPal)> K2Node_CreateDelegate_OutputDelegate_24;        // 0x025C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const struct FPalInstanceID& CriminalIndividualId, const TArray<class FName>& CrimeIds)> K2Node_CreateDelegate_OutputDelegate_25; // 0x026C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class UPalIndividualCharacterHandle* CriminalHandle)> K2Node_CreateDelegate_OutputDelegate_26; // 0x027C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_27;           // 0x028C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const struct FPalArenaEntryPair& EntryPair)> K2Node_CreateDelegate_OutputDelegate_28; // 0x029C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class FName BossType, EPalBossBattleDifficulty Difficulty, const TArray<class APalPlayerCharacter*>& PlayerList, const bool ShouldMask)> K2Node_CreateDelegate_OutputDelegate_29; // 0x02AC(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const struct FGuid& CrimeInstanceId)> K2Node_CreateDelegate_OutputDelegate_30;    // 0x02BC(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const struct FDateTime& StartRealTime)> K2Node_CreateDelegate_OutputDelegate_31;  // 0x02CC(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(const struct FPalIncidentBroadcastParameter& Parameter)> K2Node_CreateDelegate_OutputDelegate_34; // 0x030C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_37;           // 0x0348(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FTimerHandle                           CallFunc_K2_SetTimerDelegate_ReturnValue_2;        // 0x0358(0x0008)(NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_38;           // 0x0360(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(float MaxWeight)>              K2Node_CreateDelegate_OutputDelegate_39;           // 0x0378(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(float NowWeight)>              K2Node_CreateDelegate_OutputDelegate_40;           // 0x0388(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class UPalBuilderComponent* Self)> K2Node_CreateDelegate_OutputDelegate_41;       // 0x03A0(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class UPalBuilderComponent* Self)> K2Node_CreateDelegate_OutputDelegate_42;       // 0x03B4(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const TArray<struct FPalStaticItemIdAndNum>& StackItems)> K2Node_CreateDelegate_OutputDelegate_43; // 0x03C4(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3D4[0x4];                                      // 0x03D4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class APalPlayerCharacter*                    CallFunc_GetPalmi_ReturnValue_4;                   // 0x03D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalBuilderComponent*                   CallFunc_GetComponentByClass_ReturnValue_1;        // 0x03E0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(const struct FPalUICommonItemRewardData& RewardData)> K2Node_CreateDelegate_OutputDelegate_44; // 0x03F8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_45;           // 0x0408(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_46;           // 0x0418(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(bool IsAlerted, bool IsFound, float DiscoveryGaugeNormalized, float DiscoveryGaugeRatePerSec, bool IsWanted)> K2Node_CreateDelegate_OutputDelegate_47; // 0x0428(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalPlayerCharacter*                    CallFunc_GetPalmi_ReturnValue_5;                   // 0x0438(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalJetpackGliderComponent*             CallFunc_GetComponentByClass_ReturnValue_2;        // 0x0440(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const struct FGuid& campID, EPalRaidBossBattleFinishType FinishType)> K2Node_CreateDelegate_OutputDelegate_48; // 0x0448(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const struct FGuid& campID)>   K2Node_CreateDelegate_OutputDelegate_49;           // 0x0458(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class APalBossTower* BossTower)> K2Node_CreateDelegate_OutputDelegate_50;         // 0x0468(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(EPalBossBattleCombatResult CombatResult, bool bIsSkipUI)> K2Node_CreateDelegate_OutputDelegate_51; // 0x0478(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_52;           // 0x0488(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalBossBattleManager*                  CallFunc_GetBossBattleManager_ReturnValue;         // 0x0498(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class FName BossType, EPalBossBattleDifficulty Difficulty, const TArray<class APalPlayerCharacter*>& PlayerList, const bool ShouldMask)> K2Node_CreateDelegate_OutputDelegate_53; // 0x04A0(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue_11;                   // 0x04B0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4B1[0x3];                                      // 0x04B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_54;           // 0x04B4(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_55;           // 0x04C4(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(bool bIsSpotAiming)>           K2Node_CreateDelegate_OutputDelegate_56;           // 0x04D4(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4E4[0x4];                                      // 0x04E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class APalPlayerCharacter*                    CallFunc_GetPalmi_ReturnValue_6;                   // 0x04E8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(int32 NextTemperature)>        K2Node_CreateDelegate_OutputDelegate_57;           // 0x04F0(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(EPalBodyTemperatureState BodyState)> K2Node_CreateDelegate_OutputDelegate_58;     // 0x0504(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_514[0x4];                                      // 0x0514(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class APalPlayerCharacter*                    CallFunc_GetPalmi_ReturnValue_7;                   // 0x0518(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class AActor* RideActor)>      K2Node_CreateDelegate_OutputDelegate_59;           // 0x0520(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalBodyTemperatureComponent*           CallFunc_GetComponentByClass_ReturnValue_3;        // 0x0530(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class AActor* RideActor)>      K2Node_CreateDelegate_OutputDelegate_60;           // 0x0538(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalPlayerCharacter*                    CallFunc_GetPalmi_ReturnValue_8;                   // 0x0548(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const class FName& RegionNameID)> K2Node_CreateDelegate_OutputDelegate_61;        // 0x0550(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalRiderComponent*                     CallFunc_GetComponentByClass_ReturnValue_4;        // 0x0560(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class APalPlayerCharacter*                    CallFunc_GetPalmi_ReturnValue_9;                   // 0x0568(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class FName                                   CallFunc_GetLastInsideRegionNameID_OutNameID;      // 0x0570(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFixedPoint64                          CallFunc_GetShieldMaxHP_ReturnValue;               // 0x0578(0x0008)(NoDestructor)
	struct FFixedPoint64                          CallFunc_GetShieldHP_ReturnValue;                  // 0x0580(0x0008)(NoDestructor)
	TDelegate<void(const struct FPalDamageResult& DamageResult)> K2Node_CreateDelegate_OutputDelegate_62; // 0x0588(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalPlayerCharacter*                    CallFunc_GetPalmi_ReturnValue_10;                  // 0x0598(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class APalCharacter*                          CallFunc_Array_Get_Item;                           // 0x05A8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const struct FPalUICommonExpRewardData& RewardData)> K2Node_CreateDelegate_OutputDelegate_63; // 0x05B0(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(int32 SlotIndex, class UPalIndividualCharacterHandle* LastHandle)> K2Node_CreateDelegate_OutputDelegate_64; // 0x05C0(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_65;           // 0x05D0(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_66;           // 0x05E0(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_67;           // 0x05F0(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_68;           // 0x0600(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(const struct FFixedPoint64& nowShieldMaxHP)> K2Node_CreateDelegate_OutputDelegate_69; // 0x0618(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_70;           // 0x062C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(const struct FFixedPoint64& nowShieldMaxHP, const struct FFixedPoint64& nowShieldHP)> K2Node_CreateDelegate_OutputDelegate_71; // 0x0648(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(int32 Damage, bool IsShieldBroken)> K2Node_CreateDelegate_OutputDelegate_72;      // 0x0658(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const struct FPalIncidentBroadcastParameter& Parameter)> K2Node_CreateDelegate_OutputDelegate_73; // 0x0668(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetFullStomach_ReturnValue;               // 0x0678(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(float Current, float Last)>    K2Node_CreateDelegate_OutputDelegate_74;           // 0x067C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_68C[0x4];                                      // 0x068C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalGameSetting*                        CallFunc_GetGameSetting_ReturnValue;               // 0x0690(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(const struct FFixedPoint64& nowHP, const struct FFixedPoint64& nowMaxHP)> K2Node_CreateDelegate_OutputDelegate_75; // 0x06A8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(EPalPlayerInventoryType inventoryType, int32 Index)> K2Node_CreateDelegate_OutputDelegate_76; // 0x06B8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalPlayerCharacter*                    CallFunc_GetPalmi_ReturnValue_12;                  // 0x06C8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_77;           // 0x06D0(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_GetNowSelectedIndex_ReturnValue;          // 0x06E4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(EWeaponNotifyType Type)>       K2Node_CreateDelegate_OutputDelegate_78;           // 0x06E8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalOtomoHolderComponentBase*           CallFunc_GetOtomoHolderComponent_ReturnValue;      // 0x06F8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_79;           // 0x0700(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue_15;                   // 0x0710(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_711[0x7];                                      // 0x0711(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UBP_OtomoPalHolderComponent_C*          K2Node_DynamicCast_AsBP_Otomo_Pal_Holder_Component; // 0x0718(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_80;           // 0x0724(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(const struct FPalUIPalCaptureInfo& CaptureInfo)> K2Node_CreateDelegate_OutputDelegate_81; // 0x0740(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(const struct FFixedPoint64& nowSP, const struct FFixedPoint64& nowMaxSP, bool IsOverHeated)> K2Node_CreateDelegate_OutputDelegate_82; // 0x0788(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const struct FFixedPoint64& nowHP, const struct FFixedPoint64& nowMaxHP)> K2Node_CreateDelegate_OutputDelegate_83; // 0x0798(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
