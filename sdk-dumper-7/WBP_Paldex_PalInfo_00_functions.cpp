...
void UWBP_Paldex_PalInfo_00_C::OnHoveredSuitability_Internal(class UWBP_MainMenu_Pal_WorkIconText_C* Widget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Paldex_PalInfo_00_C", "OnHoveredSuitability_Internal");

	Params::WBP_Paldex_PalInfo_00_C_OnHoveredSuitability_Internal Parms{};
...
// Function WBP_Paldex_PalInfo_00.WBP_Paldex_PalInfo_00_C.OnUnhoveredSuitability_Internal
// (Public, BlueprintCallable, BlueprintEvent)

void UWBP_Paldex_PalInfo_00_C::OnUnhoveredSuitability_Internal()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Paldex_PalInfo_00_C", "OnUnhoveredSuitability_Internal");
