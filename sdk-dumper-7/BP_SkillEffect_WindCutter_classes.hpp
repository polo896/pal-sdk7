...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_SkillEffect_WindCutter_C;        // 0x0430(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UNiagaraComponent*                      NS_WindCutterBullet;                               // 0x0438(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_SkillEffect_WindCutter_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_SkillEffect_WindCutter_C")
	}
...
DUMPER7_ASSERTS_ABP_SkillEffect_WindCutter_C;
