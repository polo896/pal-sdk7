...
class ABP_PickMainMeshVolume_C : public AActor
{
    ...
    int32 MaterialVolumePriority;                                                     // 0x02AC (size: 0x4)
    ...
    void Begin or End Overlapped(class AActor* Actor, const FBegin or End OverlappedSkel_AppliedMakeInfoEvent& Skel_AppliedMakeInfoEvent, bool IsBegin);
