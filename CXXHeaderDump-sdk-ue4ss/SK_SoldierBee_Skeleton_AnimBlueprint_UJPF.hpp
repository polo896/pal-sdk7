#ifndef UE4SS_SDK_SK_SoldierBee_Skeleton_AnimBlueprint_UJPF_HPP
#define UE4SS_SDK_SK_SoldierBee_Skeleton_AnimBlueprint_UJPF_HPP
...
class USK_SoldierBee_Skeleton_AnimBlueprint_UJPF_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_SK_SoldierBee_Skeleton_AnimBlueprint_UJPF(int32 EntryPoint);
}; // Size: 0x740
