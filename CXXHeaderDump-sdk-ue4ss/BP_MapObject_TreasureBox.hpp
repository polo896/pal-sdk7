...
class ABP_MapObject_TreasureBox_C : public APalMapObjectTreasureBox
{
    ...
    class UPalPickingGameDataComponent* PalPickingGameData;                           // 0x0470 (size: 0x8)
    ...
    TMap<class EPalMapObjectTreasureGradeType, class TSubclassOf<AActor>> VisualMap;  // 0x0490 (size: 0x50)
