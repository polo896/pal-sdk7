...
class UBP_ActionUniqueAttackBase_C : public UPalActionWazaBase
{
    ...
    TArray<TSoftObjectPtr<class APalSkillEffectBase>> SpawnedEffects;                 // 0x01C8 (size: 0x10)
    TMap<FName, FSkillEffectSpawnParameter> SkillEffectSpawnParameters;               // 0x01D8 (size: 0x50)
    ...
    TArray<UPalShooterSpringArmComponent*> RegistedCameraOffsetComponents;            // 0x0280 (size: 0x10)
