...
class UWBP_Trading_Pal_C : public UPalUserWidgetOverlayUI
{
    ...
    class UCanvasPanel* Canvas_SellList;                                              // 0x0490 (size: 0x8)
    class UCanvasPanel* Canvas_SellSetting;                                           // 0x0498 (size: 0x8)
    class UCheckBox* CheckBox_PrivateLock;                                            // 0x04A0 (size: 0x8)
    class UHorizontalBox* HorizontalBox_Lock_1;                                       // 0x04A8 (size: 0x8)
    class UHorizontalBox* HorizontalBox_SellSetting_Head;                             // 0x04B0 (size: 0x8)
    class UHorizontalBox* HorizontalBoxSellListHead_;                                 // 0x04B8 (size: 0x8)
    class UImage* Image_ItemSlot_Add;                                                 // 0x04C0 (size: 0x8)
    class UImage* Image_PalSlot_Add;                                                  // 0x04C8 (size: 0x8)
    class UPalEditableTextBox* PalEditableTextBox_CostNum;                            // 0x04D0 (size: 0x8)
    class UWBP_BoxPalList_Party_C* WBP_BoxPalList_Party;                              // 0x04D8 (size: 0x8)
    class UWBP_CommonButton_1_C* WBP_CommonButton_Cancel;                             // 0x04E0 (size: 0x8)
    class UWBP_CommonButton_C* WBP_CommonButton_Confirm;                              // 0x04E8 (size: 0x8)
    ...
    class UWBP_PalCommonCharacterSlotButton_C* WBP_PalCommonCharacterSlotButton_Edit; // 0x0500 (size: 0x8)
    class UWBP_PalInGameMenuItemSlotButton_C* WBP_PalInGameMenuItemSlotButton_Cost;   // 0x0508 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton_Lock;                     // 0x0510 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton_Minus;                    // 0x0518 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton_Plus;                     // 0x0520 (size: 0x8)
    class UWBP_Trading_Item_List_C* WBP_Trading_Item_List;                            // 0x0528 (size: 0x8)
    class UWBP_Trading_Item_List_C* WBP_Trading_Item_List_1;                          // 0x0530 (size: 0x8)
    class UWBP_Trading_Item_List_C* WBP_Trading_Item_List_2;                          // 0x0538 (size: 0x8)
    class UWBP_Trading_Item_List_C* WBP_Trading_Item_List_3;                          // 0x0540 (size: 0x8)
    class UWBP_Trading_Item_List_C* WBP_Trading_Item_List_4;                          // 0x0548 (size: 0x8)
    class UPalMapObjectPalBoothModel* PalBoothModel;                                  // 0x0550 (size: 0x8)
    TArray<class UWBP_PalCommonCharacterSlotButton_C*> PartyPalSlots;                 // 0x0558 (size: 0x10)
    class UWBP_PalCharacterSlotButtonBase_C* CachedLastHoveredSlot;                   // 0x0568 (size: 0x8)
    FPalUIActionBindData ViewDetailInputHandle;                                       // 0x0570 (size: 0x4)
    TArray<class UWBP_Trading_Item_List_C*> TradingList;                              // 0x0578 (size: 0x10)
    FPalPalBoothTradeInfo CurrentTradeInfo;                                           // 0x0588 (size: 0x70)
    FText LastCostNum;                                                                // 0x05F8 (size: 0x18)
    bool Confirmable;                                                                 // 0x0610 (size: 0x1)
    int32 EditingIndex;                                                               // 0x0614 (size: 0x4)
    bool SelectingProduct;                                                            // 0x0618 (size: 0x1)
    TEnumAsByte<EPalBoxHoveredSlotType::Type> hoverdSlotType;                         // 0x0619 (size: 0x1)
    class UPalIndividualCharacterHandle* LastHoveredTradePalHandle;                   // 0x0620 (size: 0x8)
    bool EnableEdit;                                                                  // 0x0628 (size: 0x1)
    FPalDataTableRowName_UIInputAction FavoriteShortcutInput;                         // 0x062C (size: 0x8)
    FPalUIActionBindData FavoriteInputHandle;                                         // 0x0634 (size: 0x4)
