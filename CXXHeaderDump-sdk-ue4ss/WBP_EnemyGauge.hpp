...
class UWBP_EnemyGauge_C : public UUserWidget
{
    ...
    class UImage* IconSleeping_1;                                                     // 0x0330 (size: 0x8)
    class UImage* Image;                                                              // 0x0338 (size: 0x8)
    class UImage* Image_1;                                                            // 0x0340 (size: 0x8)
    class UImage* Image_145;                                                          // 0x0348 (size: 0x8)
    class UImage* Image_Base;                                                         // 0x0350 (size: 0x8)
    class UImage* Image_CaptureIcon;                                                  // 0x0358 (size: 0x8)
    class UImage* Image_Frame;                                                        // 0x0360 (size: 0x8)
    class UImage* Image_Mutant;                                                       // 0x0368 (size: 0x8)
    class UImage* Image_StatusIconEffect;                                             // 0x0370 (size: 0x8)
    class UImage* Image_Strong_Rare;                                                  // 0x0378 (size: 0x8)
    class UOverlay* Overlay_Potencial;                                                // 0x0380 (size: 0x8)
    class UImage* PalEnemyBase_Hunger;                                                // 0x0388 (size: 0x8)
    class UProgressBar* ProgressBar_HP;                                               // 0x0390 (size: 0x8)
    class UProgressBar* ProgressBar_HPBack;                                           // 0x0398 (size: 0x8)
    class URetainerBox* RetainerBox_CommonDetail;                                     // 0x03A0 (size: 0x8)
    class USizeBox* SizeBox_CaptureIcon;                                              // 0x03A8 (size: 0x8)
    class USizeBox* SizeBox_Gender;                                                   // 0x03B0 (size: 0x8)
    class USizeBox* SizeBox_Lv;                                                       // 0x03B8 (size: 0x8)
    class USizeBox* SizeBox_StatusEffect;                                             // 0x03C0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_GuildName;                                         // 0x03C8 (size: 0x8)
    class UBP_PalTextBlock_C* Text_LevelNum;                                          // 0x03D0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_Name;                                              // 0x03D8 (size: 0x8)
    class UBP_PalTextBlock_C* Text_WorkName;                                          // 0x03E0 (size: 0x8)
    class UWBP_EnemyGauge_SAN_C* WBP_EnemyGauge_SAN;                                  // 0x03E8 (size: 0x8)
    class UWBP_MainMenu_Pal_State_C* WBP_MainMenu_Pal_State;                          // 0x03F0 (size: 0x8)
    class UWBP_PalElementIcon_C* WBP_PalElementIcon_Double_00;                        // 0x03F8 (size: 0x8)
    class UWBP_PalElementIcon_C* WBP_PalElementIcon_Double_01;                        // 0x0400 (size: 0x8)
    class UWBP_PalElementIcon_C* WBP_PalElementIcon_Single;                           // 0x0408 (size: 0x8)
    class UWBP_PalGenderIcon_C* WBP_PalGenderIcon;                                    // 0x0410 (size: 0x8)
    TMap<int32, UTexture2D*> RankIconMap;                                             // 0x0418 (size: 0x50)
    FColor enemyColor;                                                                // 0x0468 (size: 0x4)
    FColor friendColor;                                                               // 0x046C (size: 0x4)
    FColor NeutralColor;                                                              // 0x0470 (size: 0x4)
    FColor NormalBackColor;                                                           // 0x0474 (size: 0x4)
    FColor BackNeutralColor;                                                          // 0x0478 (size: 0x4)
    class UPalUIDelayGaugeCalculator* delayGaugeCalculator;                           // 0x0480 (size: 0x8)
    class UMaterial* savedDefaultFontMat;                                             // 0x0488 (size: 0x8)
    double LowHealthPercent;                                                          // 0x0490 (size: 0x8)
    bool IsLowHealthNoticeDisplay;                                                    // 0x0498 (size: 0x1)
    double cachedHPPercent;                                                           // 0x04A0 (size: 0x8)
    bool isFriendBg;                                                                  // 0x04A8 (size: 0x1)
    bool CachedBattleMode;                                                            // 0x04A9 (size: 0x1)
    bool CachedIsWork;                                                                // 0x04AA (size: 0x1)
    EPalBaseCampWorkerEventType CachedCampEvent;                                      // 0x04AB (size: 0x1)
