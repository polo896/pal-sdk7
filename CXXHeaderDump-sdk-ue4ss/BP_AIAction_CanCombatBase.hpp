...
class UBP_AIAction_CanCombatBase_C : public UPalAIActionBase
{
    ...
    class UPalDamageReactionComponent* DamageReaction;                                // 0x0140 (size: 0x8)
    EPalAIResponseType CurrentBehavior;                                               // 0x0148 (size: 0x1)
    bool NextCombatModeChange;                                                        // 0x0149 (size: 0x1)
    TSubclassOf<class UPalAIActionBase> TempEncountClass;                             // 0x0150 (size: 0x8)
    class UPalAISensorComponent* TSCache_AISensorComponent;                           // 0x0158 (size: 0x8)
    bool KeepDamageReaction;                                                          // 0x0160 (size: 0x1)
    TSubclassOf<class UPalAIActionBase> PalEncountClass;                              // 0x0168 (size: 0x8)
    TSubclassOf<class UPalAIActionBase> NPCEncountClass;                              // 0x0170 (size: 0x8)
