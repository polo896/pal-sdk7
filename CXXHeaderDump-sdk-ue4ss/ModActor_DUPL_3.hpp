...
class AModActor_C : public AActor
{
    ...
    TMap<AActor*, UPaperSpriteComponent*> ActorMap;                                   // 0x02A0 (size: 0x50)
    ...
    TMap<FName, FString> AssetLoading;                                                // 0x0368 (size: 0x50)
    ...
    TMap<AActor*, UPaperSpriteComponent*> OtomoActorMap;                              // 0x0470 (size: 0x50)
    TMap<AActor*, UPaperSpriteComponent*> PlayerActorMap;                             // 0x04C0 (size: 0x50)
    TMap<AActor*, UPaperSpriteComponent*> NPCActorMap;                                // 0x0510 (size: 0x50)
