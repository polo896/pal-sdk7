...
class UABP_KingBahamut_Implementation_C : public UPalAnimInstance
{
    ...
    double __CustomProperty_PositionAlpha_leg_03_r_Goal_8ADBCE284C81CE657AAD309997AAD225; // 0x1800 (size: 0x8)
    double __CustomProperty_PositionAlpha_leg_03_l_Goal_8ADBCE284C81CE657AAD309997AAD225; // 0x1808 (size: 0x8)
    double __CustomProperty_PositionAlpha_hand_r_Goal_8ADBCE284C81CE657AAD309997AAD225; // 0x1810 (size: 0x8)
    double __CustomProperty_PositionAlpha_hand_l_Goal_8ADBCE284C81CE657AAD309997AAD225; // 0x1818 (size: 0x8)
