...
class UWBP_CharaCre_PlayerNameEdit_C : public UPalUserWidgetOverlayUI
{
    ...
    class UImage* Image_57;                                                           // 0x0488 (size: 0x8)
    class UPalEditableTextBox* PalEditableTextBox_83;                                 // 0x0490 (size: 0x8)
    ...
    FDataTableRowHandle NoPlayerNameMsgID;                                            // 0x04B8 (size: 0x10)
    FDataTableRowHandle NoPalNameMsgID;                                               // 0x04C8 (size: 0x10)
    int32 MaxNameLength;                                                              // 0x04D8 (size: 0x4)
    FPalDataTableRowName_UIInputAction ShortcutConfirmInputAction;                    // 0x04DC (size: 0x8)
    FPalUIActionBindData ShortcutConfirmInputActionHandle;                            // 0x04E4 (size: 0x4)
    bool ForPlayer;                                                                   // 0x04E8 (size: 0x1)
    FDataTableRowHandle TitleMsgID_Player;                                            // 0x04F0 (size: 0x10)
    FDataTableRowHandle TitleMsgID_Pal;                                               // 0x0500 (size: 0x10)
