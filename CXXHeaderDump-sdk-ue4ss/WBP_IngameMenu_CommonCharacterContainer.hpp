...
class UWBP_IngameMenu_CommonCharacterContainer_C : public UPalUserWidgetOverlayUI
{
    ...
    class UBP_PalTextBlock_C* MapObjectTitle;                                         // 0x0488 (size: 0x8)
    class UWBP_BoxPalList_Party_C* WBP_BoxPalList_Party;                              // 0x0490 (size: 0x8)
    class UWBP_PalCharacterScrollList_C* WBP_DisplayCharacterScrollList;              // 0x0498 (size: 0x8)
    ...
    class UPalMapObjectConcreteModelBase* Model;                                      // 0x04B0 (size: 0x8)
    TArray<class UWBP_PalCommonCharacterSlotButton_C*> PartyPalSlots;                 // 0x04B8 (size: 0x10)
    FPalUIActionBindData SendSlotInputHandle;                                         // 0x04C8 (size: 0x4)
    FPalUIActionBindData ViewDetailInputHandle;                                       // 0x04CC (size: 0x4)
    FPalDataTableRowName_UIInputAction SendSlotInput;                                 // 0x04D0 (size: 0x8)
    FPalDataTableRowName_UIInputAction ViewDetailInput;                               // 0x04D8 (size: 0x8)
    class UPalIndividualCharacterSlot* CachedLastHoveredSlot;                         // 0x04E0 (size: 0x8)
    TEnumAsByte<EPalBoxHoveredSlotType::Type> hoverdSlotType;                         // 0x04E8 (size: 0x1)
    FPalUIActionBindData FavoriteInputHandle;                                         // 0x04EC (size: 0x4)
    FPalDataTableRowName_UIInputAction FavoriteShortcutInput;                         // 0x04F0 (size: 0x8)
