#ifndef UE4SS_SDK_SK_GrassRabbitMan_AnimBlueprint_UZM_HPP
#define UE4SS_SDK_SK_GrassRabbitMan_AnimBlueprint_UZM_HPP
...
class USK_GrassRabbitMan_AnimBlueprint_UZM_C : public UAnimInstance
{
    ...
    FAnimNode_SpringBone AnimGraphNode_SpringBone;                                    // 0x0490 (size: 0x158)

    void AnimGraph(FPoseLink InPose, FPoseLink& AnimGraph);
    void ExecuteUbergraph_SK_GrassRabbitMan_AnimBlueprint_UZM(int32 EntryPoint);
}; // Size: 0x5E8
