...
class UWBP_CaptureReticle_C : public UPalUserWidget
{
    ...
    TSoftObjectPtr<class APalMonsterCharacter> NowTargetMonster;                      // 0x0490 (size: 0x30)
    class UPalLoadoutSelectorComponent* LoadoutSelector;                              // 0x04C0 (size: 0x8)
    bool isCaptureItemEquiped;                                                        // 0x04C8 (size: 0x1)
    TSoftObjectPtr<class APalWeaponBase> lastEquipedWeapon;                           // 0x04D0 (size: 0x30)
    TMap<TSoftObjectPtr<class ABP_PalCaptureBodyBase_C>, UWBP_PalGetReticle_C*> secondStepWidgetMap; // 0x0500 (size: 0x50)
    ...
    TMap<TSoftObjectPtr<class APalCharacter>, UWBP_CaptureFailedPercent_C*> FailedCaptureRateWidgetMap; // 0x0560 (size: 0x50)
