...
class ABP_WantedPolice_NPCSpawner_C : public ABP_MonoNPCSpawner_C
{
    ...
    TArray<UPalIndividualCharacterHandle*> OwnedHandles;                              // 0x0650 (size: 0x10)
    bool bDeferredMode;                                                               // 0x0660 (size: 0x1)
    int32 DeferredSpawnCount;                                                         // 0x0664 (size: 0x4)
    TArray<UPalIndividualCharacterHandle*> NotAdjustToFloorHandles;                   // 0x0668 (size: 0x10)
    ...
    void DespawnPolices(TArray<UPalIndividualCharacterHandle*>& DespawnHandles);
