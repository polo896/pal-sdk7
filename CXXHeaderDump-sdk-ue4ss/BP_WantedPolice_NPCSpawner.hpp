...
class ABP_WantedPolice_NPCSpawner_C : public ABP_MonoNPCSpawner_C
{
    ...
    FName CharacterID;                                                                // 0x0620 (size: 0x8)
    int32 PoliceLevel;                                                                // 0x0628 (size: 0x4)
    double PoliceHate;                                                                // 0x0630 (size: 0x8)
    class UPalIndividualCharacterHandle* DespawnHandle;                               // 0x0638 (size: 0x8)
    class UBP_WorldSecurityPoliceSpawner_C* PoliceSpawnerModel;                       // 0x0640 (size: 0x8)
    TArray<FVector> SpawnLocations;                                                   // 0x0648 (size: 0x10)
    int32 SpawnIndex;                                                                 // 0x0658 (size: 0x4)
    TArray<class UPalIndividualCharacterHandle*> OwnedHandles;                        // 0x0660 (size: 0x10)
    bool bDeferredMode;                                                               // 0x0670 (size: 0x1)
    int32 DeferredSpawnCount;                                                         // 0x0674 (size: 0x4)
    TArray<class UPalIndividualCharacterHandle*> NotAdjustToFloorHandles;             // 0x0678 (size: 0x10)
