...
class UWBP_Guild_MemberList_C : public UUserWidget
{
    ...
    class UImage* CursorArrow;                                                        // 0x0288 (size: 0x8)
    class UBP_PalTextBlock_C* Text_LoginState;                                        // 0x0290 (size: 0x8)
    class UBP_PalTextBlock_C* Text_PlayerName;                                        // 0x0298 (size: 0x8)
    class UBP_PalTextBlock_C* Text_Role;                                              // 0x02A0 (size: 0x8)
    ...
    FPalUIGuildMemberDisplayInfo MyDisplayInfo;                                       // 0x02E0 (size: 0x30)
