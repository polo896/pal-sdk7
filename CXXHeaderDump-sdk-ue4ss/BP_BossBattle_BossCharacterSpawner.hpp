...
class ABP_BossBattle_BossCharacterSpawner_C : public AActor
{
    ...
    void Request Other Spawn(FName CharacterID, int32 Level, TSubclassOf<class APalAIController> AIController, bool IsOutAreaSpawn, bool IsOverrideRotation, FRotator Rotation);
    void SetBossLocationToStartPoint();
    void IsSkipCutscene(bool& Skip);
    void SpawnBossDelegate(FPalInstanceID ID);
    void RequestDespawn();
    void RequestBossSpawn(FName CharacterID, int32 Level, TSubclassOf<class AAIController> AIController);
