...
class UWBP_Paldex_tabset_C : public UWBP_PanelWidgetChildrenSelectorBase_C
{
    ...
    FWBP_Paldex_tabset_COnSelectedModelTab OnSelectedModelTab;                        // 0x04D8 (size: 0x10)
    void OnSelectedModelTab();
    FWBP_Paldex_tabset_COnSelectedDistributionTab OnSelectedDistributionTab;          // 0x04E8 (size: 0x10)
