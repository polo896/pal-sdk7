...
struct FRecastNavMeshGenerationProperties
{
    ...
    int32 MaxVerticalMergeError;                                                      // 0x0028 (size: 0x4)
    float MaxSimplificationError;                                                     // 0x002C (size: 0x4)
    float SimplificationElevationRatio;                                               // 0x0030 (size: 0x4)
    int32 TileNumberHardLimit;                                                        // 0x0034 (size: 0x4)
    TEnumAsByte<ERecastPartitioning::Type> RegionPartitioning;                        // 0x0038 (size: 0x1)
    TEnumAsByte<ERecastPartitioning::Type> LayerPartitioning;                         // 0x0039 (size: 0x1)
    int32 RegionChunkSplits;                                                          // 0x003C (size: 0x4)
    int32 LayerChunkSplits;                                                           // 0x0040 (size: 0x4)
    uint8 bSortNavigationAreasByCost;                                                 // 0x0044 (size: 0x1)
    uint8 bPerformVoxelFiltering;                                                     // 0x0044 (size: 0x1)
    uint8 bMarkLowHeightAreas;                                                        // 0x0044 (size: 0x1)
    uint8 bUseExtraTopCellWhenMarkingAreas;                                           // 0x0044 (size: 0x1)
    uint8 bFilterLowSpanSequences;                                                    // 0x0044 (size: 0x1)
    uint8 bFilterLowSpanFromTileCache;                                                // 0x0044 (size: 0x1)
    uint8 bFixedTilePoolSize;                                                         // 0x0044 (size: 0x1)
    uint8 bIsWorldPartitioned;                                                        // 0x0044 (size: 0x1)
...
class ARecastNavMesh : public ANavigationData
{
    ...
    int32 MaxVerticalMergeError;                                                      // 0x0500 (size: 0x4)
    float MaxSimplificationError;                                                     // 0x0504 (size: 0x4)
    float SimplificationElevationRatio;                                               // 0x0508 (size: 0x4)
    int32 MaxSimultaneousTileGenerationJobsCount;                                     // 0x050C (size: 0x4)
    int32 TileNumberHardLimit;                                                        // 0x0510 (size: 0x4)
    int32 PolyRefTileBits;                                                            // 0x0514 (size: 0x4)
    int32 PolyRefNavPolyBits;                                                         // 0x0518 (size: 0x4)
    int32 PolyRefSaltBits;                                                            // 0x051C (size: 0x4)
    FVector NavMeshOriginOffset;                                                      // 0x0520 (size: 0x18)
    float DefaultDrawDistance;                                                        // 0x0538 (size: 0x4)
    float DefaultMaxSearchNodes;                                                      // 0x053C (size: 0x4)
    float DefaultMaxHierarchicalSearchNodes;                                          // 0x0540 (size: 0x4)
    TEnumAsByte<ERecastPartitioning::Type> RegionPartitioning;                        // 0x0544 (size: 0x1)
    TEnumAsByte<ERecastPartitioning::Type> LayerPartitioning;                         // 0x0545 (size: 0x1)
    int32 RegionChunkSplits;                                                          // 0x0548 (size: 0x4)
    int32 LayerChunkSplits;                                                           // 0x054C (size: 0x4)
    uint8 bSortNavigationAreasByCost;                                                 // 0x0550 (size: 0x1)
    uint8 bIsWorldPartitioned;                                                        // 0x0550 (size: 0x1)
    uint8 bPerformVoxelFiltering;                                                     // 0x0550 (size: 0x1)
    uint8 bMarkLowHeightAreas;                                                        // 0x0550 (size: 0x1)
    uint8 bUseExtraTopCellWhenMarkingAreas;                                           // 0x0550 (size: 0x1)
    uint8 bFilterLowSpanSequences;                                                    // 0x0550 (size: 0x1)
    uint8 bFilterLowSpanFromTileCache;                                                // 0x0550 (size: 0x1)
    uint8 bDoFullyAsyncNavDataGathering;                                              // 0x0550 (size: 0x1)
    uint8 bUseBetterOffsetsFromCorners;                                               // 0x0551 (size: 0x1)
    uint8 bStoreEmptyTileLayers;                                                      // 0x0551 (size: 0x1)
    uint8 bUseVirtualFilters;                                                         // 0x0551 (size: 0x1)
    uint8 bUseVirtualGeometryFilteringAndDirtying;                                    // 0x0551 (size: 0x1)
    uint8 bAllowNavLinkAsPathEnd;                                                     // 0x0551 (size: 0x1)
    int32 TimeSliceFilterLedgeSpansMaxYProcess;                                       // 0x0554 (size: 0x4)
    double TimeSliceLongDurationDebug;                                                // 0x0558 (size: 0x8)
    uint8 bUseVoxelCache;                                                             // 0x0560 (size: 0x1)
    float TileSetUpdateInterval;                                                      // 0x0564 (size: 0x4)
    float HeuristicScale;                                                             // 0x0568 (size: 0x4)
    float VerticalDeviationFromGroundCompensation;                                    // 0x056C (size: 0x4)
