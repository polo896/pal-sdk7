...
class UWBP_GuildSetting_ForDisplay_C : public UPalUIGuildSetting
{
    ...
    class UWBP_Guild_Setting_C* WBP_Guild_Setting;                                    // 0x0488 (size: 0x8)
    FPalDataTableRowName_UIInputAction NextCategoryInputAction;                       // 0x0490 (size: 0x8)
    FPalDataTableRowName_UIInputAction PrevCategoryInputAction;                       // 0x0498 (size: 0x8)
