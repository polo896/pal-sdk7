...
{
    class UWidgetAnimation* FailedOpShake;                                            // 0x0450 (size: 0x8)
    class UWBP_PalCommonCharacterSlot_C* WBP_PalCommonCharacterSlot;                  // 0x0458 (size: 0x8)
    class UWBP_PalInGameMenuItemSlotButton_C* WBP_PalInGameMenuItemSlotButton;        // 0x0460 (size: 0x8)
    class UPalUILiftSlotModel* Model;                                                 // 0x0468 (size: 0x8)
