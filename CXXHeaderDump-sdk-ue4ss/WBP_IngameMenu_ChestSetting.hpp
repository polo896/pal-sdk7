...
class UWBP_IngameMenu_ChestSetting_C : public UPalUserWidgetOverlayUI
{
    ...
    class UImage* Image_Dark;                                                         // 0x0490 (size: 0x8)
    class UWBP_IngameMenu_ChestSetting_FilterBlock_C* WBP_IngameMenu_ChestSetting_FilterBlock; // 0x0498 (size: 0x8)
    class UWBP_IngameMenu_ChestSetting_SecurityBlock_C* WBP_IngameMenu_ChestSetting_SecurityBlock; // 0x04A0 (size: 0x8)
    class UWBP_Menu_btn_C* WBP_Menu_btn;                                              // 0x04A8 (size: 0x8)
    class UWBP_PalCommonWindow_C* WBP_PalCommonWindow;                                // 0x04B0 (size: 0x8)
    class UWBP_Paldex_tab_C* WBP_Paldex_tab_Filter;                                   // 0x04B8 (size: 0x8)
    class UWBP_Paldex_tab_C* WBP_Paldex_tab_Security;                                 // 0x04C0 (size: 0x8)
    class UWBP_PalKeyGuideIcon_C* WBP_PalKeyGuideIcon_Next;                           // 0x04C8 (size: 0x8)
    class UWBP_PalKeyGuideIcon_C* WBP_PalKeyGuideIcon_Prev;                           // 0x04D0 (size: 0x8)
    class UWidgetSwitcher* WidgetSwitcher;                                            // 0x04D8 (size: 0x8)
    FWBP_IngameMenu_ChestSetting_COnClickedCloseButton OnClickedCloseButton;          // 0x04E0 (size: 0x10)
    void OnClickedCloseButton();
    FWBP_IngameMenu_ChestSetting_COnClickedAllCheckButton OnClickedAllCheckButton;    // 0x04F0 (size: 0x10)
    void OnClickedAllCheckButton();
    FWBP_IngameMenu_ChestSetting_COnClickedAllUncheckButton OnClickedAllUncheckButton; // 0x0500 (size: 0x10)
    void OnClickedAllUncheckButton();
    FWBP_IngameMenu_ChestSetting_COnClickedApplyButton OnClickedApplyButton;          // 0x0510 (size: 0x10)
    void OnClickedApplyButton();
    class UPalUIItemChestFilterModel* PreferenceModel;                                // 0x0520 (size: 0x8)
    bool NowFilter;                                                                   // 0x0528 (size: 0x1)
    bool Can Edit Security;                                                           // 0x0529 (size: 0x1)
