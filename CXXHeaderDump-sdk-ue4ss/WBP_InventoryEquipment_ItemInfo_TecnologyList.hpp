...
class UWBP_InventoryEquipment_ItemInfo_TecnologyList_C : public UUserWidget
{
    ...
    class UBP_PalTextBlock_C* BP_PalTextBlock_sp;                                     // 0x0290 (size: 0x8)
    class UImage* Icon;                                                               // 0x0298 (size: 0x8)
    class UBP_PalTextBlock_C* Text_Num;                                               // 0x02A0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_One;                                               // 0x02A8 (size: 0x8)
