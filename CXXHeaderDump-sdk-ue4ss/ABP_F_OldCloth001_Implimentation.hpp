...
class UABP_F_OldCloth001_Implimentation_C : public UAnimInstance
{
    ...
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics_1;                            // 0x0BB0 (size: 0x840)
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics;                              // 0x13F0 (size: 0x840)
    FAnimNode_Root AnimGraphNode_Root_1;                                              // 0x1C30 (size: 0x20)
    FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;       // 0x1C50 (size: 0x20)
    FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;       // 0x1C70 (size: 0x20)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose;                          // 0x1C90 (size: 0xC8)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x1D58 (size: 0x20)
