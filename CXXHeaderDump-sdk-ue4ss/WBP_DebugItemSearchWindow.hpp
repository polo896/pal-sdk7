...
class UWBP_DebugItemSearchWindow_C : public UPalUserWidgetOverlayUI
{
    ...
    class UImage* Image_27;                                                           // 0x0490 (size: 0x8)
    class UImage* Image_56;                                                           // 0x0498 (size: 0x8)
    class UPalCheckBox* PalCheckBox_119;                                              // 0x04A0 (size: 0x8)
    class USpinBox* SpinBox_37;                                                       // 0x04A8 (size: 0x8)
    class UWBP_IngameMenu_ItemSearchList_C* WBP_IngameMenu_ItemSearchList;            // 0x04B0 (size: 0x8)
    class UWBP_Menu_btn_C* WBP_Menu_btn;                                              // 0x04B8 (size: 0x8)
    TArray<FPalItemAndNum> LegalItemInfos;                                            // 0x04C0 (size: 0x10)
    TArray<FName> LegalItemIds;                                                       // 0x04D0 (size: 0x10)
    FPalDataTableRowName_UIInputAction EscAction;                                     // 0x04E0 (size: 0x8)
