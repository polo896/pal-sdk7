#ifndef UE4SS_SDK_WBP_CommonButton_Activation_HPP
#define UE4SS_SDK_WBP_CommonButton_Activation_HPP

class UWBP_CommonButton_Activation_C : public UUserWidget
{
    ...
    FWBP_CommonButton_Activation_COnClicked OnClicked;                                // 0x02B8 (size: 0x10)
    void OnClicked();
    bool Is First Focus Target;                                                       // 0x02C8 (size: 0x1)
    FWBP_CommonButton_Activation_COnHovered OnHovered;                                // 0x02D0 (size: 0x10)
    void OnHovered();
    FWBP_CommonButton_Activation_COnUnhovered OnUnhovered;                            // 0x02E0 (size: 0x10)
    void OnUnhovered();
