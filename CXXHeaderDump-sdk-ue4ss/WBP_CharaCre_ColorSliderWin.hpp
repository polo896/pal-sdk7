...
class UWBP_CharaCre_ColorSliderWin_C : public UPalUserWidgetOverlayUI
{
    ...
    class UCanvasPanel* CanvasPanel_1;                                                // 0x0480 (size: 0x8)
    class UImage* Image_38;                                                           // 0x0488 (size: 0x8)
    class UWBP_CharaCre_ColorSelect_WithPreset_C* WBP_CharaCre_ColorSelect_WithPreset; // 0x0490 (size: 0x8)
    class UWBP_Menu_btn_C* WBP_Menu_btn;                                              // 0x0498 (size: 0x8)
    class UBP_CharaCre_ColorSelectWindowDispatchParameter_C* MyParameter;             // 0x04A0 (size: 0x8)
