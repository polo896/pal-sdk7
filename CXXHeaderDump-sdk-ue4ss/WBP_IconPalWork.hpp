...
class UWBP_IconPalWork_C : public UUserWidget
{
    ...
    TMap<EPalWorkSuitability, UTexture2D*> IconMap;                                   // 0x0280 (size: 0x50)
    TMap<EPalMapObjectMaterialSubType, TSoftObjectPtr<class UTexture2D>> IconMap_MaterialSubType; // 0x02D0 (size: 0x50)
