...
class UWBP_IngameMenu_WorkSpace_NumArrow_C : public UPalUserWidget
{
    ...
    class UImage* DoubleArrowHover;                                                   // 0x0468 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton;                          // 0x0470 (size: 0x8)
    class UWidgetSwitcher* WidgetSwitcher;                                            // 0x0478 (size: 0x8)
    FWBP_IngameMenu_WorkSpace_NumArrow_COnClicked OnClicked;                          // 0x0480 (size: 0x10)
    void OnClicked(int32 Progress);
    FName InputActionName;                                                            // 0x0490 (size: 0x8)
    bool DoubleArrow;                                                                 // 0x0498 (size: 0x1)
    int32 ProgressValue;                                                              // 0x049C (size: 0x4)
    FTimerHandle PressedTimer;                                                        // 0x04A0 (size: 0x8)
    double ProgressMultiplier;                                                        // 0x04A8 (size: 0x8)
    int32 HoldCount;                                                                  // 0x04B0 (size: 0x4)
