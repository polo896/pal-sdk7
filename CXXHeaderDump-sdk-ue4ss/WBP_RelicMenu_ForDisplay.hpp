...
class UWBP_RelicMenu_ForDisplay_C : public UPalUIRelicMenu
{
    ...
    class UWBP_Buildup_Player_1_C* WBP_Buildup_Player_1;                              // 0x0488 (size: 0x8)
    class UPalCharacterStatusOperation* StatusOperation;                              // 0x0490 (size: 0x8)
    bool bRequesting;                                                                 // 0x0498 (size: 0x1)
    bool bReplicated_Relic;                                                           // 0x0499 (size: 0x1)
    bool bReplicated_Status;                                                          // 0x049A (size: 0x1)
    bool bLastOperationSuccessed;                                                     // 0x049B (size: 0x1)
    TArray<EPalRelicType> LastRequestedRelicType;                                     // 0x04A0 (size: 0x10)
    TArray<EPalRelicType> WaitingSynsRelicType;                                       // 0x04B0 (size: 0x10)
    TMap<FName, int32> PreRankupStatusMap;                                            // 0x04C0 (size: 0x50)
