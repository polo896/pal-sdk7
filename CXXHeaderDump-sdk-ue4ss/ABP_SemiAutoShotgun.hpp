#ifndef UE4SS_SDK_ABP_SemiAutoShotgun_HPP
#define UE4SS_SDK_ABP_SemiAutoShotgun_HPP
...
class UABP_SemiAutoShotgun_C : public UAnimInstance
{
    ...
    FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;       // 0x0498 (size: 0x20)
    FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;       // 0x04B8 (size: 0x20)
    FAnimNode_RigidBody AnimGraphNode_RigidBody;                                      // 0x04E0 (size: 0x9A0)
