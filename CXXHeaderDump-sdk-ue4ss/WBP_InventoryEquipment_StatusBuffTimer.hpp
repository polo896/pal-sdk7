...
class UWBP_InventoryEquipment_StatusBuffTimer_C : public UUserWidget
{
    ...
    TMap<EPalFoodStatusEffectType, UTexture*> BuffIcons;                              // 0x02A0 (size: 0x50)
    TMap<EPalFoodStatusEffectType, UTexture*> DebuffIcons;                            // 0x02F0 (size: 0x50)
    ...
    TMap<EPalFoodStatusEffectType, UTexture2D*> BaseIcons;                            // 0x0350 (size: 0x50)
