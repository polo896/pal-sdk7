...
class UWBP_MenuESC_PlayerBlockListPopup_C : public UPalUserWidgetOverlayUI
{
    ...
    class UImage* Image_224;                                                          // 0x0488 (size: 0x8)
    class UImage* Image_225;                                                          // 0x0490 (size: 0x8)
    class UImage* Image_226;                                                          // 0x0498 (size: 0x8)
    class UImage* Image_227;                                                          // 0x04A0 (size: 0x8)
    class UWBP_PalCommonScrollList_C* TRASH_WBP_PalCommonScrollList_Members_0;        // 0x04A8 (size: 0x8)
    class UWBP_Menu_btn_C* WBP_Menu_btn;                                              // 0x04B0 (size: 0x8)
    class UWBP_PalCommonWindow_C* WBP_PalCommonWindow;                                // 0x04B8 (size: 0x8)
    FWBP_MenuESC_PlayerBlockListPopup_COnCloseBlockList OnCloseBlockList;             // 0x04C0 (size: 0x10)
    void OnCloseBlockList();
    class UWBP_MenuESCPlayerBlockListItem_C* WBP_MenuESCPlayerBlockItem;              // 0x04D0 (size: 0x8)
