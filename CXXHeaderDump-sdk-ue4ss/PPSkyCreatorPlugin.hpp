...
class APPSkyCreator : public AActor
{
    ...
    bool bUseVolumetricCloud;                                                         // 0x02B0 (size: 0x1)
    class UVolumetricCloudComponent* VolumetricCloud;                                 // 0x02B8 (size: 0x8)
    class USkyLightComponent* SkyLight;                                               // 0x02C0 (size: 0x8)
    class UDirectionalLightComponent* Sunlight;                                       // 0x02C8 (size: 0x8)
    class UDirectionalLightComponent* MoonLight;                                      // 0x02D0 (size: 0x8)
    class UExponentialHeightFogComponent* ExponentialHeightFog;                       // 0x02D8 (size: 0x8)
    class UPostProcessComponent* PostProcess;                                         // 0x02E0 (size: 0x8)
    class UStaticMeshComponent* StarMap;                                              // 0x02E8 (size: 0x8)
    class UStaticMeshComponent* SunSphere;                                            // 0x02F0 (size: 0x8)
    class UStaticMeshComponent* MoonSphere;                                           // 0x02F8 (size: 0x8)
    class USceneCaptureComponent2D* OcclusionCapture;                                 // 0x0300 (size: 0x8)
    class UNiagaraComponent* WeatherFX;                                               // 0x0308 (size: 0x8)
    class UStaticMeshComponent* SkySphere;                                            // 0x0310 (size: 0x8)
    class UMaterialInterface* SkySphereMaterial;                                      // 0x0318 (size: 0x8)
    class UMaterialInstanceDynamic* SkySphereMID;                                     // 0x0320 (size: 0x8)
    bool bUseEditorTimeOfDay;                                                         // 0x0328 (size: 0x1)
    float EditorTimeOfDay;                                                            // 0x032C (size: 0x4)
    bool bUseEditorWeatherSettings;                                                   // 0x0330 (size: 0x1)
    TEnumAsByte<EPPSkyCreatorEditorWeatherType> EditorWeatherType;                    // 0x0331 (size: 0x1)
    class UPPSkyCreatorWeatherPreset* EditorWeatherPreset;                            // 0x0338 (size: 0x8)
    FPPSkyCreatorWeatherSettings EditorWeatherSettings;                               // 0x0340 (size: 0x458)
    bool bIsUsedWithSequencer;                                                        // 0x0798 (size: 0x1)
    bool bIsEditorTickEnabled;                                                        // 0x0799 (size: 0x1)
    float TimeOfDay;                                                                  // 0x079C (size: 0x4)
    FPPSkyCreatorWeatherSettings WeatherSettings;                                     // 0x07A0 (size: 0x458)
    class UMaterialParameterCollection* CommonMPC;                                    // 0x0BF8 (size: 0x8)
    float SkySphereRadius;                                                            // 0x0C00 (size: 0x4)
    bool bShowDebugVariables;                                                         // 0x0C04 (size: 0x1)
    TEnumAsByte<EPPSkyCreatorSunPositionType> SunPositionType;                        // 0x0C05 (size: 0x1)
    FPPCelestialPositionData SunPositionData;                                         // 0x0C08 (size: 0x8)
    TEnumAsByte<EPPSkyCreatorMoonPositionType> MoonPositionType;                      // 0x0C10 (size: 0x1)
    FPPCelestialPositionData MoonPositionData;                                        // 0x0C14 (size: 0x8)
    float SunriseTime;                                                                // 0x0C1C (size: 0x4)
    float SunsetTime;                                                                 // 0x0C20 (size: 0x4)
    float SunDawnOffsetTime;                                                          // 0x0C24 (size: 0x4)
    float SunDuskOffsetTime;                                                          // 0x0C28 (size: 0x4)
    float SunDawnTime;                                                                // 0x0C2C (size: 0x4)
    float SunDuskTime;                                                                // 0x0C30 (size: 0x4)
    float SunElevation;                                                               // 0x0C34 (size: 0x4)
    float SunAzimuth;                                                                 // 0x0C38 (size: 0x4)
    float SunMinAngleAtDawnDusk;                                                      // 0x0C3C (size: 0x4)
    float SunFadeInOutTime;                                                           // 0x0C40 (size: 0x4)
    float MoonriseTime;                                                               // 0x0C44 (size: 0x4)
    float MoonsetTime;                                                                // 0x0C48 (size: 0x4)
    float MoonElevation;                                                              // 0x0C4C (size: 0x4)
    float MoonAzimuth;                                                                // 0x0C50 (size: 0x4)
    float MoonFadeInOutTime;                                                          // 0x0C54 (size: 0x4)
    float Latitude;                                                                   // 0x0C58 (size: 0x4)
    float Longitude;                                                                  // 0x0C5C (size: 0x4)
    float TimeZone;                                                                   // 0x0C60 (size: 0x4)
    bool bDaylightSavingTime;                                                         // 0x0C64 (size: 0x1)
    int32 Year;                                                                       // 0x0C68 (size: 0x4)
    int32 Month;                                                                      // 0x0C6C (size: 0x4)
    int32 Day;                                                                        // 0x0C70 (size: 0x4)
    FDateTime Date;                                                                   // 0x0C78 (size: 0x8)
    bool bLightTransition;                                                            // 0x0C80 (size: 0x1)
    float SunSurfaceBrightness;                                                       // 0x0C84 (size: 0x4)
    float MoonSurfaceBrightness;                                                      // 0x0C88 (size: 0x4)
    float SunCurrentElevation;                                                        // 0x0C8C (size: 0x4)
    float TransitionStartSunAngle;                                                    // 0x0C90 (size: 0x4)
    float TransitionMiddleSunAngle;                                                   // 0x0C94 (size: 0x4)
    float TransitionEndSunAngle;                                                      // 0x0C98 (size: 0x4)
    float NightIntensityTransitionStartSunAngle;                                      // 0x0C9C (size: 0x4)
    float NightIntensityTransitionEndSunAngle;                                        // 0x0CA0 (size: 0x4)
    TEnumAsByte<EComponentMobility::Type> SkyAtmosphereMobility;                      // 0x0CA4 (size: 0x1)
    ESkyAtmosphereTransformMode TransformMode;                                        // 0x0CA5 (size: 0x1)
    float PlanetRadius;                                                               // 0x0CA8 (size: 0x4)
    float AtmosphereHeight;                                                           // 0x0CAC (size: 0x4)
    float AerialPespectiveViewDistanceScale;                                          // 0x0CB0 (size: 0x4)
    FVector PlanetTopPosition;                                                        // 0x0CB8 (size: 0x18)
    float TraceSampleCountScale;                                                      // 0x0CD0 (size: 0x4)
    float GodRaysResolution;                                                          // 0x0CD4 (size: 0x4)
    float LayerBottomAltitude;                                                        // 0x0CD8 (size: 0x4)
    float LayerHeight;                                                                // 0x0CDC (size: 0x4)
    float TracingStartMaxDistance;                                                    // 0x0CE0 (size: 0x4)
    float TracingMaxDistance;                                                         // 0x0CE4 (size: 0x4)
    bool bPerSampleAtmosphericLightTransmittance;                                     // 0x0CE8 (size: 0x1)
    class UMaterialParameterCollection* VolumetricCloudsMPC;                          // 0x0CF0 (size: 0x8)
    FVector LayerBottomAltitudePosition;                                              // 0x0CF8 (size: 0x18)
    FVector LayerTopAltitudePosition;                                                 // 0x0D10 (size: 0x18)
    class UMaterialInterface* CurrentVolumetricCloudMaterial;                         // 0x0D28 (size: 0x8)
    class UMaterialInstanceDynamic* VolumetricCloudMID;                               // 0x0D30 (size: 0x8)
    class UMaterialInterface* VolumetricCloudDensitySampleMaterial;                   // 0x0D38 (size: 0x8)
    class UMaterialInstanceDynamic* VolumetricCloudDensitySampleMID;                  // 0x0D40 (size: 0x8)
    class UTextureRenderTarget2D* VolumetricCloudDensitySampleRT;                     // 0x0D48 (size: 0x8)
    bool bCinematicQuality;                                                           // 0x0D50 (size: 0x1)
    TEnumAsByte<EPPVolumetricCloudRenderTargetMode> RenderMode;                       // 0x0D51 (size: 0x1)
    bool bHighQualityAerialPerspective;                                               // 0x0D52 (size: 0x1)
    int32 MultiScatteringApproximationOctaveCount;                                    // 0x0D54 (size: 0x4)
    bool bGroundContribution;                                                         // 0x0D58 (size: 0x1)
    bool bRayMarchVolumeShadow;                                                       // 0x0D59 (size: 0x1)
    float ViewSampleCountScale;                                                       // 0x0D5C (size: 0x4)
    float ReflectionSampleCountScale;                                                 // 0x0D60 (size: 0x4)
    float ShadowViewSampleCountScale;                                                 // 0x0D64 (size: 0x4)
    float ShadowReflectionSampleCountScale;                                           // 0x0D68 (size: 0x4)
    float ShadowTracingDistance;                                                      // 0x0D6C (size: 0x4)
    float CloudMapScale;                                                              // 0x0D70 (size: 0x4)
    FVector2D CloudMapOffset;                                                         // 0x0D78 (size: 0x10)
    float CoverageVariationMapScale;                                                  // 0x0D88 (size: 0x4)
    TEnumAsByte<EPPVolumetricCloudNoiseShapeResolution> NoiseShapeResolution;         // 0x0D8C (size: 0x1)
    TEnumAsByte<EPPVolumetricCloudNoiseDetailResolution> NoiseDetailResolution;       // 0x0D8D (size: 0x1)
    float NoiseShapeScale;                                                            // 0x0D90 (size: 0x4)
    float NoiseDetailScale;                                                           // 0x0D94 (size: 0x4)
    float TurbulenceScale;                                                            // 0x0D98 (size: 0x4)
    float BackgroundCloudsContrast;                                                   // 0x0D9C (size: 0x4)
    float BackgroundCloudsReflectionScale;                                            // 0x0DA0 (size: 0x4)
    TEnumAsByte<EComponentMobility::Type> SkyLightMobility;                           // 0x0DA4 (size: 0x1)
    bool bRealTimeCapture;                                                            // 0x0DA5 (size: 0x1)
    bool bSkyLightCaptureTimeSlice;                                                   // 0x0DA6 (size: 0x1)
    bool bLowerHemisphereIsSolidColor;                                                // 0x0DA7 (size: 0x1)
    bool bCloudAmbientOcclusion;                                                      // 0x0DA8 (size: 0x1)
    float CloudAmbientOcclusionExtent;                                                // 0x0DAC (size: 0x4)
    float CloudAmbientOcclusionMapResolutionScale;                                    // 0x0DB0 (size: 0x4)
    float CloudAmbientOcclusionApertureScale;                                         // 0x0DB4 (size: 0x4)
    TEnumAsByte<EComponentMobility::Type> SunLightMobility;                           // 0x0DB8 (size: 0x1)
    bool bControlSunDirection;                                                        // 0x0DB9 (size: 0x1)
    bool bSunConstantIntensity;                                                       // 0x0DBA (size: 0x1)
    float SunIntensity;                                                               // 0x0DBC (size: 0x4)
    float SunCurrentIntensity;                                                        // 0x0DC0 (size: 0x4)
    bool bSunUseTemperature;                                                          // 0x0DC4 (size: 0x1)
    float SunDiskSize;                                                                // 0x0DC8 (size: 0x4)
    bool bSunConstantAtmosphereDiskColorScale;                                        // 0x0DCC (size: 0x1)
    FLinearColor SunAtmosphereDiskColorScale;                                         // 0x0DD0 (size: 0x10)
    bool bSunPerPixelAtmosphereTransmittance;                                         // 0x0DE0 (size: 0x1)
    float SunCloudShadowExtent;                                                       // 0x0DE4 (size: 0x4)
    float SunCloudShadowMapResolutionScale;                                           // 0x0DE8 (size: 0x4)
    float SunCloudShadowRaySampleCountScale;                                          // 0x0DEC (size: 0x4)
    TEnumAsByte<EComponentMobility::Type> MoonLightMobility;                          // 0x0DF0 (size: 0x1)
    bool bControlMoonDirection;                                                       // 0x0DF1 (size: 0x1)
    bool bMoonConstantIntensity;                                                      // 0x0DF2 (size: 0x1)
    float MoonIntensity;                                                              // 0x0DF4 (size: 0x4)
    float MoonCurrentIntensity;                                                       // 0x0DF8 (size: 0x4)
    bool bMoonUseTemperature;                                                         // 0x0DFC (size: 0x1)
    float MoonDiskSize;                                                               // 0x0E00 (size: 0x4)
    float MoonRotation;                                                               // 0x0E04 (size: 0x4)
    float MoonPhase;                                                                  // 0x0E08 (size: 0x4)
    bool bMoonPhaseLightIntensityScale;                                               // 0x0E0C (size: 0x1)
    float MoonPhaseLightIntensityMinScale;                                            // 0x0E10 (size: 0x4)
    float MoonPhaseLightIntensityMaxScale;                                            // 0x0E14 (size: 0x4)
    bool bMoonConstantAtmosphereDiskColorScale;                                       // 0x0E18 (size: 0x1)
    FLinearColor MoonAtmosphereDiskColorScale;                                        // 0x0E1C (size: 0x10)
    bool bMoonPerPixelAtmosphereTransmittance;                                        // 0x0E2C (size: 0x1)
    float MoonCloudShadowExtent;                                                      // 0x0E30 (size: 0x4)
    float MoonCloudShadowMapResolutionScale;                                          // 0x0E34 (size: 0x4)
    float MoonCloudShadowRaySampleCountScale;                                         // 0x0E38 (size: 0x4)
    TEnumAsByte<EComponentMobility::Type> ExponentialHeightFogMobility;               // 0x0E3C (size: 0x1)
    bool bEnableExponentialHeightFog;                                                 // 0x0E3D (size: 0x1)
    bool bVolumetricFog;                                                              // 0x0E3E (size: 0x1)
    float FogHeightOffset;                                                            // 0x0E40 (size: 0x4)
    float SecondFogHeightOffset;                                                      // 0x0E44 (size: 0x4)
    class UTexture2D* StarMapTexture;                                                 // 0x0E48 (size: 0x8)
    TEnumAsByte<EPPSkyCreatorStarMapRotationType> StarMapRotationType;                // 0x0E50 (size: 0x1)
    FVector StarMapAdditionalRotation;                                                // 0x0E58 (size: 0x18)
    bool bEnableOcclusionCapture;                                                     // 0x0E70 (size: 0x1)
    class UTextureRenderTarget2D* OcclusionRenderTarget;                              // 0x0E78 (size: 0x8)
    float OcclusionCaptureWidth;                                                      // 0x0E80 (size: 0x4)
    float OcclusionCaptureHeight;                                                     // 0x0E84 (size: 0x4)
    bool bOcclusionCaptureRealtimeUpdate;                                             // 0x0E88 (size: 0x1)
    float OcclusionCaptureStepDistance;                                               // 0x0E8C (size: 0x4)
    float OcclusionCaptureStepSize;                                                   // 0x0E90 (size: 0x4)
    float OcclusionBias;                                                              // 0x0E94 (size: 0x4)
    int32 OcclusionBlurSamples;                                                       // 0x0E98 (size: 0x4)
    float OcclusionBlurDistance;                                                      // 0x0E9C (size: 0x4)
    float OcclusionMaskFadeHardness;                                                  // 0x0EA0 (size: 0x4)
    FVector CameraLocation;                                                           // 0x0EA8 (size: 0x18)
    FVector CameraLocationSnapped;                                                    // 0x0EC0 (size: 0x18)
    FVector OcclusionCurrentLocation;                                                 // 0x0ED8 (size: 0x18)
    float WeatherFXCutoffWorldHeight;                                                 // 0x0EF0 (size: 0x4)
    float WeatherFXCutoffSoftness;                                                    // 0x0EF4 (size: 0x4)
    float PrecipitationSpawnRadius;                                                   // 0x0EF8 (size: 0x4)
    bool bEnableGPUPrecipitation;                                                     // 0x0EFC (size: 0x1)
    float PrecipitationSpawnRadiusGPU;                                                // 0x0F00 (size: 0x4)
    float PrecipitationMaxViewDistance;                                               // 0x0F04 (size: 0x4)
    float PrecipitationVerticalCheckDistance;                                         // 0x0F08 (size: 0x4)
    TEnumAsByte<ECollisionChannel> PrecipitationCollisionChannel;                     // 0x0F0C (size: 0x1)
    float PrecipitationDepthFadeDistance;                                             // 0x0F10 (size: 0x4)
    float PrecipitationCameraFadeDistance;                                            // 0x0F14 (size: 0x4)
    float PrecipitationCameraFadeOffset;                                              // 0x0F18 (size: 0x4)
    float RainSpawnRateMaxCPU;                                                        // 0x0F1C (size: 0x4)
    float RainSpawnRateMaxGPU;                                                        // 0x0F20 (size: 0x4)
    float RainDistanceScaleFactor;                                                    // 0x0F24 (size: 0x4)
    float RainCameraMotionAlignmentScale;                                             // 0x0F28 (size: 0x4)
    float RainVelocityElongationScale;                                                // 0x0F2C (size: 0x4)
    float RainMaskHardness;                                                           // 0x0F30 (size: 0x4)
    float RainSplashSpawnRateMax;                                                     // 0x0F34 (size: 0x4)
    float RainSplashSpawnRateMaxGPU;                                                  // 0x0F38 (size: 0x4)
    float SnowSpawnRateMaxCPU;                                                        // 0x0F3C (size: 0x4)
    float SnowSpawnRateMaxGPU;                                                        // 0x0F40 (size: 0x4)
    float SnowDistanceScaleFactor;                                                    // 0x0F44 (size: 0x4)
    float SnowCameraMotionAlignmentScale;                                             // 0x0F48 (size: 0x4)
    float SnowVelocityElongationScale;                                                // 0x0F4C (size: 0x4)
    float SnowMaskHardness;                                                           // 0x0F50 (size: 0x4)
    class UTextureRenderTarget2D* LightningsParametersRT;                             // 0x0F58 (size: 0x8)
    TArray<FPPSkyCreatorLightningParameters> LightningParameters;                     // 0x0F60 (size: 0x10)
    float CurrentLightningInterval;                                                   // 0x0F78 (size: 0x4)
    FVector LastLightningPosition;                                                    // 0x0F80 (size: 0x18)
    TArray<FVector> LightningAvailablePositions;                                      // 0x0F98 (size: 0x10)
    int32 LightningCurrentIndex;                                                      // 0x0FA8 (size: 0x4)
    bool bSampleCloudDensity;                                                         // 0x0FAC (size: 0x1)
    int32 LightningMaxSamples;                                                        // 0x0FB0 (size: 0x4)
    float LightningSpawnInnerRadius;                                                  // 0x0FB4 (size: 0x4)
    float LightningSpawnOuterRadius;                                                  // 0x0FB8 (size: 0x4)
    float LightningRandomDegreeInConeMax;                                             // 0x0FBC (size: 0x4)
    float LightningBoltEmissiveScale;                                                 // 0x0FC0 (size: 0x4)
    float LightningFlashFadeUpdateRate;                                               // 0x0FD0 (size: 0x4)
    float LightningFlashFadeDelta;                                                    // 0x0FD4 (size: 0x4)
    float LightningFlashEmissiveScale;                                                // 0x0FD8 (size: 0x4)
    float LightningFlashEmissiveReflectionScale;                                      // 0x0FDC (size: 0x4)
    float LightningFlashRadiusScale;                                                  // 0x0FE0 (size: 0x4)
    float LightningFlashFadeSpeed;                                                    // 0x0FE4 (size: 0x4)
    float RainbowDistance;                                                            // 0x0FE8 (size: 0x4)
    float RainbowDepthFadeDistance;                                                   // 0x0FEC (size: 0x4)
    float MaterialFXCutoffWorldHeight;                                                // 0x0FF0 (size: 0x4)
    float MaterialFXCutoffSoftness;                                                   // 0x0FF4 (size: 0x4)
    float WetnessSlopeAngle;                                                          // 0x0FF8 (size: 0x4)
    float WetnessSlopeSmoothness;                                                     // 0x0FFC (size: 0x4)
    float PuddlesMaskScale;                                                           // 0x1000 (size: 0x4)
    float PuddlesRoughness;                                                           // 0x1004 (size: 0x4)
    float PuddlesSlopeAngle;                                                          // 0x1008 (size: 0x4)
    float PuddlesSlopeSmoothness;                                                     // 0x100C (size: 0x4)
    bool bEnableRainRipplesSolver;                                                    // 0x1010 (size: 0x1)
    bool bPauseRainRipplesSolver;                                                     // 0x1011 (size: 0x1)
    float RainRipplesUpdateRate;                                                      // 0x1020 (size: 0x4)
    float RainRipplesScale;                                                           // 0x1024 (size: 0x4)
    float RainRipplesMaxDensity;                                                      // 0x1028 (size: 0x4)
    float WindRipplesScale;                                                           // 0x102C (size: 0x4)
    float RainRipplesSolverDelta;                                                     // 0x1030 (size: 0x4)
    int32 RainRipplesSolverHeightState;                                               // 0x1034 (size: 0x4)
    class UMaterialInterface* RainRipplesPropagation;                                 // 0x1038 (size: 0x8)
    class UMaterialInstanceDynamic* RainRipplesPropagationMID;                        // 0x1040 (size: 0x8)
    class UMaterialInterface* RainRipplesForce;                                       // 0x1048 (size: 0x8)
    class UMaterialInterface* RainRipplesNormal;                                      // 0x1050 (size: 0x8)
    class UMaterialInstanceDynamic* RainRipplesNormalMID;                             // 0x1058 (size: 0x8)
    class UTextureRenderTarget2D* RainRipplesPropagationFrame0;                       // 0x1060 (size: 0x8)
    class UTextureRenderTarget2D* RainRipplesPropagationFrame1;                       // 0x1068 (size: 0x8)
    class UTextureRenderTarget2D* RainRipplesPropagationFrame2;                       // 0x1070 (size: 0x8)
    class UTextureRenderTarget2D* RainRipplesNormalRT;                                // 0x1078 (size: 0x8)
    float SnowMaskScale;                                                              // 0x1080 (size: 0x4)
    float SnowScale;                                                                  // 0x1084 (size: 0x4)
    float SnowRoughness;                                                              // 0x1088 (size: 0x4)
    float SnowSparklesScale;                                                          // 0x108C (size: 0x4)
    float SnowSparklesRoughness;                                                      // 0x1090 (size: 0x4)
    float SnowSlopeAngle;                                                             // 0x1094 (size: 0x4)
    float SnowSlopeSmoothness;                                                        // 0x1098 (size: 0x4)
    bool bEnableWind;                                                                 // 0x109C (size: 0x1)
    bool bIndependentWindControl;                                                     // 0x109D (size: 0x1)
    FPPSkyCreatorWindSettings EditorIndependentWindSettings;                          // 0x10A0 (size: 0x1C)
    float CloudWindSkewAmount;                                                        // 0x10BC (size: 0x4)
    FVector CloudWindOffset;                                                          // 0x10C0 (size: 0x18)
    FVector CloudWindSkewDirection;                                                   // 0x10D8 (size: 0x18)
    float CloudWindSkewForce;                                                         // 0x10F0 (size: 0x4)
    FVector CloudNoiseShapeWindOffset;                                                // 0x10F8 (size: 0x18)
    FVector CloudNoiseDetailWindOffset;                                               // 0x1110 (size: 0x18)
    bool bUseExposureSettings;                                                        // 0x1128 (size: 0x1)
    bool bExtendDefaultLuminanceRange;                                                // 0x1129 (size: 0x1)
    float PostProcessPriority;                                                        // 0x112C (size: 0x4)
    TEnumAsByte<EAutoExposureMethod> ExposureMethod;                                  // 0x1130 (size: 0x1)
    class UCurveFloat* ExposureBiasCurve;                                             // 0x1138 (size: 0x8)
    class UTexture* ExposureMeterMask;                                                // 0x1140 (size: 0x8)
    float ExposureMinBrightness;                                                      // 0x1148 (size: 0x4)
    float ExposureMaxBrightness;                                                      // 0x114C (size: 0x4)
    float ExposureMinEV100;                                                           // 0x1150 (size: 0x4)
    float ExposureMaxEV100;                                                           // 0x1154 (size: 0x4)
    float ExposureSpeedUp;                                                            // 0x1158 (size: 0x4)
    float ExposureSpeedDown;                                                          // 0x115C (size: 0x4)
    float ExposureLowPercent;                                                         // 0x1160 (size: 0x4)
    float ExposureHighPercent;                                                        // 0x1164 (size: 0x4)
    float ExposureHistogramLogMin;                                                    // 0x1168 (size: 0x4)
    float ExposureHistogramLogMax;                                                    // 0x116C (size: 0x4)
    float ExposureHistogramMinEV100;                                                  // 0x1170 (size: 0x4)
    float ExposureHistogramMaxEV100;                                                  // 0x1174 (size: 0x4)
    FPPSkyCreatorOnLightningStrike OnLightningStrike;                                 // 0x1178 (size: 0x10)
