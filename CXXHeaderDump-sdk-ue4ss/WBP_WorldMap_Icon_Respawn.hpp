...
class UWBP_WorldMap_Icon_Respawn_C : public UWBP_WorldMap_IconBase_NoDesign_C
{
    ...
    class UWidgetAnimation* Anm_Loop;                                                 // 0x0540 (size: 0x8)
    class UImage* Icon;                                                               // 0x0548 (size: 0x8)
    class UImage* Image_Wave;                                                         // 0x0550 (size: 0x8)
    class UWBP_PalCommonButton_C* WBP_PalCommonButton;                                // 0x0558 (size: 0x8)
    FName Respawn Point ID;                                                           // 0x0560 (size: 0x8)
