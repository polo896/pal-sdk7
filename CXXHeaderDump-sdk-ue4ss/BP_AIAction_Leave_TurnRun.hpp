...
class UBP_AIAction_Leave_TurnRun_C : public UPalAIAction_LeaveBase
{
    ...
    FVector MoveTargetPos;                                                            // 0x0158 (size: 0x18)
    bool FailureLineTrace;                                                            // 0x0170 (size: 0x1)
    TArray<FVector> MoveVectorCandidate;                                              // 0x0178 (size: 0x10)
    int32 SelectIndex;                                                                // 0x0188 (size: 0x4)
    double Const_AutoDeleteTime;                                                      // 0x0190 (size: 0x8)
