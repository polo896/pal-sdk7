...
class UWBP_Menu_CharacterHPGauge_C : public UWBP_IndividualParameterBindWidget_C
{
    ...
    class UCanvasPanel* Canvas_HP;                                                    // 0x0660 (size: 0x8)
    class UProgressBar* ProgressBar_HPGauge;                                          // 0x0668 (size: 0x8)
    class UBP_PalTextBlock_C* Text_MaxHP;                                             // 0x0670 (size: 0x8)
    class UBP_PalTextBlock_C* Text_NowHP;                                             // 0x0678 (size: 0x8)
