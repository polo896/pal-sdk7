...
class UABP_Serpent_Implementation_C : public UAnimInstance
{
    ...
    FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;       // 0x0B90 (size: 0x20)
    FAnimNode_LookAt AnimGraphNode_LookAt_3;                                          // 0x0BB0 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt_2;                                          // 0x0E00 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt_1;                                          // 0x1050 (size: 0x250)
    FAnimNode_LookAt AnimGraphNode_LookAt;                                            // 0x12A0 (size: 0x250)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x14F0 (size: 0x20)
    FVector LookAtWorldLocation;                                                      // 0x1510 (size: 0x18)
