...
class UWBP_MainMenu_Pal_00_C : public UWBP_IndividualParameterBindWidget_C
{
    ...
    class UWidgetAnimation* Anm_NoPal;                                                // 0x0660 (size: 0x8)
    class UWidgetAnimation* Anm_Close_Status;                                         // 0x0668 (size: 0x8)
    class UWidgetAnimation* Anm_Open_Status;                                          // 0x0670 (size: 0x8)
    class UWidgetAnimation* Anm_Open_List;                                            // 0x0678 (size: 0x8)
    class UBackgroundBlur* BackgroundBlur_Lock_1;                                     // 0x0680 (size: 0x8)
    class UBP_PalTextBlock_C* BP_PalTextBlock_C_2;                                    // 0x0688 (size: 0x8)
    class UBP_PalTextBlock_C* BP_PalTextBlock_LvText;                                 // 0x0690 (size: 0x8)
    class UBP_PalTextBlock_C* BP_PalTextBlock_NickName;                               // 0x0698 (size: 0x8)
    class UBP_PalTextBlock_C* BP_PalTextBlock_SoulRank;                               // 0x06A0 (size: 0x8)
    class UCanvasPanel* Canvas_Awakening;                                             // 0x06A8 (size: 0x8)
    class UCanvasPanel* Canvas_DropGuide;                                             // 0x06B0 (size: 0x8)
    class UCanvasPanel* Canvas_Locked;                                                // 0x06B8 (size: 0x8)
    class UCanvasPanel* Canvas_PalName;                                               // 0x06C0 (size: 0x8)
    class UCanvasPanel* Canvas_PalStatus;                                             // 0x06C8 (size: 0x8)
    class UCanvasPanel* Canvas_SkillInfo;                                             // 0x06D0 (size: 0x8)
    class UCanvasPanel* Canvas_Unlocked;                                              // 0x06D8 (size: 0x8)
    class UCanvasPanel* CanvasPanel_PartnerSkill;                                     // 0x06E0 (size: 0x8)
    class UCanvasPanel* CanvasPanel_Potencial;                                        // 0x06E8 (size: 0x8)
    class UCanvasPanel* CanvasPanelDebuff;                                            // 0x06F0 (size: 0x8)
    class UCanvasPanel* CanvasPanelLock_1;                                            // 0x06F8 (size: 0x8)
    class UCanvasPanel* CanvasPanelLockText;                                          // 0x0700 (size: 0x8)
    class UCanvasPanel* CanvasPanelLockText_1;                                        // 0x0708 (size: 0x8)
    class UProgressBar* Gauge_Exp;                                                    // 0x0710 (size: 0x8)
    class UProgressBar* Gauge_Friendship;                                             // 0x0718 (size: 0x8)
    class UProgressBar* Gauge_HP;                                                     // 0x0720 (size: 0x8)
    class UProgressBar* Gauge_Hunger;                                                 // 0x0728 (size: 0x8)
    class UImage* Icon_Friendship;                                                    // 0x0730 (size: 0x8)
    class UImage* IconRankArrow_Attack;                                               // 0x0738 (size: 0x8)
    class UImage* IconRankArrow_Defence;                                              // 0x0740 (size: 0x8)
    class UImage* IconRankArrow_Work;                                                 // 0x0748 (size: 0x8)
    class UImage* Image_Icon_GlobalInport;                                            // 0x0750 (size: 0x8)
    class UImage* Image_Icon_Locked;                                                  // 0x0758 (size: 0x8)
    class UImage* Image_Mutant;                                                       // 0x0760 (size: 0x8)
    class UImage* Image_PartnerSkill;                                                 // 0x0768 (size: 0x8)
    class UImage* Image_PartnerSkill_Sq;                                              // 0x0770 (size: 0x8)
    class UImage* Image_PartnerSkillIcon;                                             // 0x0778 (size: 0x8)
    class UImage* Image_PartnerSkillIcon_Sq;                                          // 0x0780 (size: 0x8)
    class UImage* Image_Rare;                                                         // 0x0788 (size: 0x8)
    class UImage* Image_Strong;                                                       // 0x0790 (size: 0x8)
    class UOverlay* Overlay_Circle;                                                   // 0x0798 (size: 0x8)
    class UOverlay* Overlay_Icon_Circle;                                              // 0x07A0 (size: 0x8)
    class UOverlay* Overlay_Icon_sq;                                                  // 0x07A8 (size: 0x8)
    class UOverlay* Overlay_sq;                                                       // 0x07B0 (size: 0x8)
    class UBP_PalRichTextBlock_C* RichText_PartnerSkillDesc;                          // 0x07B8 (size: 0x8)
    class UBP_PalRichTextBlock_C* RichText_PartnerSkillDesc_1;                        // 0x07C0 (size: 0x8)
    class UBP_PalRichTextBlock_C* RichText_PartnerSkillName;                          // 0x07C8 (size: 0x8)
    class UBP_PalTextBlock_C* Text_DefenseValue;                                      // 0x07D0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_FriendshipRank_Num;                                // 0x07D8 (size: 0x8)
    class UBP_PalTextBlock_C* Text_LevelValue;                                        // 0x07E0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_MaxHP;                                             // 0x07E8 (size: 0x8)
    class UBP_PalTextBlock_C* Text_MaxHunger;                                         // 0x07F0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_NextExp;                                           // 0x07F8 (size: 0x8)
    class UBP_PalTextBlock_C* Text_NowHP;                                             // 0x0800 (size: 0x8)
    class UBP_PalTextBlock_C* Text_NowHunger;                                         // 0x0808 (size: 0x8)
    class UBP_PalTextBlock_C* Text_NowSanity;                                         // 0x0810 (size: 0x8)
    class UBP_PalTextBlock_C* Text_PartnerSkillLevel_Value;                           // 0x0818 (size: 0x8)
    class UBP_PalTextBlock_C* Text_PartnerSkillLevel_Value_1;                         // 0x0820 (size: 0x8)
    class UBP_PalTextBlock_C* Text_PartnerSkillLockItem;                              // 0x0828 (size: 0x8)
    class UBP_PalTextBlock_C* Text_PartnerSkillName_1;                                // 0x0830 (size: 0x8)
    class UBP_PalTextBlock_C* Text_PunishedLevel_Af;                                  // 0x0838 (size: 0x8)
    class UBP_PalTextBlock_C* Text_PunishedLevel_Pre;                                 // 0x0840 (size: 0x8)
    class UBP_PalTextBlock_C* Text_RangeAttackValue;                                  // 0x0848 (size: 0x8)
    class UBP_PalTextBlock_C* Text_WorkSpeedValue;                                    // 0x0850 (size: 0x8)
    class UUniformGridPanel* UniformGrid_Suitability;                                 // 0x0858 (size: 0x8)
    class UVerticalBox* VerticalBox_Pal_List;                                         // 0x0860 (size: 0x8)
    class UVerticalBox* VerticalBox_Skill;                                            // 0x0868 (size: 0x8)
    class UWBP_CommonButton_C* WBP_CommonButton_NameEdit;                             // 0x0870 (size: 0x8)
    class UWBP_MainMenu_Pal_FoodAmount_C* WBP_MainMenu_Pal_FoodAmount;                // 0x0878 (size: 0x8)
    class UWBP_MainMenu_Pal_Skill_Active_C* WBP_MainMenu_Pal_Skill_Active;            // 0x0880 (size: 0x8)
    class UWBP_MainMenu_Pal_Skill_Active_C* WBP_MainMenu_Pal_Skill_Active_1;          // 0x0888 (size: 0x8)
    class UWBP_MainMenu_Pal_Skill_Active_C* WBP_MainMenu_Pal_Skill_Active_2;          // 0x0890 (size: 0x8)
    class UWBP_MainMenu_Pal_Skill_Passive_C* WBP_MainMenu_Pal_Skill_Passive;          // 0x0898 (size: 0x8)
    class UWBP_MainMenu_Pal_Skill_Passive_C* WBP_MainMenu_Pal_Skill_Passive_1;        // 0x08A0 (size: 0x8)
    class UWBP_MainMenu_Pal_Skill_Passive_C* WBP_MainMenu_Pal_Skill_Passive_2;        // 0x08A8 (size: 0x8)
    class UWBP_MainMenu_Pal_Skill_Passive_C* WBP_MainMenu_Pal_Skill_Passive_3;        // 0x08B0 (size: 0x8)
    class UWBP_MainMenu_Pal_State_C* WBP_MainMenu_Pal_State;                          // 0x08B8 (size: 0x8)
    class UWBP_MainMenu_Pal_State_C* WBP_MainMenu_Pal_State_0;                        // 0x08C0 (size: 0x8)
    class UWBP_MainMenu_Pal_State_C* WBP_MainMenu_Pal_State_1;                        // 0x08C8 (size: 0x8)
    class UWBP_MainMenu_Pal_State_C* WBP_MainMenu_Pal_State_2;                        // 0x08D0 (size: 0x8)
    class UWBP_MainMenu_Pal_State_C* WBP_MainMenu_Pal_State_3;                        // 0x08D8 (size: 0x8)
    class UWBP_MainMenu_Pal_State_C* WBP_MainMenu_Pal_State_4;                        // 0x08E0 (size: 0x8)
    class UWBP_MainMenu_Pal_StatusElement_C* WBP_MainMenu_Pal_StatusElement_000;      // 0x08E8 (size: 0x8)
    class UWBP_MainMenu_Pal_StatusElement_C* WBP_MainMenu_Pal_StatusElement_001;      // 0x08F0 (size: 0x8)
    class UWBP_MainMenu_PalRarityStar_C* WBP_MainMenu_PalRarityStar;                  // 0x08F8 (size: 0x8)
    class UWBP_MainMenu_PalRarityStar_C* WBP_MainMenu_PalRarityStar_1;                // 0x0900 (size: 0x8)
    class UWBP_MainMenu_PalRarityStar_C* WBP_MainMenu_PalRarityStar_2;                // 0x0908 (size: 0x8)
    class UWBP_MainMenu_PalRarityStar_C* WBP_MainMenu_PalRarityStar_3;                // 0x0910 (size: 0x8)
    class UWBP_MainMenu_PalSkillInfo_C* WBP_MainMenu_PalSkillInfo;                    // 0x0918 (size: 0x8)
    class UWBP_Menu_Pal_Potencial_C* WBP_Menu_Pal_Potencial;                          // 0x0920 (size: 0x8)
    class UWBP_Menu_PalList_C* WBP_Menu_PalList;                                      // 0x0928 (size: 0x8)
    class UWBP_Menu_PalList_C* WBP_Menu_PalList_1;                                    // 0x0930 (size: 0x8)
    class UWBP_Menu_PalList_C* WBP_Menu_PalList_2;                                    // 0x0938 (size: 0x8)
    class UWBP_Menu_PalList_C* WBP_Menu_PalList_3;                                    // 0x0940 (size: 0x8)
    class UWBP_Menu_PalList_C* WBP_Menu_PalList_4;                                    // 0x0948 (size: 0x8)
    class UWBP_Menu_PalList_C* WBP_Menu_PalList_5;                                    // 0x0950 (size: 0x8)
    class UWBP_NoData_C* WBP_NoData;                                                  // 0x0958 (size: 0x8)
    class UWBP_PalCommonButton_C* WBP_PalCommonButton_Friendship;                     // 0x0960 (size: 0x8)
    class UWBP_PalCommonButton_C* WBP_PalCommonButton_HP;                             // 0x0968 (size: 0x8)
    class UWBP_PalCommonButton_C* WBP_PalCommonButton_Hunger;                         // 0x0970 (size: 0x8)
    class UWBP_PalCommonButton_C* WBP_PalCommonButton_SAN;                            // 0x0978 (size: 0x8)
    class UWBP_PalGenderIcon_C* WBP_PalGenderIcon;                                    // 0x0980 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton;                          // 0x0988 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton_Atk;                      // 0x0990 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton_Def;                      // 0x0998 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton_LevelSync;                // 0x09A0 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton_Lock;                     // 0x09A8 (size: 0x8)
    ...
    FDataTableRowHandle HungerParameterDescMsgID;                                     // 0x0A90 (size: 0x10)
    ...
    FDataTableRowHandle AtkTitleMsgID;                                                // 0x0B60 (size: 0x10)
    FDataTableRowHandle AtkDescMsgID;                                                 // 0x0B70 (size: 0x10)
    FPalDataTableRowName_UIInputAction RemoveWazaInputAction;                         // 0x0B80 (size: 0x8)
    FPalUIActionBindData RemoveWazaActionHandle;                                      // 0x0B88 (size: 0x4)
    EPalWazaID CachedSelectedWazaID;                                                  // 0x0B8C (size: 0x2)
    FWBP_MainMenu_Pal_00_COnRequestedRemoveWaza OnRequestedRemoveWaza;                // 0x0B90 (size: 0x10)
    void OnRequestedRemoveWaza(EPalWazaID WazaID, class UPalIndividualCharacterHandle* targetHandle);
    FDataTableRowHandle WorkTitleMsgID;                                               // 0x0BA0 (size: 0x10)
    FDataTableRowHandle WorkDescMsgID;                                                // 0x0BB0 (size: 0x10)
    FDataTableRowHandle LevelSyncMsgID;                                               // 0x0BC0 (size: 0x10)
    FDataTableRowHandle LevelSyncDescMsgID;                                           // 0x0BD0 (size: 0x10)
    bool IsEditingNickName;                                                           // 0x0BE0 (size: 0x1)
    FWBP_MainMenu_Pal_00_COnToggleFavoritePal OnToggleFavoritePal;                    // 0x0BE8 (size: 0x10)
    void OnToggleFavoritePal(class UPalIndividualCharacterHandle* CharacterHandle);
    bool Is Lock;                                                                     // 0x0BF8 (size: 0x1)
    ...
    class UWidget* DoCustomNavigation_ToTopWorkSuitability(EUINavigation Navigation);
