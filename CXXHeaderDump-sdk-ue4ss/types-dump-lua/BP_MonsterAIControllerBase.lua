...
local ABP_MonsterAIControllerBase_C = {}
...
ABP_MonsterAIControllerBase_C['To Log Tone Type'] = function(self, LogType, ToneType) end
...
ABP_MonsterAIControllerBase_C['カスタムイベント_0'] = function(self, InCharacter) end
