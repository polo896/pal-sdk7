...
UWBP_CharacterMake_C['Update Camera Location'] = function(self, DeltaTime) end
---@param DeltaTime double
...
UWBP_CharacterMake_C['Get Character Make Data Instance'] = function(self, MakeDataInstance) end
...
---@param ShouldDelay boolean
UWBP_CharacterMake_C['Request Display'] = function(self, ShouldDelay) end
...
function UWBP_CharacterMake_C:DelayDisplay() end
