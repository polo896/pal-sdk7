...
---@field ReturnRadiusRate_Combat_BB double
---@field DisablelRovocationTimerHandle FTimerHandle
---@field DisablelAnimationSideStepTimerHandle FTimerHandle
---@field IsDisableAnimationSideStep boolean
---@field RoundStepHistory TArray<boolean>
local UBP_PalAIBlackboard_Common_C = {}

function UBP_PalAIBlackboard_Common_C:ClearRoundStepHistory() end
---@param IsRight boolean
function UBP_PalAIBlackboard_Common_C:AddRoundStepHistory(IsRight) end
function UBP_PalAIBlackboard_Common_C:ClearIsDisableAnimationSideStep() end
function UBP_PalAIBlackboard_Common_C:DisableAnimationSideStep() end
