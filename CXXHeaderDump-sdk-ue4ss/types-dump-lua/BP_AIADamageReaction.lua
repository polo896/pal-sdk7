...
---@field DefaultAIActionDeathClass TSubclassOf<UPalAIActionBase>
local UBP_AIADamageReaction_C = {}

---@param StunType EPalHumanStunType
---@param BlowVelocity FVector
---@param StunSuccess boolean
function UBP_AIADamageReaction_C:CheckHumanStun(StunType, BlowVelocity, StunSuccess) end
