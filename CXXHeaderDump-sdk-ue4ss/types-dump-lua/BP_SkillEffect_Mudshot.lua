...
local ABP_SkillEffect_Mudshot_C = {}
...
ABP_SkillEffect_Mudshot_C['OnHitDelegate_イベント_0'] = function(self, MyHitComponent, OtherHitActor, OtherHitComponent, FoliageIndex, HitLocation, HitCount) end
