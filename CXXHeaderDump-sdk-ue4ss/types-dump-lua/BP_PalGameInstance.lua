...
---@field UIInputBlockFlagName FName
---@field PollingFadeInWaitHandle FTimerHandle
local UBP_PalGameInstance_C = {}
...
---@param bCrossPlay boolean
function UBP_PalGameInstance_C:StartGame(bNewGame, bListenServer, bCrossPlay) end
---@param bResult boolean
UBP_PalGameInstance_C['カスタムイベント'] = function(self, bResult) end
...
function UBP_PalGameInstance_C:PollingCheckLoadingScreen() end
