...
---@field OtomoNameMap TMap<UPalIndividualCharacterHandle, FName>
local UBP_PalIncidentInvaderBase_C = {}

function UBP_PalIncidentInvaderBase_C:ClearInvaderCompassIcon() end
---@param Otomo APalCharacter
---@param IsActive boolean
function UBP_PalIncidentInvaderBase_C:OnOtomoActivated(Otomo, IsActive) end
...
UBP_PalIncidentInvaderBase_C['Get Character Location Type'] = function(self, CharacterLocationType) end
---@param StartLocation FVector
...
function UBP_PalIncidentInvaderBase_C:OnWaveTimeup() end
