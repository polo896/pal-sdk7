...
local UBP_ActionCutPalMeat_Player_C = {}

---@param UseKnife boolean
UBP_ActionCutPalMeat_Player_C['Use Meat Cut Knife'] = function(self, UseKnife) end
---@param IsValid boolean
function UBP_ActionCutPalMeat_Player_C:IsValidTarget(IsValid) end
