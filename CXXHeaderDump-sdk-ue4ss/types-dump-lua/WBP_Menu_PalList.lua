...
function UWBP_Menu_PalList_C:OnUpdateSkin(NewSkinName) end
---@param IsMute boolean
function UWBP_Menu_PalList_C:SetMuteClickEvent(IsMute) end
...
function UWBP_Menu_PalList_C:UpdateFavorite(NewIndex) end
---@param Now double
---@param Max double
