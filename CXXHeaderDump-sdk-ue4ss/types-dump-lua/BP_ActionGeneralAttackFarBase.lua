...
local UBP_ActionGeneralAttackFarBase_C = {}

---@param IsEnable boolean
UBP_ActionGeneralAttackFarBase_C['Is Enable Rot Pitch'] = function(self, IsEnable) end
...
UBP_ActionGeneralAttackFarBase_C['Adjust Effect Rot Pitch to Target'] = function(self, AttachOnly) end
