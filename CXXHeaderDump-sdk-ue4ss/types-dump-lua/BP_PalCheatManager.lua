...
local UBP_PalCheatManager_C = {}

function UBP_PalCheatManager_C:TogglePalSpawner() end
function UBP_PalCheatManager_C:LaunchNewBuildObjectUI() end
...
function UBP_PalCheatManager_C:PlayAreaBarrierUnlockCutscene_BP() end
