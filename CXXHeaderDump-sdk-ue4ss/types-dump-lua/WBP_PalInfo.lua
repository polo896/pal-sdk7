...
---@field DisplayingGetInfo FFPalUIPalInfoDisplayData
local UWBP_PalInfo_C = {}
...
UWBP_PalInfo_C['Create Default Get Info'] = function(self, CaptureInfo, getInfoData, isSuccessed) end
...
---@param AlreadyBonusCompleted boolean
function UWBP_PalInfo_C:AnmEvent_OpenAndSetTimer(infoType, AlreadyBonusCompleted) end
...
---@param AlreadyBonusCompleted boolean
function UWBP_PalInfo_C:AnmEvent_DescToBonus(AlreadyBonusCompleted) end
function UWBP_PalInfo_C:Construct() end
