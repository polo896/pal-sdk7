...
local UBP_AIAction_NPC_Talking_C = {}

---@param TalkAction TSubclassOf<UPalActionBase>
function UBP_AIAction_NPC_Talking_C:GetNPCTalkingActionClass(TalkAction) end
...
---@param Pawn APawn
function UBP_AIAction_NPC_Talking_C:OnActionStop(Pawn) end
