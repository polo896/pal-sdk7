...
---@field EnableDashSkip boolean
---@field DashSkipTime double
---@field bLocalVelocityControl boolean
local UBP_UniqueSkillModule_Tackle_C = {}

---@param GeneralAnimationParameter FGeneralAnimationParameter
---@param Character APalCharacter
---@param Success boolean
function UBP_UniqueSkillModule_Tackle_C:CanDashSkip(GeneralAnimationParameter, Character, Success) end
---@param Montages TArray<UAnimMontage>
---@param Result boolean
function UBP_UniqueSkillModule_Tackle_C:IsPlayingAnyMontage(Montages, Result) end
---@param Result boolean
function UBP_UniqueSkillModule_Tackle_C:IsPlayingEndMontage(Result) end
...
function UBP_UniqueSkillModule_Tackle_C:OnMontageEnded_Tackle(Montage, bInterrupted) end
