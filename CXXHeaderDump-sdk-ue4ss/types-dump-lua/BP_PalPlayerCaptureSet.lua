...
---@field ArmorMaterialOverrideMap TMap<UMaterialInstance, UMaterialInstance>
local ABP_PalPlayerCaptureSet_C = {}
...
ABP_PalPlayerCaptureSet_C['Add Camera Relative Location'] = function(self, AddLocation) end
