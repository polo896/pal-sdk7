...
---@class UBP_ActionSleep_C : UPalAction_Sleep
...
---@field bFadingBySleepLoop boolean
local UBP_ActionSleep_C = {}

---@param Character APalCharacter
function UBP_ActionSleep_C:UnregisterSleepLoopEffect(Character) end
---@param Return_Value boolean
function UBP_ActionSleep_C:ShouldChangeSleepLoopMontage(Return_Value) end
---@param AnimMontage UAnimMontage
function UBP_ActionSleep_C:GetSleepLoopMontage(AnimMontage) end
---@return boolean
function UBP_ActionSleep_C:IsPlayingSleepLoop() end
function UBP_ActionSleep_C:CheckSleepOnSideAndReplaceMontage() end
