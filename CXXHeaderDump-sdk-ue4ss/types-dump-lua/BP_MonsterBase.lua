...
local ABP_MonsterBase_C = {}

function ABP_MonsterBase_C:SpawnMultiJumpEffect() end
...
ABP_MonsterBase_C['OnUpdateLevelDelegate_イベント_0'] = function(self, addLevel, nowLevel) end
function ABP_MonsterBase_C:RegisterSwimEvent() end
function ABP_MonsterBase_C:OnEnterWater() end
function ABP_MonsterBase_C:OnExitWater() end
function ABP_MonsterBase_C:UnregisterSwimEvent() end
---@param EndPlayReason EEndPlayReason::Type
function ABP_MonsterBase_C:ReceiveEndPlay(EndPlayReason) end
---@param IsAboveWater boolean
function ABP_MonsterBase_C:OnUpdateAboveWater(IsAboveWater) end
---@param Component UPalCharacterMovementComponent
function ABP_MonsterBase_C:BndEvt__BP_MonsterBase_CharacterMovement_K2Node_ComponentBoundEvent_3_OnCancelJumpDelegate__DelegateSignature(Component) end
