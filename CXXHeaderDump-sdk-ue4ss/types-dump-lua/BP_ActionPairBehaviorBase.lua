...
---@field PlayingAnimMontage UAnimMontage
local UBP_ActionPairBehaviorBase_C = {}

---@return EPalActionType
function UBP_ActionPairBehaviorBase_C:GetEActionForRideBoss() end
---@param IsValid boolean
UBP_ActionPairBehaviorBase_C['Is Valid Target'] = function(self, IsValid) end
