...
---@field ['DestroyableWall BPName'] FString
local UBP_HitEffectSlot_C = {}
...
---@param OverrideEffect TSoftObjectPtr<UNiagaraSystem>
UBP_HitEffectSlot_C['Spawn Elemental Hit Effect Far'] = function(self, Element, Location, EffectScale, IsPoison, OverrideEffect) end
