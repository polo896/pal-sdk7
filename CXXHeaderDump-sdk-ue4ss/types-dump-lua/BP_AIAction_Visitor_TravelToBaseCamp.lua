...
local UBP_AIAction_Visitor_TravelToBaseCamp_C = {}

---@param ControlledPawn AActor
---@param DeltaTime float
UBP_AIAction_Visitor_TravelToBaseCamp_C['Tick Move to Base Camp'] = function(self, ControlledPawn, DeltaTime) end
...
UBP_AIAction_Visitor_TravelToBaseCamp_C['Sight Check and Response'] = function(self, Current, OverrideIsDamage, ChangeNextAction) end
