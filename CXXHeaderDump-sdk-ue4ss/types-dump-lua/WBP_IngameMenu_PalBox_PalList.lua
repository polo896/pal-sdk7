...
---@field Anm_Pal_Alive UWidgetAnimation
---@field Anm_Pal_Dead UWidgetAnimation
...
---@field Image_Pal_List_Bar UImage
---@field PalIcon UImage
---@field PalSelect_BaseTri UCanvasPanel
...
---@field bEnableDragDrop boolean
local UWBP_IngameMenu_PalBox_PalList_C = {}

function UWBP_IngameMenu_PalBox_PalList_C:Unbind() end
---@param NewSkinName FName
function UWBP_IngameMenu_PalBox_PalList_C:OnUpdateSkin(NewSkinName) end
---@param bIsEnable boolean
function UWBP_IngameMenu_PalBox_PalList_C:SetEnableDragDrop(bIsEnable) end
---@param Slot UPalIndividualCharacterSlot
---@param LastHandle UPalIndividualCharacterHandle
function UWBP_IngameMenu_PalBox_PalList_C:OnUpdateHandleSlot(Slot, LastHandle) end
...
UWBP_IngameMenu_PalBox_PalList_C['Update Level'] = function(self, NewLevel) end
---@param NewIndex int32
function UWBP_IngameMenu_PalBox_PalList_C:UpdateFavorite(NewIndex) end
