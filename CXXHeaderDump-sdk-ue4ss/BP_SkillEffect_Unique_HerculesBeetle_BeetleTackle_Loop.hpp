...
class ABP_SkillEffect_Unique_HerculesBeetle_BeetleTackle_Loop_C : public ABP_SkillEffectBase_C
{
    ...
    class USphereComponent* DisableMovementTrigger;                                   // 0x0438 (size: 0x8)
    class UNiagaraComponent* NiagaraEffect;                                           // 0x0440 (size: 0x8)
    FBP_SkillEffect_Unique_HerculesBeetle_BeetleTackle_Loop_COnHitDisableMovement OnHitDisableMovement; // 0x0448 (size: 0x10)
