...
struct FAnimBlueprintGeneratedConstantData : public FAnimBlueprintConstantData
{
    ...
    bool __BoolProperty_66;                                                           // 0x000C (size: 0x1)
    float __FloatProperty_67;                                                         // 0x0010 (size: 0x4)
    FInputScaleBiasClampConstants __StructProperty_68;                                // 0x0014 (size: 0x2C)
    float __FloatProperty_69;                                                         // 0x0040 (size: 0x4)
    bool __BoolProperty_70;                                                           // 0x0044 (size: 0x1)
    EAnimSyncMethod __EnumProperty_71;                                                // 0x0045 (size: 0x1)
    TEnumAsByte<EAnimGroupRole::Type> __ByteProperty_72;                              // 0x0046 (size: 0x1)
    FAnimNodeFunctionRef __StructProperty_73;                                         // 0x0048 (size: 0x20)
    FName __NameProperty_74;                                                          // 0x0068 (size: 0x8)
    FName __NameProperty_75;                                                          // 0x0070 (size: 0x8)
...
class UABP_Player_Hair001_Implementation_C : public UPalAnimInstance
{
    ...
    FAnimNode_Root AnimGraphNode_Root_1;                                              // 0x06F8 (size: 0x20)
    FAnimNode_LinkedInputPose AnimGraphNode_LinkedInputPose;                          // 0x0718 (size: 0xC8)
    FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;       // 0x07E0 (size: 0x20)
    FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;       // 0x0800 (size: 0x20)
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics_13;                           // 0x0820 (size: 0x840)
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics_12;                           // 0x1060 (size: 0x840)
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics_11;                           // 0x18A0 (size: 0x840)
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics_10;                           // 0x20E0 (size: 0x840)
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics_9;                            // 0x2920 (size: 0x840)
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics_8;                            // 0x3160 (size: 0x840)
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics_7;                            // 0x39A0 (size: 0x840)
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics_6;                            // 0x41E0 (size: 0x840)
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics_5;                            // 0x4A20 (size: 0x840)
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics_4;                            // 0x5260 (size: 0x840)
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics_3;                            // 0x5AA0 (size: 0x840)
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics_2;                            // 0x62E0 (size: 0x840)
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics_1;                            // 0x6B20 (size: 0x840)
    FAnimNode_KawaiiPhysics AnimGraphNode_KawaiiPhysics;                              // 0x7360 (size: 0x840)
    FAnimNode_ApplyAdditive AnimGraphNode_ApplyAdditive;                              // 0x7BA0 (size: 0xC8)
    FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer;                            // 0x7C68 (size: 0x48)
    FAnimNode_Root AnimGraphNode_Root;                                                // 0x7CB0 (size: 0x20)
    FKawaiiPhysicsSettings PhysicsSettings;                                           // 0x7CD0 (size: 0x18)
    double Alpha;                                                                     // 0x7CE8 (size: 0x8)
