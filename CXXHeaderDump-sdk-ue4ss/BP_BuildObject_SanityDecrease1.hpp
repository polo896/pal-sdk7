#ifndef UE4SS_SDK_BP_BuildObject_SanityDecrease1_HPP
#define UE4SS_SDK_BP_BuildObject_SanityDecrease1_HPP

class ABP_BuildObject_SanityDecrease1_C : public APalBuildObject
{
    class UBP_BuildObjectSimulateArrowComponent_C* BP_BuildObjectSimulateArrowComponent; // 0x0750 (size: 0x8)
    class UPalMapObjectBaseCampPassiveEffectSanityParameterComponent* PalMapObjectBaseCampPassiveEffectSanityParameter; // 0x0758 (size: 0x8)
