...
class UWBP_PalOverallUILayout_C : public UPalPrimaryGameLayoutBase
{
    ...
    TMap<EPalFadeWidgetLayerType, UCanvasPanel*> FadeWidgetCanvasMap;                 // 0x03C8 (size: 0x50)
    TMap<EPalFadeWidgetType, TSubclassOf<class UWBP_PalFadeWidgetBase_C>> FadeWidgetMap; // 0x0418 (size: 0x50)
    TArray<EPalFadeWidgetLayerType> WaitFadeInLayers;                                 // 0x0468 (size: 0x10)
    class UPalUILiftSlotModel* LiftSlotModel;                                         // 0x0478 (size: 0x8)
    TSoftObjectPtr<class UWidget> CursorTargetWidget;                                 // 0x0480 (size: 0x30)
    TMap<FGuid, UWBP_CommonWarning_C*> WarningWidgets;                                // 0x04B0 (size: 0x50)
