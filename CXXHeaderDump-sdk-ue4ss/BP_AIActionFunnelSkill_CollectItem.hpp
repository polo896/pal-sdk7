...
class UBP_AIActionFunnelSkill_CollectItem_C : public UPalAIActionFunnelSkillBase
{
    ...
    bool bPickupped;                                                                  // 0x0148 (size: 0x1)
    class UPalFunnelSkillModuleCollectItem* ModuleCollectItem;                        // 0x0150 (size: 0x8)
    class UAnimMontage* PickupAnimation;                                              // 0x0158 (size: 0x8)
