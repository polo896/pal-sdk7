#ifndef UE4SS_SDK_SK_ElecCat_Skeleton_AnimBlueprint_UJPF_HPP
#define UE4SS_SDK_SK_ElecCat_Skeleton_AnimBlueprint_UJPF_HPP
...
class USK_ElecCat_Skeleton_AnimBlueprint_UJPF_C : public UAnimInstance
{
    ...
    FAnimNode_ModifyBone AnimGraphNode_ModifyBone;                                    // 0x0490 (size: 0x128)

    void AnimGraph(FPoseLink InPose, FPoseLink& AnimGraph);
    void ExecuteUbergraph_SK_ElecCat_Skeleton_AnimBlueprint_UJPF(int32 EntryPoint);
}; // Size: 0x5B8
