...
class UWBP_ResearchEffectIcon_C : public UUserWidget
{
    ...
    TMap<EPalWorkSuitability, TSoftObjectPtr<class UTexture2D>> MainTypeIcons;        // 0x0288 (size: 0x50)
    TMap<EPalLabCategorySubType, TSoftObjectPtr<class UTexture2D>> SubTypeIcons;      // 0x02D8 (size: 0x50)
