...
class UBP_CoopSkill_NightRunner_C : public UPalCoopSkillModuleAssignPassiveSkill
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0050 (size: 0x8)
    class UNiagaraComponent* Effect;                                                  // 0x0058 (size: 0x8)
    class UPalCharacterMovementComponent* Movement;                                   // 0x0060 (size: 0x8)
    FName Flag Name;                                                                  // 0x0068 (size: 0x8)
    TArray<double> SpeedMultiplier;                                                   // 0x0070 (size: 0x10)
    TArray<double> AccelerationMultiplier;                                            // 0x0080 (size: 0x10)
