...
class UWBP_MenuESC_C : public UPalUserWidgetOverlayUI
{
    ...
    class UWidgetAnimation* Anm_Clipboard_InToOut;                                    // 0x0488 (size: 0x8)
    class UWidgetAnimation* Anm_Copy_NormalToFocus;                                   // 0x0490 (size: 0x8)
    class UCheckBox* AimAssistKeyboard_CheckBox;                                      // 0x0498 (size: 0x8)
    class UCheckBox* AimAssistPad_CheckBox;                                           // 0x04A0 (size: 0x8)
    class UCheckBox* bActiveUNKO_CheckBox;                                            // 0x04A8 (size: 0x8)
    class UCheckBox* bEnableFriendlyFire_CheckBox;                                    // 0x04B0 (size: 0x8)
    class UCheckBox* bEnableInvaderEnemy_CheckBox;                                    // 0x04B8 (size: 0x8)
    class UBP_PalRichTextBlock_C* BP_PalRichTextBlock_MultiTips;                      // 0x04C0 (size: 0x8)
    class UBP_PalTextBlock_C* BPPalTextBlock_JitterNum;                               // 0x04C8 (size: 0x8)
    class UBP_PalTextBlock_C* BPPalTextBlock_JoinNum;                                 // 0x04D0 (size: 0x8)
    class UBP_PalTextBlock_C* BPPalTextBlock_PacketlossNum;                           // 0x04D8 (size: 0x8)
    class UBP_PalTextBlock_C* BPPalTextBlock_RTTNum;                                  // 0x04E0 (size: 0x8)
    class UBP_PalTextBlock_C* BPPalTextBlock_ServerFPSNum;                            // 0x04E8 (size: 0x8)
    class UBP_PalTextBlock_C* BPPalTextBlock_WorldExplain;                            // 0x04F0 (size: 0x8)
    class UBP_PalTextBlock_C* BPPalTextBlock_WorldName;                               // 0x04F8 (size: 0x8)
    class USpinBox* BuildObjectDamageRate_SpinBox;                                    // 0x0500 (size: 0x8)
    class UCanvasPanel* Canvas_Buttons;                                               // 0x0508 (size: 0x8)
    class UCanvasPanel* Canvas_Content;                                               // 0x0510 (size: 0x8)
    class UCanvasPanel* CanvasPanel_EOSError;                                         // 0x0518 (size: 0x8)
    class UCanvasPanel* CanvasPanel_MultiTips;                                        // 0x0520 (size: 0x8)
    class UCanvasPanel* CanvasPanelPlayerList;                                        // 0x0528 (size: 0x8)
    class UCanvasPanel* CanvasPanelServerInfo;                                        // 0x0530 (size: 0x8)
    class USpinBox* CollectionDropRate_SpinBox;                                       // 0x0538 (size: 0x8)
    class USpinBox* CollectionObjectHpRate_SpinBox;                                   // 0x0540 (size: 0x8)
    class USpinBox* CollectionObjectRespawnSpeedRate;                                 // 0x0548 (size: 0x8)
    class UOverlay* CopyCode;                                                         // 0x0550 (size: 0x8)
    class USpinBox* DayTimeSpeedRateValue_SpinBox;                                    // 0x0558 (size: 0x8)
    class UComboBoxString* DeathPenalty_ComboBox;                                     // 0x0560 (size: 0x8)
    class UComboBoxString* Difficulty_ComboBox;                                       // 0x0568 (size: 0x8)
    class USpinBox* DropItemMaxNum_SpinBox;                                           // 0x0570 (size: 0x8)
    class USpinBox* DropItemMaxNum_UNKO_SpinBox;                                      // 0x0578 (size: 0x8)
    class USpinBox* EnemyDropItemRate_SpinBox;                                        // 0x0580 (size: 0x8)
    class USpinBox* ExpRate_SpinBox;                                                  // 0x0588 (size: 0x8)
    class UHorizontalBox* HorizontalBox_Jitter;                                       // 0x0590 (size: 0x8)
    class UHorizontalBox* HorizontalBox_JoinNum;                                      // 0x0598 (size: 0x8)
    class UHorizontalBox* HorizontalBox_PacketLoss;                                   // 0x05A0 (size: 0x8)
    class UHorizontalBox* HorizontalBox_RTT;                                          // 0x05A8 (size: 0x8)
    class UHorizontalBox* HorizontalBox_ServerFPS;                                    // 0x05B0 (size: 0x8)
    class UImage* IconShowHide;                                                       // 0x05B8 (size: 0x8)
    class UImage* Image_115;                                                          // 0x05C0 (size: 0x8)
    class UImage* Image_CautionBase;                                                  // 0x05C8 (size: 0x8)
    class UHorizontalBox* InviteCode_HorizontalBox;                                   // 0x05D0 (size: 0x8)
    class USpinBox* NightTimeSpeedRate_SpinBox;                                       // 0x05D8 (size: 0x8)
    class UOverlay* Overlay_WorldExplain;                                             // 0x05E0 (size: 0x8)
    class USpinBox* PalAutoHPRegeneRate_SpinBox;                                      // 0x05E8 (size: 0x8)
    class USpinBox* PalAutoHpRegeneRateInSleep_SpinBOx;                               // 0x05F0 (size: 0x8)
    class USpinBox* PalCaptureRateAdd_SpinBox;                                        // 0x05F8 (size: 0x8)
    class USpinBox* PalDamageRateAttack_SpinBox;                                      // 0x0600 (size: 0x8)
    class USpinBox* PalDamageRateDefense_SpinBox;                                     // 0x0608 (size: 0x8)
    class UPalRichTextBlockBase* PalRichTextBlockBase_370;                            // 0x0610 (size: 0x8)
    class USpinBox* PalSpawnNumRate_SpinBox;                                          // 0x0618 (size: 0x8)
    class USpinBox* PalStaminaDecreaceRate;                                           // 0x0620 (size: 0x8)
    class USpinBox* PalStomachDecreaceRate_SpinBox;                                   // 0x0628 (size: 0x8)
    class USpinBox* PlayerAutoHPRegeneRate_SpinBox;                                   // 0x0630 (size: 0x8)
    class USpinBox* PlayerAutoHpRegeneRateInSleep_SpinBox;                            // 0x0638 (size: 0x8)
    class USpinBox* PlayerDamageRateAttack_SpinBox;                                   // 0x0640 (size: 0x8)
    class USpinBox* PlayerDamageRateDefense_SpinBox;                                  // 0x0648 (size: 0x8)
    class USpinBox* PlayerStaminaDecreaceRate;                                        // 0x0650 (size: 0x8)
    class USpinBox* PlayerStomachDecreaceRate_SpinBox;                                // 0x0658 (size: 0x8)
    class UBP_PalRichTextBlock_C* RichTextBlock_EOSError;                             // 0x0660 (size: 0x8)
    class UScrollBox* ScrollBox_Text;                                                 // 0x0668 (size: 0x8)
    class UBP_PalTextBlock_C* Text_InviteCode;                                        // 0x0670 (size: 0x8)
    class UVerticalBox* VerticalBox_PlayerList;                                       // 0x0678 (size: 0x8)
    class UVerticalBox* VerticalBox_ServerInfo;                                       // 0x0680 (size: 0x8)
    class UVerticalBox* VerticalBoxWorld;                                             // 0x0688 (size: 0x8)
    class UWBP_CommonButton_1_C* WBP_CommonButton_BlockList;                          // 0x0690 (size: 0x8)
    class UWBP_MenuESC_Button_C* WBP_MenuESC_Button_Note;                             // 0x0698 (size: 0x8)
    class UWBP_MenuESC_Button_C* WBP_MenuESC_Button_Option;                           // 0x06A0 (size: 0x8)
    class UWBP_MenuESC_Button_S_C* WBP_MenuESC_Button_S_Discord;                      // 0x06A8 (size: 0x8)
    class UWBP_MenuESC_Button_S_C* WBP_MenuESC_Button_S_Eula;                         // 0x06B0 (size: 0x8)
    class UWBP_MenuESC_Button_S_C* WBP_MenuESC_Button_S_Form;                         // 0x06B8 (size: 0x8)
    class UWBP_MenuESC_Button_S_C* WBP_MenuESC_Button_S_Pause;                        // 0x06C0 (size: 0x8)
    class UWBP_MenuESC_Button_S_C* WBP_MenuESC_Button_S_ReturnTitle;                  // 0x06C8 (size: 0x8)
    class UWBP_MenuESC_Button_S_C* WBP_MenuESC_Button_S_XBInvite;                     // 0x06D0 (size: 0x8)
    class UWBP_MenuESC_Button_S_C* WBP_MenuESC_Button_Suicide;                        // 0x06D8 (size: 0x8)
    class UWBP_MenuESC_Button_C* WBP_MenuESC_Button_Tips;                             // 0x06E0 (size: 0x8)
    class UWBP_MenuESC_PlayerMenu_C* WBP_MenuESC_PlayerMenu;                          // 0x06E8 (size: 0x8)
    class UWBP_MenuESC_tabset_C* WBP_MenuESC_tabset1;                                 // 0x06F0 (size: 0x8)
    class UWBP_PalCommonScrollList_C* WBP_PalCommonScrollList_Members;                // 0x06F8 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton_CopyCode;                 // 0x0700 (size: 0x8)
    class UWBP_PalInvisibleButton_C* WBP_PalInvisibleButton_ShoiwHideInviteCode;      // 0x0708 (size: 0x8)
    class UCanvasPanel* WorldOptionCanvas;                                            // 0x0710 (size: 0x8)
    FPalOptionWorldSettings OptionWorldSettingsCache;                                 // 0x0718 (size: 0x210)
    FPalOptionAudioSettings AudioSettingsCache;                                       // 0x0928 (size: 0x24)
    FPalOptionKeyboardSettings KeyboardSettingsCache;                                 // 0x094C (size: 0x14)
    FPalOptionPadSettings PadSettingsCache;                                           // 0x0960 (size: 0x1C)
    FPalOptionGraphicsSettings GraphicsSettingsCache;                                 // 0x097C (size: 0x68)
    FDataTableRowHandle CheckSucide_FirstStep;                                        // 0x09E8 (size: 0x10)
    FDataTableRowHandle CheckSucide_SecondStep;                                       // 0x09F8 (size: 0x10)
    FDataTableRowHandle ToTitleDialogMsgId;                                           // 0x0A08 (size: 0x10)
    bool bShowInviteCode;                                                             // 0x0A18 (size: 0x1)
    bool Close All;                                                                   // 0x0A19 (size: 0x1)
    FWBP_MenuESC_COnCloseEscMenu OnCloseEscMenu;                                      // 0x0A20 (size: 0x10)
    void OnCloseEscMenu();
    bool IsSelectingMemberMenu;                                                       // 0x0A30 (size: 0x1)
    TSoftObjectPtr<UWBP_MenuESCPlayerListItem_C> SelectionPlayerWidget;               // 0x0A38 (size: 0x30)
    FDataTableRowHandle MutePlayerDialogMsgID;                                        // 0x0A68 (size: 0x10)
    FGuid MutePlayerUId;                                                              // 0x0A78 (size: 0x10)
    FText Ban Reason;                                                                 // 0x0A88 (size: 0x18)
    FDataTableRowHandle UnMutePlayerDialogMsgID;                                      // 0x0AA0 (size: 0x10)
    FDataTableRowHandle BlockPlayerDialogMsgID;                                       // 0x0AB0 (size: 0x10)
    FDataTableRowHandle UnBlockPlayerDialogMsgID;                                     // 0x0AC0 (size: 0x10)
    int32 TabIndex;                                                                   // 0x0AD0 (size: 0x4)
    bool IsFirstSetup;                                                                // 0x0AD4 (size: 0x1)
    class UWidgetAnimation* Anm_PalInfo;                                              // 0x0AD8 (size: 0x8)
    class UWidgetAnimation* Anm_PalinfoToMap;                                         // 0x0AE0 (size: 0x8)
    class UWidgetAnimation* Anm_MapToPalinfo;                                         // 0x0AE8 (size: 0x8)
    FPalDataTableRowName_UIInputAction ToPlayerlistInputAction;                       // 0x0AF0 (size: 0x8)
    FPalDataTableRowName_UIInputAction ToServerinfoInputAction;                       // 0x0AF8 (size: 0x8)
    FPalUIActionBindData ToPlayerlistInputHandle;                                     // 0x0B00 (size: 0x4)
    FPalUIActionBindData ToServerinfoInputHandle;                                     // 0x0B04 (size: 0x4)
    double ScrollPerSecond;                                                           // 0x0B08 (size: 0x8)
    double RightStickAxisY;                                                           // 0x0B10 (size: 0x8)
    FTimerHandle CheckEOSStatusTimerHandle;                                           // 0x0B18 (size: 0x8)
    TArray<class UWBP_MenuESC_Button_Base_C*> MenuButtons;                            // 0x0B20 (size: 0x10)
    FDataTableRowHandle EOSConnectionIssueMsgID;                                      // 0x0B30 (size: 0x10)
    TEnumAsByte<E_PalEscMenuType::Type> CurrentMenuType;                              // 0x0B40 (size: 0x1)
    FWBP_MenuESC_COnLaunchHeilGuideOrSurvivalGuide OnLaunchHeilGuideOrSurvivalGuide;  // 0x0B48 (size: 0x10)
    void OnLaunchHeilGuideOrSurvivalGuide();
    FWBP_MenuESC_COnReturnFromGuideMenu OnReturnFromGuideMenu;                        // 0x0B58 (size: 0x10)
