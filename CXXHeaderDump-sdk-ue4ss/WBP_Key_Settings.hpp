...
class UWBP_Key_Settings_C : public UUserWidget
{
    ...
    TArray<UVerticalBox*> VerticalBoxs;                                               // 0x02B8 (size: 0x10)
    TArray<UWBP_PalCommonButtonBase_C*> FirstRows;                                    // 0x02C8 (size: 0x10)
    int32 Current;                                                                    // 0x02D8 (size: 0x4)
    TMap<FName, UWBP_OptionSettings_ListContent_C*> InputActionsMap_KM;               // 0x02E0 (size: 0x50)
    TMap<FName, UWBP_OptionSettings_ListContent_C*> InputActionsMap_GP;               // 0x0330 (size: 0x50)
    TMap<FName, UWBP_OptionSettings_ListContent_C*> UIActionsMap_KM;                  // 0x0380 (size: 0x50)
    TMap<FName, UWBP_OptionSettings_ListContent_C*> UIActionsMap_GP;                  // 0x03D0 (size: 0x50)
    FPalKeyConfigSettings KeyConfigSettingsCache;                                     // 0x0420 (size: 0x160)
    TMap<FName, FPalKeyAction> AxisMap;                                               // 0x0580 (size: 0x50)
    TMap<FPalKeyAction, FName> ReverseAxisMap;                                        // 0x05D0 (size: 0x50)
    ...
    TMap<FName, FName> MultiKeyMap;                                                   // 0x0658 (size: 0x50)
    ...
    void Multi Key Setting(const TMap<FName, FPalKeyConfigKeys>& TargetMap, const FName& ActionName, const FPalKeyConfigKeys& Key);
