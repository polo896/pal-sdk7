...
class UWBP_Arena_TopMenu_C : public UPalUserWidgetOverlayUI
{
    ...
    class UWidgetAnimation* Anm_ButtonOut;                                            // 0x0488 (size: 0x8)
    class UWidgetAnimation* Anm_MenuInOut;                                            // 0x0490 (size: 0x8)
    class UWidgetAnimation* Anm_Out;                                                  // 0x0498 (size: 0x8)
    class UWidgetAnimation* Anm_In;                                                   // 0x04A0 (size: 0x8)
    class UCanvasPanel* Canvas_MenuGuideText;                                         // 0x04A8 (size: 0x8)
    class UCanvasPanel* Canvas_Wait;                                                  // 0x04B0 (size: 0x8)
    class UBP_PalTextBlock_C* Text_MenuGuide;                                         // 0x04B8 (size: 0x8)
    class UWBP_Arena_PlayerRank_C* WBP_Arena_PlayerRank;                              // 0x04C0 (size: 0x8)
    class UWBP_Arena_TopMenuButton_C* WBP_Arena_TopMenuButton_PvP;                    // 0x04C8 (size: 0x8)
    class UWBP_Arena_TopMenuButton_C* WBP_Arena_TopMenuButton_Solo;                   // 0x04D0 (size: 0x8)
    class UWBP_Arena_TopMenuButton_C* WBP_Arena_TopMenuButton_Spectate;               // 0x04D8 (size: 0x8)
    class APalArenaEntrance* Entrance;                                                // 0x04E0 (size: 0x8)
    int32 LastFocusIndex;                                                             // 0x04E8 (size: 0x4)
    bool MenuOut;                                                                     // 0x04EC (size: 0x1)
    EPalArenaMenuActionType LastAction;                                               // 0x04ED (size: 0x1)
