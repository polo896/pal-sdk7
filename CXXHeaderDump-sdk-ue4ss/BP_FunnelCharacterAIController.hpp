...
class ABP_FunnelCharacterAIController_C : public APalAIController
{
    ...
    TSubclassOf<class UPalAIActionCompositeBase> DefaultRootCompositeActionClass;     // 0x0570 (size: 0x8)
    FVector FollowInterpolatedPos;                                                    // 0x0578 (size: 0x18)
    double FollowSpeed;                                                               // 0x0590 (size: 0x8)
    FName flagName;                                                                   // 0x0598 (size: 0x8)
