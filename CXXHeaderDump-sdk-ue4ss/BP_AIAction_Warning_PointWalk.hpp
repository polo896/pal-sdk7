...
class UBP_AIAction_Warning_PointWalk_C : public UBP_AIAction_CanCombatBase_C
{
    ...
    FVector AttentionPoint;                                                           // 0x0180 (size: 0x18)
    double ConstWalkSpeed;                                                            // 0x0198 (size: 0x8)
    FVector MoveGoalLocation;                                                         // 0x01A0 (size: 0x18)
    double AcceptanceDistance;                                                        // 0x01B8 (size: 0x8)
    double tempDeltaTime;                                                             // 0x01C0 (size: 0x8)
    double Timer;                                                                     // 0x01C8 (size: 0x8)
    double RandomWalkStartTime;                                                       // 0x01D0 (size: 0x8)
    FVector TurnR_Direction;                                                          // 0x01D8 (size: 0x18)
    FVector TurnL_Direction;                                                          // 0x01F0 (size: 0x18)
    TEnumAsByte<EWarningPalAIMoveType::Type> MoveMode;                                // 0x0208 (size: 0x1)
    double TimeOutTime;                                                               // 0x0210 (size: 0x8)
    class UPalActionBase* TurnAction;                                                 // 0x0218 (size: 0x8)
