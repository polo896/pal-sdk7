...
class ABP_MonsterAIControllerBase_C : public APalAIController
{
    ...
    class UBP_AIADamageReaction_C* BP_AIADamageReaction;                              // 0x0570 (size: 0x8)
    TSubclassOf<class UPalAIActionBase> DefaultActionClass;                           // 0x0578 (size: 0x8)
    TSubclassOf<class UPalAIActionCompositeBase> DefaultRootCompositeActionClass;     // 0x0580 (size: 0x8)
    bool bPlayDefaultCompositeAction;                                                 // 0x0588 (size: 0x1)
    bool IsSetupEnd;                                                                  // 0x0589 (size: 0x1)
    bool IsAutoPlayDefaultAction;                                                     // 0x058A (size: 0x1)
