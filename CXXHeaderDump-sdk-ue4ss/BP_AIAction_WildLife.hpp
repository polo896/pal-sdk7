...
class UBP_AIAction_WildLife_C : public UBP_AIAction_CanCombatBase_C
{
    ...
    FVector GoalPosition;                                                             // 0x0198 (size: 0x18)
    bool InitEnd;                                                                     // 0x01B0 (size: 0x1)
    FVector PrePos;                                                                   // 0x01B8 (size: 0x18)
    FTimerHandle StackTimerHandle;                                                    // 0x01D0 (size: 0x8)
    FVector SpawnerLocation;                                                          // 0x01D8 (size: 0x18)
    double WalkingTimer;                                                              // 0x01F0 (size: 0x8)
    double tempDeltaTime;                                                             // 0x01F8 (size: 0x8)
    bool RestMode;                                                                    // 0x0200 (size: 0x1)
    double FollowRandomDistance;                                                      // 0x0208 (size: 0x8)
    FTimerHandle StateUpdateTimerHandle;                                              // 0x0210 (size: 0x8)
    FVector RestStartPosition;                                                        // 0x0218 (size: 0x18)
    TEnumAsByte<EWildPalAIMoveMode::Type> MoveMode;                                   // 0x0230 (size: 0x1)
    TEnumAsByte<EWildPalAIRestType::Type> RestType;                                   // 0x0231 (size: 0x1)
    double WalkingRadius;                                                             // 0x0238 (size: 0x8)
    bool IsGroupBehavior;                                                             // 0x0240 (size: 0x1)
    bool IsCancelThisAIAction;                                                        // 0x0241 (size: 0x1)
    bool IsTickStop;                                                                  // 0x0242 (size: 0x1)
    FTimerHandle TickStopTimer;                                                       // 0x0248 (size: 0x8)
    FTimerHandle DrinkWaterTimerHandle;                                               // 0x0250 (size: 0x8)
    bool DrinkWaterCheckFlag;                                                         // 0x0258 (size: 0x1)
    class AActor* CurrentTarget;                                                      // 0x0260 (size: 0x8)
    EPalAIResponseType CurrentResponse;                                               // 0x0268 (size: 0x1)
    bool IsSleep;                                                                     // 0x0269 (size: 0x1)
    double WanderingMinRadius;                                                        // 0x0270 (size: 0x8)
    FPalAsyncMoveRequestId CurrentMoveRequestId;                                      // 0x0278 (size: 0x4)
    FVector LastRequestedGoal;                                                        // 0x0280 (size: 0x18)
    double GoalChangeThreshold;                                                       // 0x0298 (size: 0x8)

    void IsValidFollowMoveGoal(FVector Goal, bool& IsValid);
    void CancelAsyncFollowMoveIfAny();
    void IssueAsyncFollowMove(FVector Goal);
