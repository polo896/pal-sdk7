...
class UWBP_Buildup_Player_1_C : public UPalUserWidget
{
    ...
    TMap<EPalRelicType, UWBP_Buildup_Player_Item_C*> InInventoryRelicCountWidgetMap;  // 0x0570 (size: 0x50)
    TMap<EPalRelicType, UWBP_Buildup_Player_Item_C*> RequireRelicCountWidgetMap;      // 0x05C0 (size: 0x50)
    TMap<EPalRelicType, UWBP_Buildup_Player_StatusContent_C*> OperationWidgetMap;     // 0x0610 (size: 0x50)
    TSoftObjectPtr<class UPalCharacterStatusOperation> SoftStatusOpetation;           // 0x0660 (size: 0x30)
