...
class UWBP_ColorEditor_C : public UPalUserWidgetOverlayUI
{
    ...
    class UWBP_IngameConstruction_Paint_EditColor_C* WBP_IngameConstruction_Paint_EditColor; // 0x0488 (size: 0x8)
    class UPalHUDDispatchParameter_ColorEditor* DispatchParam;                        // 0x0490 (size: 0x8)
    FPalDataTableRowName_UIInputAction CancelActionHandle_GamepadOnly;                // 0x0498 (size: 0x8)
    FPalDataTableRowName_UIInputAction CancelActionHandle_Escape;                     // 0x04A0 (size: 0x8)
    FPalDataTableRowName_UIInputAction CancelActionHandle_Tab;                        // 0x04A8 (size: 0x8)
