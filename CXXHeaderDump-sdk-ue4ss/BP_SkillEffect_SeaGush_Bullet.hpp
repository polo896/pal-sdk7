#ifndef UE4SS_SDK_BP_SkillEffect_SeaGush_Bullet_HPP
#define UE4SS_SDK_BP_SkillEffect_SeaGush_Bullet_HPP

class ABP_SkillEffect_SeaGush_Bullet_C : public ABP_SkillEffectBase_C
{
    ...
    void Setup(FVector Location, double DelayTime);
