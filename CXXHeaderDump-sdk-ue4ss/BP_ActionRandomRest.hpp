...
class UBP_ActionRandomRest_C : public UPalActionBase
{
    ...
    FPalRandomRestInfo CurrentRestInfo;                                               // 0x0170 (size: 0x18)
    int32 CurrentLoopMaxNum;                                                          // 0x0188 (size: 0x4)
    int32 CurrentLoopingCount;                                                        // 0x018C (size: 0x4)
    double tempRand;                                                                  // 0x0190 (size: 0x8)
