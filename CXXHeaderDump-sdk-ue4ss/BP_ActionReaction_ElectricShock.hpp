...
class UBP_ActionReaction_ElectricShock_C : public UPalActionBase
{
    ...
    double SelfTimer;                                                                 // 0x0168 (size: 0x8)
    class UCurveFloat* Curve_Right;                                                   // 0x0170 (size: 0x8)
    double DefaultMeshPosZ;                                                           // 0x0178 (size: 0x8)
    bool VibEnd;                                                                      // 0x0180 (size: 0x1)
    bool ExistFacialNotify;                                                           // 0x0181 (size: 0x1)
    TMap<EPalSizeType, double> Const_VibGainMap;                                      // 0x0188 (size: 0x50)
