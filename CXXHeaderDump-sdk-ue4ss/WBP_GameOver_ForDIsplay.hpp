...
class UWBP_GameOver_ForDIsplay_C : public UPalUIGameOver
{
    ...
    class UCircularThrobber* CircularThrobber_107;                                    // 0x0488 (size: 0x8)
    class UImage* Image_35;                                                           // 0x0490 (size: 0x8)
    class UOverlay* Overlay_WaitingResetCharacter;                                    // 0x0498 (size: 0x8)
    class UWBP_GameOver_Defeat_C* WBP_GameOver_Defeat;                                // 0x04A0 (size: 0x8)
    FTimerHandle BlockRespawnTimerHandle;                                             // 0x04A8 (size: 0x8)
    bool CanRespawn;                                                                  // 0x04B0 (size: 0x1)
    FDataTableRowHandle ResetCharacterDialogMsgID;                                    // 0x04B8 (size: 0x10)
