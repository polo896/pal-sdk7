...
class ABP_MapObject_PickupItem_PalEgg_Base_C : public APalMapObjectPalEgg
{
    ...
    class UStaticMeshComponent* SM_basket;                                            // 0x0430 (size: 0x8)
    ...
    class USkeletalMeshComponent* SK_Kurinuki_EggA;                                   // 0x0448 (size: 0x8)
    double Scale;                                                                     // 0x0450 (size: 0x8)
    FVector DefaultEggMeshScale;                                                      // 0x0458 (size: 0x18)
    FVector DefaultBasketMeshScale;                                                   // 0x0470 (size: 0x18)
