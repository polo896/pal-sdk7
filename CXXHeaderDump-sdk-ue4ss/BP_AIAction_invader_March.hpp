...
class UBP_AIAction_invader_March_C : public UPalAIActionBase
{
    ...
    FVector MarchGoalPosition;                                                        // 0x0140 (size: 0x18)
    FVector PrevLocation;                                                             // 0x0158 (size: 0x18)
    double StackTimer;                                                                // 0x0170 (size: 0x8)
    FVector StartPoint;                                                               // 0x0178 (size: 0x18)
    double NotStartTimer;                                                             // 0x0190 (size: 0x8)
    bool IsStartAble;                                                                 // 0x0198 (size: 0x1)
