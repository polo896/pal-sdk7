...
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0648 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0650 (size: 0x8)
    double ReturnRadius;                                                              // 0x0658 (size: 0x8)
    double WalkRadius;                                                                // 0x0660 (size: 0x8)
    TMap<class FName, class FF_NPC_PathWalkArray> WalkPathLists;                      // 0x0668 (size: 0x50)
    TArray<class UPalIndividualCharacterHandle*> IndividualHandleList;                // 0x06B8 (size: 0x10)
    TMap<class UPalIndividualCharacterHandle*, class FPalRandomIncidentSpawnMonsterData> MonsterSpawnData; // 0x06C8 (size: 0x50)
    TMap<class UPalIndividualCharacterHandle*, class FPalRandomIncidentSpawnNPCData> NPCSpawnData; // 0x0718 (size: 0x50)
    TMap<class UPalIndividualCharacterHandle*, class FName> PathNames;                // 0x0768 (size: 0x50)
    TMap<class UPalIndividualCharacterHandle*, class FName> RowNames;                 // 0x07B8 (size: 0x50)
    FBP_PalRandomIncidentNPCSpawner_CGetWalkPathDelegate GetWalkPathDelegate;         // 0x0808 (size: 0x10)
    void GetWalkPathDelegate(FName NewParam);
    TMap<class UPalIndividualCharacterHandle*, class FVector> SpawnedLocation;        // 0x0818 (size: 0x50)
    TMap<class UPalIndividualCharacterHandle*, class FName> OtomoNames;               // 0x0868 (size: 0x50)
