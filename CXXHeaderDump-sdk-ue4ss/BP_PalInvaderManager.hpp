...
class UBP_PalInvaderManager_C : public UPalInvaderManager
{
    ...
    class UBP_PalIncidentNotifyListener_C* IncidentListener;                          // 0x0320 (size: 0x8)
    FName InvaderEnemyIncidentId;                                                     // 0x0328 (size: 0x8)
    FName VisitorNPCIncidentId;                                                       // 0x0330 (size: 0x8)
