...
class UWBP_PalDebugInfo_C : public UPalUserWidget
{
    ...
    TMap<FString, FString> BuildConfigDisplayTextMap;                                 // 0x0460 (size: 0x50)
    TMap<EPalSupportedPlatformType, FString> PlatformDisplayTextMap;                  // 0x04B0 (size: 0x50)
    TMap<FString, FString> NetModeDisplayTextMap;                                     // 0x0500 (size: 0x50)
