enum class ECapturedPalPendingOp {
    None = 0,
    CreatingHandle = 1,
    Spawning = 2,
    Despawning = 3,
...
enum class EPalAchivementCategory {
    BossDefeat = 0,
    PalCapture = 1,
    PalDex = 2,
    Invalid = 3,
...
enum class EPalActionMovementBaseType {
    Walking = 0,
    Falling = 1,
    Flying = 2,
    Custom = 3,
...
enum class EPalActionMovementEndReplicationType {
    None = 0,
...
enum class EPalActivatableDamageAreaState {
    Inactive = 0,
    Activating = 1,
...
enum class EPalAkComponentTickPolicy {
...
enum class EPalArenaEntryRequestResult {
    Failed = 0,
...
enum class EPalArenaMenuActionType {
    Open = 0,
    Close = 1,
    Back = 2,
    Failed = 3,
...
enum class EPalArenaRankChange {
    NoChange = 0,
    RankUp = 1,
    RankDown = 2,
...
enum class EPalArenaRulePanelType {
    Editable = 0,
    ForConfirm = 1,
    ViewOnly = 2,
...
enum class EPalArenaSequencerOwnerType {
    None = 0,
    Player_Client = 1,
    Player_Server = 2,
    Manager_Server = 3,
...
enum class EPalArenaSpectateState {
    STATE_None = 0,
    STATE_Spectating = 1,
    STATE_MAX = 2,
};

enum class EPalArenaStartRequestResult {
    Success_Started = 0,
    Failed = 1,
...
enum class EPalAsyncMoveStatus {
    Pending = 0,
    PathFound = 1,
    Moving = 2,
    Succeeded = 3,
...
enum class EPalAttackTargetsType {
    None = 0,
    Pot = 1,
...
enum class EPalAutoTurretState {
    Inactive = 0,
    Idle = 1,
    Searching = 2,
    Engaging = 3,
...
enum class EPalBaseCampEnergyStorageConsumePriority {
    Normal = 0,
    Low = 1,
    Num = 2,
...
enum class EPalBaseCampRecoverStatusType {
    Hungry = 0,
    Sick = 1,
...
enum class EPalBodyPartsFlagOverrideState {
    Release = 0,
    HighPriority = 1,
    LowPriority = 2,
...
enum class EPalBossBattleHardUnlockCondition {
...
enum class EPalBossBattleStartRequestResult {
    Success_Started = 0,
    Failed = 1,
    Failed_OverConcurrentStageLimitation = 2,
...
enum class EPalBreedStoppedReason {
    None = 0,
    NoPower = 1,
    SlotFull = 2,
    NoItem = 3,
...
enum class EPalBuildObjectStatusHUDSlot {
    DefaultSlot = 0,
    Slot1 = 1,
    Slot2 = 2,
    Slot3 = 3,
...
enum class EPalBuildObjectTypeForUIDisplay {
    Invalid = 0,
    Product_Repair = 1,
    Weapon = 2,
    Refine = 3,
...
enum class EPalBuildingLimitType {
    Invalid = 0,
    UltraLow = 1,
    VeryLow = 2,
    Low = 3,
...
enum class EPalBuildingNumWarningType {
    None = 0,
    Warning = 1,
    Limit = 2,
...
enum class EPalCameraModifierMode {
    OneShot = 0,
    Infinite = 1,
    EPalCameraModifierMode_MAX = 2,
};

enum class EPalCameraModifierParameterType {
    None = 0,
    Replace = 1,
    Additional = 2,
...
enum class EPalCharacterLiftupObjectThrowState {
    None = 0,
    BeLiftup = 1,
    BePitching = 2,
    BeReleased = 3,
...
enum class EPalCharacterTeamMissionDifficulty {
    Easy = 0,
    Normal = 1,
    Hard = 2,
    VeryHard = 3,
...
enum class EPalCommonExpRewardType {
    Invalid = 0,
    Expedition = 1,
    DefeatBoss = 2,
    Max = 3,
...
enum class EPalCommonItemRewardType {
    Normal = 0,
...
enum class EPalDimensionStorageReplicationTriggerType {
    Common = 0,
    Sort = 1,
    EPalDimensionStorageReplicationTriggerType_MAX = 2,
};

enum class EPalDimensionalDistortionState {
    Idle = 0,
    Tracking = 1,
    Contact = 2,
    Teleporting = 3,
...
enum class EPalDungeonGimmickSpawnedCharacterState {
    Spawned = 0,
    Defeated = 1,
...
enum class EPalDungeonLevelVersion {
...
enum class EPalDungeonRewardSpawnerContentType {
    Empty = 0,
    MapObjectSpawner = 1,
    PalSpawner = 2,
    Cage = 3,
...
enum class EPalDungeonRewardSpawnerType {
    BaseInsurance = 0,
    Easy01 = 1,
    Easy02 = 2,
    Easy03 = 3,
...
enum class EPalFacialEyeTarget {
    Both = 0,
    Left = 1,
    Right = 2,
...
enum class EPalFarmSkillFruitsLotteryItemType {
    None = 0,
    SkillFruits_Same = 1,
...
enum class EPalFarmSkillFruitsPickupResult {
    Success = 0,
    Failed = 1,
...
enum class EPalFarmSkillFruitsState {
    None = 0,
    Planting = 1,
    Watered = 2,
    Growup = 3,
...
enum class EPalFishBattleBehaviorType {
    Normal = 0,
    Calm = 1,
    Diver = 2,
    Riser = 3,
...
enum class EPalFishShadowSizeType {
    None = 0,
    A = 1,
    B = 2,
    C = 3,
...
enum class EPalFishingMotionType {
    None = 0,
    Fishing_Start = 1,
    Fishing_Idle = 2,
...
enum class EPalFishingPlayerMotionType {
    None = 0,
    S1 = 1,
    S2 = 2,
    M1 = 10,
...
enum class EPalFishingResultType {
    Success = 0,
...
enum class EPalFishingRodState {
    None = 0,
    Idle = 1,
    WaitThrowing = 2,
    Throwing = 3,
...
enum class EPalFishingSpotDifficultyType {
    None = 0,
    Easy = 1,
    Normal = 2,
    Difficult = 3,
...
enum class EPalFoliageInstanceState {
    Alive = 0,
    Decaying = 1,
    Dead = 2,
...
enum class EPalGlobalStorageExportResult {
    Success = 0,
...
enum class EPalGlobalStorageImportResult {
    Success = 0,
...
enum class EPalGrapplingGunState {
    Idle = 0,
    Shooting = 1,
    Pulling = 2,
    Grappling = 3,
...
enum class EPalGuildNotificationType {
    Join = 0,
    Leave = 1,
    Login = 2,
    Logout = 3,
...
enum class EPalGuildPermission {
    JoinApproval = 0,
    Expulsion = 1,
    RoleEdit = 2,
    RoleAssignment = 3,
...
enum class EPalGuildRoleChangeReason {
    Manual = 0,
    GuildCreation = 1,
    AutoTransfer = 2,
    Merge = 3,
...
enum class EPalHeliDropOffState {
    Idle = 0,
    Deploying = 1,
    Complete = 2,
    Aborted = 3,
...
enum class EPalInvaderCancelResult {
    Success = 0,
...
enum class EPalItemInfoCollectType {
    InventoryOnly = 0,
    BaseCampOnly = 1,
    Both = 2,
...
enum class EPalItemRequireCategory {
    Food_A = 0,
    Food_B = 1,
    Food_C = 2,
    Food_D = 3,
...
enum class EPalItemUseEffectType {
    Invalid = 0,
...
enum class EPalJetpackEffectAttachTarget {
    RootComponent = 0,
    GliderMesh = 1,
    CharacterMesh = 2,
...
enum class EPalJetpackShootingOverride {
    None = 0,
    ForceAllow = 1,
    ForceDeny = 2,
...
enum class EPalKingWhaleBattlePhase {
    Phase0 = 0,
    Phase1 = 1,
    Phase2 = 2,
    Phase3 = 3,
...
enum class EPalLabCategorySubType {
    None = 0,
...
enum class EPalLabResearchOperationResult {
...
enum class EPalLogWidgetOverrideClassType {
    Invalid = 0,
    StartExpedition = 1,
...
enum class EPalLowGravityApplySource {
    Pollen = 0,
    Passive = 2,
...
enum class EPalMapObjectAccessType {
    Anyone = 0,
    SameGuildOnly = 1,
...
enum class EPalMapObjectCharacterTeamMissionIconTextureType {
    None = 0,
    Grass = 1,
    Forest = 2,
    Volcano = 3,
...
enum class EPalMapObjectCharacterTeamMissionState {
    None = 0,
    Ready = 1,
    InProgress = 2,
    Reward = 3,
...
enum class EPalMapObjectTreasureSpecialType {
    None = 0,
    Salvage = 1,
...
enum class EPalMapObjectValidationCheckMode {
...
enum class EPalMimicEncountType {
    None = 0,
    Battle = 1,
    Escape = 2,
...
enum class EPalMultiplayRestrictReason {
    None = 0,
    Unknown = 1,
...
enum class EPalNiagaraSoundAkComponentTickPolicy {
    UseAkDefault = 0,
    AlwaysDisable = 1,
...
enum class EPalOilrigCombatHeliWeaponType {
    MachineGun = 0,
    Missile = 1,
    Bomb = 2,
    MachineGun_Wide = 3,
...
enum class EPalOilrigNPCSpawnerCheckResultType {
    Ignore = 0,
    Spawn = 1,
    Despawn = 2,
...
enum class EPalOneStrokeGameDifficultyType {
    Invalid = 0,
    VeryEasy = 1,
    Easy = 2,
    Normal = 3,
...
enum class EPalOneStrokeGameState {
    NotInitialized = 0,
    Pause = 1,
    InGame = 2,
    Success = 3,
...
enum class EPalOneStrokeMoveDirection {
    Up = 0,
    Down = 1,
    Left = 2,
    Right = 3,
...
enum class EPalOneStrokeTileState {
    Empty = 0,
    Visited = 1,
    Start = 2,
    Goal = 3,
...
enum class EPalOptionLocalSaveRequestType {
    None = 0,
    LocalSaveDataOnly = 1,
    AllLocalSave = 2,
...
enum class EPalOptionUpscalingLevel {
    Off = 0,
    Auto = 1,
    AA = 2,
    UltraQuality = 3,
...
enum class EPalOverlayUICancelActionType {
    Invalid = 0,
    CommonCancel = 1,
    Tab = 2,
    Esc = 3,
...
enum class EPalPalDisplayCategory {
    Area_A1 = 0,
    Area_A2 = 1,
    Area_A3 = 2,
    Area_A4 = 3,
...
enum class EPalPalLoadoutApplyResult {
    None = 0,
    Success = 1,
    PalBoxFull = 2,
    PalLost = 3,
...
enum class EPalPalWildlifeSanctuarySplineEventType {
    None = 0,
    Stop = 1,
    LookAround = 2,
...
enum class EPalPassiveAddTriggerType {
    None = 0,
    DayTime = 1,
    Night = 2,
    NonBattle = 4,
...
enum class EPalPassiveCategory {
    SortDisplayable = 0,
...
enum class EPalPassiveSkillEffectGroupType {
    None = 0,
    Element = 1,
    AdditionalEffect = 2,
...
enum class EPalPassiveSkillEffectTargetItemType {
    None = 0,
    Bullet = 1,
    Dish = 2,
    Ingot = 3,
...
enum class EPalPassiveSkillState {
    None = 0,
    Active = 1,
    ActivateDelay = 2,
    Inactive = 3,
...
enum class EPalPlayerBodyShape {
    Normal = 0,
    Fat = 1,
...
enum class EPalPlayerEquipLantern {
    Undefined = 0,
    Off = 1,
    Auto = 2,
    Always = 3,
...
enum class EPalPlayerMatchingType {
    None = 0,
    BossBattle = 1,
    Arena = 2,
...
enum class EPalPlayerReplicationEntityType {
    GuildChest = 0,
...
enum class EPalRaidBattleGuildCheckResult {
    Allow = 0,
...
enum class EPalRaidBossAreaPhase {
    None = 0,
    Load = 1,
    Ready = 2,
    Appearance = 3,
...
enum class EPalRaidBossAreaRequestResult {
    Success = 0,
    Failed = 1,
...
enum class EPalRaidBossBattleType {
    None = 0,
    BaseCampDefense = 1,
    RaidAreaBattle = 2,
...
enum class EPalRaidBossStoneSelectionState {
    None = 0,
    Available = 1,
...
enum class EPalRidingActiveSkillNotWeaponCondition {
    None = 0,
    WaterJump = 1,
...
enum class EPalSessionMemberChange {
    None = 0,
    Join = 1,
    Leave = 2,
    Mute = 3,
...
enum class EPalShopProductCostType {
    Invalid = 0,
    StaticItemNum = 1,
...
enum class EPalSpectateInternalState {
    STATE_None = 0,
...
enum class EPalStageRequestMessageType {
    Undefined = 0,
    Surrender = 1,
...
enum class EPalStatusDyingIndex {
    None = 0,
    InstantDeath = 1,
...
enum class EPalSyncTeleportState {
    None = 0,
    ClientFadeIn = 1,
    ClientFadeOut = 2,
    Prepare = 3,
...
enum class EPalUIBoxSortWindowType {
    PalStorage = 0,
...
enum class EPalUICommonWarningType {
    Default = 0,
    MissileWarning = 1,
    RaidWarning = 2,
...
enum class EPalUIPaldexSortType {
    PaldexNo = 0,
    CapturedCount = 1,
    ElementType = 2,
...
enum class EPalWaterEffectType {
    None = 0,
    SplashFeet = 1,
    SplashBody = 2,
    SwimMove = 3,
...
enum class EPalWazaExecuteConditionType {
    None = 0,
    HPBelow = 1,
    GroundHeightDiff = 2,
...
enum class EPalWeaponAnimationEndDelegateType {
    MontageBlendingOut = 0,
    MontageEnded = 1,
    EPalWeaponAnimationEndDelegateType_MAX = 2,
};

enum class EPalWeaponComboInputTrigger {
    None = 0,
    Pull = 1,
    Release = 2,
    Pull_Aim = 3,
...
enum class EPalWildlifeSanctuaryAlertState {
    Normal = 0,
    Detected = 1,
