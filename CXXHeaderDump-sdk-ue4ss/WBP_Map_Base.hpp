...
class UWBP_Map_Base_C : public UPalUIWorldMap
{
    ...
    TMap<FGuid, UWBP_WorldMap_IconBase_NoDesign_C*> CreatedIconMap;                   // 0x0548 (size: 0x50)
    TMap<FGuid, UWBP_Map_IconCustom_C*> CustomMarkerMap;                              // 0x0598 (size: 0x50)
    TMap<UPalLocationPoint*, FGuid> DeathMarkMap;                                     // 0x05E8 (size: 0x50)
    TArray<UWBP_Map_IconDeath_C*> DeathMarks;                                         // 0x0638 (size: 0x10)
    TArray<UWBP_Map_IconTower_C*> BossTowerIcons;                                     // 0x0648 (size: 0x10)
    TMap<FGuid, UWBP_Map_IconCustom_C*> GuildMarkerMap;                               // 0x0658 (size: 0x50)
    ...
    TArray<UWBP_Map_IconPlayer_C*> PlayerIcons;                                       // 0x06C0 (size: 0x10)
    ...
    TArray<UWBP_Map_IconBoss_C*> BossIcons;                                           // 0x0748 (size: 0x10)
    ...
    TArray<UWBP_Map_IconBoss_C*> NewVar;                                              // 0x0790 (size: 0x10)
    ...
    TMap<EPalLocationType, TSubclassOf<class UPalUIWorldMapIcon>> IconClassMap;       // 0x07B8 (size: 0x50)
    TMap<FName, UWBP_Map_Body_C*> MapBodyMap;                                         // 0x0808 (size: 0x50)
    ...
    TArray<UPalUIWorldMapIcon*> NearestRespawnPointFastTravelIcon;                    // 0x0890 (size: 0x10)
    ...
    TArray<UWBP_Map_StandAloneBossIcon_C*> StandaloneBossIcons;                       // 0x08D8 (size: 0x10)
    ...
    void RefreshDeathMark(TMap<FGuid, UPalLocationBase*> LocationMap);
