...
class UWBP_IngameFlyEff_C : public UUserWidget
{
    ...
    class UImage* Image_Line;                                                         // 0x0298 (size: 0x8)
    bool Enabled;                                                                     // 0x02A0 (size: 0x1)
    class APalCharacter* Character;                                                   // 0x02A8 (size: 0x8)
    FTimerHandle UpdateEffTimer;                                                      // 0x02B0 (size: 0x8)
    bool Visible;                                                                     // 0x02B8 (size: 0x1)
    double CachedVelocity;                                                            // 0x02C0 (size: 0x8)
