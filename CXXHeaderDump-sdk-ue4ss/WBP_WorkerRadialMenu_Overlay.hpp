...
class UWBP_WorkerRadialMenu_Overlay_C : public UPalUserWidgetOverlayUI
{
    ...
    class UWBP_WorkerRadialMenu_C* WBP_WorkerRadialMenu;                              // 0x0488 (size: 0x8)
    FName disableCrouchFlagName;                                                      // 0x0490 (size: 0x8)
    FPalDataTableRowName_UIInputAction CloseShortcutINputAction;                      // 0x0498 (size: 0x8)
    FPalDataTableRowName_UIInputAction DecideMenuAction;                              // 0x04A0 (size: 0x8)
