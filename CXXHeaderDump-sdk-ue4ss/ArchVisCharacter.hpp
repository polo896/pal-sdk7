...
{
    FRotator RotationalAcceleration;                                                  // 0x1058 (size: 0x18)
    FRotator RotationalDeceleration;                                                  // 0x1070 (size: 0x18)
    FRotator MaxRotationalVelocity;                                                   // 0x1088 (size: 0x18)
    float MinPitch;                                                                   // 0x10A0 (size: 0x4)
    float MaxPitch;                                                                   // 0x10A4 (size: 0x4)
    float WalkingFriction;                                                            // 0x10A8 (size: 0x4)
    float WalkingSpeed;                                                               // 0x10AC (size: 0x4)
    float WalkingAcceleration;                                                        // 0x10B0 (size: 0x4)
