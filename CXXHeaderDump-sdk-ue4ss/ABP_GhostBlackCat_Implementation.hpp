#ifndef UE4SS_SDK_ABP_GhostBlackCat_Implementation_HPP
#define UE4SS_SDK_ABP_GhostBlackCat_Implementation_HPP
...
class UABP_GhostBlackCat_Implementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_GhostBlackCat_Implementation(int32 EntryPoint);
}; // Size: 0x11C8
