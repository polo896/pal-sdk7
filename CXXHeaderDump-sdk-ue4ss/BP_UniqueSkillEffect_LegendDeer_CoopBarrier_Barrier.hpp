#ifndef UE4SS_SDK_BP_UniqueSkillEffect_LegendDeer_CoopBarrier_Barrier_HPP
#define UE4SS_SDK_BP_UniqueSkillEffect_LegendDeer_CoopBarrier_Barrier_HPP

class ABP_UniqueSkillEffect_LegendDeer_CoopBarrier_Barrier_C : public ABP_SkillEffectBase_C
{
    ...
    FBP_UniqueSkillEffect_LegendDeer_CoopBarrier_Barrier_COnBarrierBreak OnBarrierBreak; // 0x04B8 (size: 0x10)
    void OnBarrierBreak();
