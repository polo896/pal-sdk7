...
class ABP_PalRandomIncidentSpawner_C : public APalRandomIncidentSpawnerBase
{
    ...
    TMap<FName, FF_NPC_PathWalkArray> WalkPathList;                                   // 0x0400 (size: 0x50)
    ...
    void Create Walk Path(TArray<AActor*>& PointArray, FF_NPC_PathWalkArray& PathArray);
    void Collect Walk Path Point(class USceneComponent* SceneRoot, TArray<AActor*>& Actors);
