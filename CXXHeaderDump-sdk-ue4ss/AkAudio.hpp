...
class UAkSettings : public UObject
{
    ...
    TSoftClassPtr<UAkComponent> DefaultAkComponentClass;                              // 0x0410 (size: 0x30)
    TSubclassOf<class UAkComponent> LoadedDefaultAkComponentClass;                    // 0x0440 (size: 0x8)
...
{
    class USoundSubmix* SubmixToRecord;                                               // 0x04D8 (size: 0x8)
