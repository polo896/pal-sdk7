#ifndef UE4SS_SDK_BP_Meshes_2_HPP
#define UE4SS_SDK_BP_Meshes_2_HPP

class ABP_Meshes_2_C : public AActor
{
    class UStaticMeshComponent* StaticMesh3;                                          // 0x0290 (size: 0x8)
