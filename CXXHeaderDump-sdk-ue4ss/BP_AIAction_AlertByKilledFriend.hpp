...
class UBP_AIAction_AlertByKilledFriend_C : public UBP_AIAction_CanCombatBase_C
{
    ...
    TEnumAsByte<EPal_AI_AlertByKilledFriendState::Type> CurrentState;                 // 0x0180 (size: 0x1)
    TMap<TEnumAsByte<EPal_AI_AlertByKilledFriendState::Type>, TSubclassOf<UPalStateMachineStateBase_BlueprintBase>> StateMap; // 0x0188 (size: 0x50)
    class UPalStateMachine* StateMacine;                                              // 0x01D8 (size: 0x8)
    class AActor* DeadBody;                                                           // 0x01E0 (size: 0x8)
    FVector DeadLocation;                                                             // 0x01E8 (size: 0x18)
    class AActor* SelfActor;                                                          // 0x0200 (size: 0x8)
    double Timer;                                                                     // 0x0208 (size: 0x8)
    double tempDeltaTime;                                                             // 0x0210 (size: 0x8)
