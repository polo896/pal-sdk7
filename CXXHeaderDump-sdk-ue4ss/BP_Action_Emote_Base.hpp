...
class UBP_Action_Emote_Base_C : public UPalActionBase
{
    ...
    class UAnimMontage* EmoteAnimation;                                               // 0x0168 (size: 0x8)
    bool IsEnableInputEnd;                                                            // 0x0170 (size: 0x1)
    int32 EmoteIndex;                                                                 // 0x0174 (size: 0x4)
    bool EnableMontageSection;                                                        // 0x0178 (size: 0x1)
