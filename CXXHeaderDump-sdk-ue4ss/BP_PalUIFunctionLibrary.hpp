...
class UBP_PalUIFunctionLibrary_C : public UBlueprintFunctionLibrary
{
    ...
    void GetDamageAdditionalEffectIcon(EPalAdditionalEffectType AditionalEffect, class UObject* __WorldContext, TSoftObjectPtr<class UTexture2D>& SoftIcon);
    ...
    void GetQuestTypeIcon(EPalQuestType QuestType, class UObject* __WorldContext, TSoftObjectPtr<class UTexture2D>& IconTexture);
    ...
    void GetBlueprintItemIcon(FName StaticItemId, class UObject* __WorldContext, TSoftObjectPtr<class UTexture2D>& IconTexture);
    ...
    void GetFavoriteIcon(int32 FavoriteIndex, class UObject* __WorldContext, TSoftObjectPtr<class UTexture2D>& IconTexutre);
    void GetTeamMissionDungeonTexture(EPalMapObjectCharacterTeamMissionIconTextureType TextureType, class UObject* __WorldContext, TSoftObjectPtr<class UTexture2D>& SoftTexture);
    ...
    void GetPartnerSkillIcon(FName PalName, class UObject* __WorldContext, TSoftObjectPtr<class UTexture2D>& SoftIconTexture, bool& IsSquare);
    ...
    void GetTechnologyIcon(FName technologyName, class UObject* __WorldContext, TSoftObjectPtr<class UTexture2D>& SoftIconTexture);
    ...
    void SetupPalWazaWidget(TArray<UWBP_MainMenu_Pal_Skill_Active_C*>& wazaWidget, TArray<EPalWazaID>& WazaID, bool ShowEmptySlot, class UObject* __WorldContext);
    void Setup Pal Characteristic Widget(TArray<UWBP_MainMenu_Pal_Skill_Passive_C*>& characteristicWidget, TArray<FName>& passiveList, class UObject* __WorldContext);
    void SetupPalConditionWidget(TArray<UWBP_MainMenu_Pal_State_C*>& conditionWidget, TArray<EPalUIConditionType>& Conditions, class UObject* __WorldContext);
