...
local UWBP_DungeonInfo_FixedDungeon_C = {}
...
---@param DungeonInstanceModel UPalDungeonInstanceModel
UWBP_DungeonInfo_FixedDungeon_C['Set Dungeon Level'] = function(self, DungeonInstanceModel) end
---@param DungeonInstanceModel UPalDungeonInstanceModel
function UWBP_DungeonInfo_FixedDungeon_C:SetDungeonName(DungeonInstanceModel) end
---@param DungeonInstanceModel UPalDungeonInstanceModel
UWBP_DungeonInfo_FixedDungeon_C['Update Display Info'] = function(self, DungeonInstanceModel) end
...
UWBP_DungeonInfo_FixedDungeon_C['Setup by Stage Model'] = function(self, InStageModel) end
