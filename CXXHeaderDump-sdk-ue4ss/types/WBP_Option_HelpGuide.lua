...
---@field InGameMenu boolean
local UWBP_Option_HelpGuide_C = {}

---@return UWidget
function UWBP_Option_HelpGuide_C:BP_GetDesiredFocusTarget() end
---@param NoteTitle FName
UWBP_Option_HelpGuide_C['Change Note Content'] = function(self, NoteTitle) end
---@param NoteTitle FName
...
function UWBP_Option_HelpGuide_C:Destruct() end
