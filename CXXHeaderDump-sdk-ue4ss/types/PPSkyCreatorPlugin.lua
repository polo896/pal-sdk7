...
---@field bUseVolumetricCloud boolean
...
---@field Azimuth float
local FPPCelestialPositionData = {}
...
local FPPSkyCreatorBackgroundCloudSettings = {}
...
local FPPSkyCreatorExponentialHeightFogSettings = {}
...
local FPPSkyCreatorLightningParameters = {}
...
local FPPSkyCreatorMoonLightSettings = {}
...
local FPPSkyCreatorPostProcessSettings = {}
...
local FPPSkyCreatorSkyAtmosphereSettings = {}
...
local FPPSkyCreatorSkyLightSettings = {}
...
local FPPSkyCreatorStarMapSettings = {}
...
---@field CloudShadowOnAtmosphereStrength float
---@field CloudShadowOnSurfaceStrength float
local FPPSkyCreatorSunLightSettings = {}
...
local FPPSkyCreatorVolumetricCloudSettings = {}
...
local FPPSkyCreatorWeatherFXSettings = {}
...
local FPPSkyCreatorWeatherMaterialFXSettings = {}
...
local FPPSkyCreatorWeatherSettings = {}
...
local FPPSkyCreatorWindSettings = {}



---@class UPPSkyCreatorFunctionLibrary : UBlueprintFunctionLibrary
local UPPSkyCreatorFunctionLibrary = {}
...
---@field WindSettings FPPSkyCreatorWindSettings
---@field PostProcessSettings FPPSkyCreatorPostProcessSettings
local UPPSkyCreatorWeatherPreset = {}
