...
function UBP_PalAudioWorldSubsystem_C:OnArenaSequenceChanged(Sequencer, PrevType, AfterType) end
---@param bIsDisable boolean
function UBP_PalAudioWorldSubsystem_C:SetDsiableBattleBGM(bIsDisable) end
---@param Rank EPalBattleBGMType
UBP_PalAudioWorldSubsystem_C['On Change Battle BGM'] = function(self, Rank) end
function UBP_PalAudioWorldSubsystem_C:OnArenaSequenceEnd() end
---@param ArenaSequencer UPalArenaSequencer
function UBP_PalAudioWorldSubsystem_C:OnArenaSequenceStart(ArenaSequencer) end
