...
local UWBP_CharaCre_MenuButton_C = {}
...
function UWBP_CharaCre_MenuButton_C:AnmEvent_Reset() end
function UWBP_CharaCre_MenuButton_C:Construct() end
...
function UWBP_CharaCre_MenuButton_C:Destruct() end
