...
local UWBP_PalWorkPowerPlant_C = {}

---@return UWidgetAnimation
function UWBP_PalWorkPowerPlant_C:GetAnimationDetailToSimple() end
function UWBP_PalWorkPowerPlant_C:SetupForMapObjectConcreteModel() end
...
UWBP_PalWorkPowerPlant_C['On Updated Worker Pal'] = function(self, Work) end
