...
local ABP_MonsterAIController_BaseCamp_C = {}

---@return TSubclassOf<UPalAIControllerWorkerModule>
function ABP_MonsterAIController_BaseCamp_C:GetWorkerModuleClass() end
---@return UPalAIActionBaseCampResurrect
function ABP_MonsterAIController_BaseCamp_C:SetBaseCampActionResurrect() end
...
ABP_MonsterAIController_BaseCamp_C['OnDeadDelegate_イベント_0'] = function(self, DeadInfo) end
---@param Parameter FPalMonsterControllerBaseCampHungryParameter
