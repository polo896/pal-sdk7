...
local FPocketpairInventoryItem = {}
...
local FPocketpairPlatformID = {}



---@class FPocketpairTelemetry
local FPocketpairTelemetry = {}


---@class FPocketpairTelemetry_Stat
local FPocketpairTelemetry_Stat = {}
...
local UCreateSessionAsyncFunction = {}
...
---@param IsCrossPlay boolean
---@return UCreateSessionAsyncFunction
function UCreateSessionAsyncFunction:CreateSessionAsyncFunction(Target, IsDedicatedServer, PublicConnections, InviteCode, ServerName, Desc, ServerAddress, ServerPort, IsPassword, Version, ServerType, Region, Namespace, IsCrossPlay) end


---@class UFindSessionsAsyncFunction : UBlueprintAsyncActionBase
---@field Completed FFindSessionsAsyncFunctionCompleted
local UFindSessionsAsyncFunction = {}
...
local UGDKActivityAsyncFunction = {}

---@param Target UPocketpairUserSubsystem
---@param ConnectionString FString
---@param MaxPlayerNum int32
---@param CurrentPlayerNum int32
---@param bPublicSession boolean
---@return UGDKActivityAsyncFunction
function UGDKActivityAsyncFunction:GDKActivityAsyncFunction(Target, ConnectionString, MaxPlayerNum, CurrentPlayerNum, bPublicSession) end


---@class UGDKInviteAsyncFunction : UBlueprintAsyncActionBase
---@field Completed FGDKInviteAsyncFunctionCompleted
local UGDKInviteAsyncFunction = {}
...
---@class UGDKPrivacyPermissionAsyncFunction : UBlueprintAsyncActionBase
---@field Completed FGDKPrivacyPermissionAsyncFunctionCompleted
local UGDKPrivacyPermissionAsyncFunction = {}



---@class UGDKPrivacyPermissionForAnonymousUserAsyncFunction : UBlueprintAsyncActionBase
---@field Completed FGDKPrivacyPermissionForAnonymousUserAsyncFunctionCompleted
local UGDKPrivacyPermissionForAnonymousUserAsyncFunction = {}



---@class UGDKPrivilegeAsyncFunction : UBlueprintAsyncActionBase
---@field Completed FGDKPrivilegeAsyncFunctionCompleted
local UGDKPrivilegeAsyncFunction = {}



---@class UHTTPRequestAsyncFunction : UBlueprintAsyncActionBase
---@field Completed FHTTPRequestAsyncFunctionCompleted
local UHTTPRequestAsyncFunction = {}
...
local UJoinSessionAsyncFunction = {}
...
local ULoginDefaultOnlineSubsystemAsyncFunction = {}
...
---@class UPocketpairConnectServerFunction : UBlueprintAsyncActionBase
---@field Completed FPocketpairConnectServerFunctionCompleted
---@field Subsystem UPocketpairUserSubsystem
local UPocketpairConnectServerFunction = {}

---@param Target UPocketpairUserSubsystem
---@param Address FString
---@param Port int32
---@param AdminPassword FString
---@param ServerPassword FString
---@param WorldGUID FString
---@return UPocketpairConnectServerFunction
function UPocketpairConnectServerFunction:ConnectServer(Target, Address, Port, AdminPassword, ServerPassword, WorldGUID) end


---@class UPocketpairFriend : UObject
---@field DisplayName FString
local UPocketpairFriend = {}
...
local UPocketpairUserSubsystem = {}
...
---@return boolean
function UPocketpairUserSubsystem:IsEOSConnectTrouble() end
---@return FString
...
---@return boolean
function UPocketpairUserSubsystem:CheckEOSLoginStatus() end
---@param Address FString
---@param Ping int32
...
local USanitizeDisplayNameAsyncFunction = {}
...
local USwitchUserUIDefaultOnlineSubsystemAsyncFunction = {}
