...
local ABP_SkillEffect_StoneShotgun_C = {}
...
ABP_SkillEffect_StoneShotgun_C['OnAttackDelegate_イベント_0'] = function(self, Defencer, DamageInfo, HitCount, AttackerComponent) end
