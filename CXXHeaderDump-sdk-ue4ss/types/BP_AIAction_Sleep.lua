...
local UBP_AIAction_Sleep_C = {}

---@param DamageResult FPalDamageResult
UBP_AIAction_Sleep_C['OnDamageDelegate_イベント_0'] = function(self, DamageResult) end
---@param ControlledPawn APawn
function UBP_AIAction_Sleep_C:ActionStart(ControlledPawn) end
---@param ActionComponent UPalActionComponent
UBP_AIAction_Sleep_C['OnAllActionFinishDelegate_イベント_0'] = function(self, ActionComponent) end
---@param ControlledPawn APawn
