...
---@field NewVar int32
---@field bSkipSpawnOtomoForPalLoadoutSlotUpdate boolean
local UBP_OtomoPalHolderComponent_C = {}

---@param OtomoHandle UPalIndividualCharacterHandle
---@param Location FVector
---@param Rotation FRotator
---@param bKeepActigvateOtomoId boolean
function UBP_OtomoPalHolderComponent_C:ActivatePalByHandle(OtomoHandle, Location, Rotation, bKeepActigvateOtomoId) end
...
UBP_OtomoPalHolderComponent_C['Update Reserve Pal Location'] = function(self, DeltaTime) end
...
UBP_OtomoPalHolderComponent_C['Dummy Despawn Callback'] = function(self, ID) end
---@param Otomo APalCharacter
UBP_OtomoPalHolderComponent_C['Try Get Current Active Pal Actor'] = function(self, Otomo) end
---@param Target AActor
...
UBP_OtomoPalHolderComponent_C['Update Otomo Slot in Local'] = function(self, SlotIndex, LastHandle) end
---@param SlotIndex int32
---@param LastHandle UPalIndividualCharacterHandle
UBP_OtomoPalHolderComponent_C['Update Otomo Slot In Server'] = function(self, SlotIndex, LastHandle) end
---@param IndividualHandle UPalIndividualCharacterHandle
---@param IsDelayAddReserver boolean
---@param IsSuccess boolean
UBP_OtomoPalHolderComponent_C['Inactivate Otomo By Handle'] = function(self, IndividualHandle, IsDelayAddReserver, IsSuccess) end
---@param IsSuccess boolean
UBP_OtomoPalHolderComponent_C['Inactivate Otomo'] = function(self, IsSuccess) end
---@param SlotId int32
...
UBP_OtomoPalHolderComponent_C['Add Otomo Down Log'] = function(self, Actor) end
---@param ID FPalInstanceID
---@param SlotId int32
function UBP_OtomoPalHolderComponent_C:FindSlotByIndividualID(ID, SlotId) end
---@param ID FPalInstanceID
UBP_OtomoPalHolderComponent_C['Spawn Character Callback'] = function(self, ID) end
---@param SlotId int32
