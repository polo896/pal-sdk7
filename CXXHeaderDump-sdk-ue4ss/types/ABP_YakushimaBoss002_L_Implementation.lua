...
---@class UABP_YakushimaBoss002_L_Implementation_C : UPalAnimInstance
...
local UABP_YakushimaBoss002_L_Implementation_C = {}

---@param DefaultPose FPoseLink
---@param AimRotator FRotator
---@param AimingOverride FPoseLink
function UABP_YakushimaBoss002_L_Implementation_C:AimingOverride(DefaultPose, AimRotator, AimingOverride) end
---@param InPose FPoseLink
---@param LookAtWorldLocation FVector
---@param LookAtOverride FPoseLink
function UABP_YakushimaBoss002_L_Implementation_C:LookAtOverride(InPose, LookAtWorldLocation, LookAtOverride) end
---@param NativePose FPoseLink
---@param ActionPose FPoseLink
---@param UpperOverride FPoseLink
function UABP_YakushimaBoss002_L_Implementation_C:UpperOverride(NativePose, ActionPose, UpperOverride) end
---@param PrePose FPoseLink
---@param CustomData FPalCustomAnimOverrideData
---@param CustomOverride FPoseLink
function UABP_YakushimaBoss002_L_Implementation_C:CustomOverride(PrePose, CustomData, CustomOverride) end
---@param AnimGraph FPoseLink
function UABP_YakushimaBoss002_L_Implementation_C:AnimGraph(AnimGraph) end
function UABP_YakushimaBoss002_L_Implementation_C:EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_YakushimaBoss002_L_Implementation_AnimGraphNode_ModifyBone_748ED46F47F20C68A42722BF59F9830A() end
function UABP_YakushimaBoss002_L_Implementation_C:EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_YakushimaBoss002_L_Implementation_AnimGraphNode_ModifyBone_8601F0A74047BB419045A4939BA3D426() end
---@param DeltaTimeX float
function UABP_YakushimaBoss002_L_Implementation_C:BlueprintUpdateAnimation(DeltaTimeX) end
---@param EntryPoint int32
function UABP_YakushimaBoss002_L_Implementation_C:ExecuteUbergraph_ABP_YakushimaBoss002_L_Implementation(EntryPoint) end
