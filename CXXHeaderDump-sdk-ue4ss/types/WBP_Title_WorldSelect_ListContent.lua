...
local UWBP_Title_WorldSelect_ListContent_C = {}
...
UWBP_Title_WorldSelect_ListContent_C['Setup By Local World Display Data'] = function(self, SaveDirectoryName, DisplayData) end
