...
function UWBP_RepairEquipment_C:EndRepair(IsSuccess) end
function UWBP_RepairEquipment_C:StartRepair() end
function UWBP_RepairEquipment_C:Setup() end
function UWBP_RepairEquipment_C:RefreshRepairable() end
...
function UWBP_RepairEquipment_C:CloseAction() end
function UWBP_RepairEquipment_C:RepairShortcut() end
