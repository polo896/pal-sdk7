...
---@field CryNPCId FPalDataTableRowName_PalHumanData
local UBP_PalCryComponent_C = {}

---@param EmoState FName
function UBP_PalCryComponent_C:OnReceivedPlayCry(EmoState) end
...
function UBP_PalCryComponent_C:PlayCry(EmoState, CoolTime) end
...
---@param EmoState FName
---@param InExternalCT float
function UBP_PalCryComponent_C:OnReceivedPlayCryWithCT(EmoState, InExternalCT) end
