...
---@field OnAddStatus FWBP_PalCharacterSlotBase_COnAddStatus
---@field OnRemoveStatus FWBP_PalCharacterSlotBase_COnRemoveStatus
---@field TargetSaveParam FPalIndividualCharacterSaveParameter
---@field OnUpdateAwakening FWBP_PalCharacterSlotBase_COnUpdateAwakening
---@field CurrentBoundParameter UPalIndividualCharacterParameter
---@field CurrentBoundActor APalCharacter
local UWBP_PalCharacterSlotBase_C = {}

---@param NowReviveTimer float
---@param ReviveSpeedMultiplier float
function UWBP_PalCharacterSlotBase_C:CREATEDELEGATE_PROXYFUNCTION_0(NowReviveTimer, ReviveSpeedMultiplier) end
---@param SaveParam FPalIndividualCharacterSaveParameter
function UWBP_PalCharacterSlotBase_C:SetupBySaveParameter(SaveParam) end
---@param StatusComponent UPalStatusComponent
---@param statusID EPalStatusID
function UWBP_PalCharacterSlotBase_C:OnRemovStatus_Internal(StatusComponent, statusID) end
---@param StatusComponent UPalStatusComponent
---@param statusID EPalStatusID
---@param Status UPalStatusBase
function UWBP_PalCharacterSlotBase_C:OnAddStatus_Internal(StatusComponent, statusID, Status) end
---@param CharacterID FName
function UWBP_PalCharacterSlotBase_C:SetupByCharacterID(CharacterID) end
---@param Parameter UPalIndividualCharacterParameter
function UWBP_PalCharacterSlotBase_C:OnReplicatedParameter(Parameter) end
function UWBP_PalCharacterSlotBase_C:OnChangedAssingToExpedition_Internal() end
---@param NewIndex int32
function UWBP_PalCharacterSlotBase_C:OnUpdateFavorite_Internal(NewIndex) end
...
UWBP_PalCharacterSlotBase_C['On Update Revive Timer Internal'] = function(self, NowReviveTimer, ReviveSpeedMultiplier) end
---@param InstanceId FPalInstanceID
UWBP_PalCharacterSlotBase_C['On Sync Individual Parameter'] = function(self, InstanceId) end
---@param Handle UPalIndividualCharacterHandle
...
---@param Handle UPalIndividualCharacterHandle
UWBP_PalCharacterSlotBase_C['Unbind Parameter Event'] = function(self, Handle) end
---@param Handle UPalIndividualCharacterHandle
UWBP_PalCharacterSlotBase_C['Bind Parameter Event'] = function(self, Handle) end
function UWBP_PalCharacterSlotBase_C:CheckTargetCondition() end
---@param nowHP FFixedPoint64
---@param nowMaxHP FFixedPoint64
UWBP_PalCharacterSlotBase_C['On Update HP'] = function(self, nowHP, nowMaxHP) end
...
function UWBP_PalCharacterSlotBase_C:OnUpdateAwakening__DelegateSignature(bAwaked) end
---@param StatusComponent UPalStatusComponent
---@param statusID EPalStatusID
function UWBP_PalCharacterSlotBase_C:OnRemoveStatus__DelegateSignature(StatusComponent, statusID) end
---@param StatusComponent UPalStatusComponent
---@param statusID EPalStatusID
---@param StatusBase UPalStatusBase
function UWBP_PalCharacterSlotBase_C:OnAddStatus__DelegateSignature(StatusComponent, statusID, StatusBase) end
...
---@param NewIndex int32
function UWBP_PalCharacterSlotBase_C:OnFavoriteUpdated__DelegateSignature(NewIndex) end
---@param WorkId FGuid
...
---@param ReviveSpeedMultiplier double
function UWBP_PalCharacterSlotBase_C:OnUpdateReviveTimer__DelegateSignature(NowTimer, ReviveSpeedMultiplier) end
