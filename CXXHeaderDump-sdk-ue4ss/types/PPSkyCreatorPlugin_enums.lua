...
local EPPSkyCreatorEditorWeatherType = {
...
local EPPSkyCreatorMoonPositionType = {
...
local EPPSkyCreatorStarMapRotationType = {
...
local EPPSkyCreatorSunPositionType = {
...
local EPPVolumetricCloudNoiseDetailResolution = {
...
local EPPVolumetricCloudNoiseShapeResolution = {
...
local EPPVolumetricCloudRenderTargetMode = {
