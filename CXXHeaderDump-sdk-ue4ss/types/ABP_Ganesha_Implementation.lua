...
---@class UABP_Ganesha_Implementation_C : UAnimInstance
...
local UABP_Ganesha_Implementation_C = {}

---@param NativePose FPoseLink
---@param ActionPose FPoseLink
---@param UpperOverride FPoseLink
function UABP_Ganesha_Implementation_C:UpperOverride(NativePose, ActionPose, UpperOverride) end
---@param DefaultPose FPoseLink
---@param AimRotator FRotator
---@param AimingOverride FPoseLink
function UABP_Ganesha_Implementation_C:AimingOverride(DefaultPose, AimRotator, AimingOverride) end
---@param InPose FPoseLink
---@param LookAtWorldLocation FVector
---@param LookAtOverride FPoseLink
function UABP_Ganesha_Implementation_C:LookAtOverride(InPose, LookAtWorldLocation, LookAtOverride) end
---@param AnimGraph FPoseLink
function UABP_Ganesha_Implementation_C:AnimGraph(AnimGraph) end
---@param EntryPoint int32
function UABP_Ganesha_Implementation_C:ExecuteUbergraph_ABP_Ganesha_Implementation(EntryPoint) end
