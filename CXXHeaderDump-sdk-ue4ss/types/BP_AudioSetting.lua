...
---@field DelaySettingAudioSwitchTimerHandle FTimerHandle
---@field CachedAudioSettings FPalOptionAudioSettings
---@field CachedWorldContextObject TSoftObjectPtr<UObject>
local UBP_AudioSetting_C = {}

---@param WorldContextObject UObject
---@param AudioSettings FPalOptionAudioSettings
function UBP_AudioSetting_C:UpdateAudioSwitchInternal(WorldContextObject, AudioSettings) end
function UBP_AudioSetting_C:DelaySetupAudioSwitch_Timer() end
---@param WorldContextObject UObject
---@param NewAudioSettings FPalOptionAudioSettings
function UBP_AudioSetting_C:UpdateAudioSwitch(WorldContextObject, NewAudioSettings) end
...
---@param Key FName
---@param Volume double
UBP_AudioSetting_C['Set Audio Bus Volume Impl'] = function(self, AudioBus, Key, Volume) end
---@param AudioBus EPalAudioBus
