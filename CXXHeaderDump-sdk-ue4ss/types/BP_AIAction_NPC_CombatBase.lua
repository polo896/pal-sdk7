...
---@field Const_StackTime double
local UBP_AIAction_NPC_CombatBase_C = {}

---@param InDeltaTime double
---@param Stack boolean
UBP_AIAction_NPC_CombatBase_C['Check Stack'] = function(self, InDeltaTime, Stack) end
...
---@param Alive boolean
UBP_AIAction_NPC_CombatBase_C['Is Alive Target Actor'] = function(self, Alive) end
---@param IsEnd boolean
