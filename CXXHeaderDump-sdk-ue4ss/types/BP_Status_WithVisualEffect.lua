...
---@field RequestHideEffect boolean
local UBP_Status_WithVisualEffect_C = {}

function UBP_Status_WithVisualEffect_C:HideReAddEffectWhenInActiveOtomo() end
---@param AddEffect EPalAdditionalEffectType
---@param Ignore boolean
function UBP_Status_WithVisualEffect_C:IsIgnoreElement(AddEffect, Ignore) end
function UBP_Status_WithVisualEffect_C:HideReAddEffect() end
...
UBP_Status_WithVisualEffect_C['カスタムイベント_OtherStatusAdd'] = function(self, StatusComponent, statusID, Status) end
---@param DeadInfo FPalDeadInfo
UBP_Status_WithVisualEffect_C['カスタムイベント_Dead'] = function(self, DeadInfo) end
