...
---@class UWBP_IngameMenuConstruction_info_OLD_C : UUserWidget
...
local UWBP_IngameMenuConstruction_info_OLD_C = {}

---@param ItemId FName
---@param Num int32
UWBP_IngameMenuConstruction_info_OLD_C['Get Useable Material Item Num'] = function(self, ItemId, Num) end
---@param Widget UWBP_IngameMenuConstruction_InfoItem_C
---@param ID FName
---@param NeedNum int32
function UWBP_IngameMenuConstruction_info_OLD_C:SetMaterialInfo(Widget, ID, NeedNum) end
---@param BuildObjectData FPalBuildObjectData
UWBP_IngameMenuConstruction_info_OLD_C['Set Build Object Data'] = function(self, BuildObjectData) end
