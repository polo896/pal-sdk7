...
---@field Scale double
---@field DefaultEggMeshScale FVector
---@field DefaultBasketMeshScale FVector
local ABP_MapObject_PickupItem_PalEgg_Base_C = {}
...
function ABP_MapObject_PickupItem_PalEgg_Base_C:UserConstructionScript() end
