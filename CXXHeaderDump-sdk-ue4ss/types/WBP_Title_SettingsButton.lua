...
---@field OnHovered FWBP_Title_SettingsButton_COnHovered
local UWBP_Title_SettingsButton_C = {}
...
function UWBP_Title_SettingsButton_C:OnHovered__DelegateSignature(Widget) end
