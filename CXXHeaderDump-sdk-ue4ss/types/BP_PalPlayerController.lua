...
---@field BP_PalNightVisionComponent UBP_PalNightVisionComponent_C
...
---@field CurrentExposure double
---@field bDay boolean
---@field DayCap double
---@field TargetGate double
---@field TimeOfDay float
---@field BaseGate double
---@field DayGate double
---@field NightGate double
---@field TransitionWidth double
---@field DungeonGate double
---@field LastUpdateRealTime double
---@field UpdateInterval double
---@field Elapsed double
---@field LiftMultiplier float
---@field CallRidePalAnim UAnimMontage
local ABP_PalPlayerController_C = {}

---@param Montage UAnimMontage
---@param bInterrupted boolean
function ABP_PalPlayerController_C:OnWhistleMontageEnded(Montage, bInterrupted) end
function ABP_PalPlayerController_C:TryPlayWhistleMontage() end
---@param Axis EPalStepAxisType
---@param Direction FVector2D
function ABP_PalPlayerController_C:PlayAirDashAction(Axis, Direction) end
...
---@param Move FVector
ABP_PalPlayerController_C['Warp Spectator'] = function(self, Move) end
---@param Rate double
...
---@param Axis EPalStepAxisType
---@param DashDirection FVector2D
function ABP_PalPlayerController_C:DoAirDash(Axis, DashDirection) end
function ABP_PalPlayerController_C:MeasureBrightness() end
