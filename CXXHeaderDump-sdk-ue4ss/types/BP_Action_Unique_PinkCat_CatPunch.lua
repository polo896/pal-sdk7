...
---@field TimerHandle1 FTimerHandle
---@field TimerHandle2 FTimerHandle
local UBP_Action_Unique_PinkCat_CatPunch_C = {}

---@param EnableMove boolean
function UBP_Action_Unique_PinkCat_CatPunch_C:SetMove(EnableMove) end
...
UBP_Action_Unique_PinkCat_CatPunch_C['Get Target Rotation'] = function(self, TargetRotation) end
...
UBP_Action_Unique_PinkCat_CatPunch_C['カスタムイベント_0'] = function(self, ) end
