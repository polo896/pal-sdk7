...
local ABP_MonsterAIController_Invader_C = {}
...
ABP_MonsterAIController_Invader_C['カスタムイベント_1'] = function(self, InCharacter) end
---@param DeadInfo FPalDeadInfo
ABP_MonsterAIController_Invader_C['カスタムイベント_OnDead'] = function(self, DeadInfo) end
...
function ABP_MonsterAIController_Invader_C:ReceiveBeginPlay() end
---@param DeltaSeconds float
function ABP_MonsterAIController_Invader_C:ReceiveTick(DeltaSeconds) end
