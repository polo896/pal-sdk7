...
---@field ShouldBossLocationNoAdjust boolean
---@field flagName FName
---@field BossAIControllerCache TSubclassOf<AAIController>
local ABP_BossBattle_BossCharacterSpawner_C = {}

---@param InCharacter APalCharacter
function ABP_BossBattle_BossCharacterSpawner_C:OnInitializeParameter(InCharacter) end
---@param BitFlag int32
...
ABP_BossBattle_BossCharacterSpawner_C['Request Other Spawn'] = function(self, CharacterID, Level, AIController, IsOutAreaSpawn, IsOverrideRotation, Rotation) end
...
---@param CharacterID FName
---@param Level int32
---@param AIController TSubclassOf<AAIController>
function ABP_BossBattle_BossCharacterSpawner_C:RequestBossSpawn(CharacterID, Level, AIController) end
