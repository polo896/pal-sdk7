...
UWBP_WorldSetting_C['On Closed Start Game Dialog'] = function(self, bResult) end
UWBP_WorldSetting_C['Open Start Game Check Dialog'] = function(self, ) end
...
function UWBP_WorldSetting_C:OnFilteredWorldName(NewWorldName) end
function UWBP_WorldSetting_C:BndEvt__WBP_WorldSetting_WBP_Title_WorldSettings_K2Node_ComponentBoundEvent_3_OnClickedRandomizerSeedInputButton__DelegateSignature() end
