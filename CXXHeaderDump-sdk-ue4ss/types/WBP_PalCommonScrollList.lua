...
---@field bEnableRightStickScroll boolean
local UWBP_PalCommonScrollList_C = {}

---@param bEnableMouseWheel boolean
function UWBP_PalCommonScrollList_C:SetEnableMouseWheelScroll(bEnableMouseWheel) end
