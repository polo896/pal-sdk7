...
local UWBP_Reticle_Pal_C = {}

---@param throwableData FPalUIAimReticleMapObjectThrowableData
function UWBP_Reticle_Pal_C:SetThrowableableDetail(throwableData) end
---@param TargetIndividualParameter UPalIndividualCharacterParameter
function UWBP_Reticle_Pal_C:SetOtomoDeadDetail(TargetIndividualParameter) end
