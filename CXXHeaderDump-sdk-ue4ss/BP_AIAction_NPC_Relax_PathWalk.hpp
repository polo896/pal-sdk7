...
class UBP_AIAction_NPC_Relax_PathWalk_C : public UBP_AIAction_NPC_RelaxBase_C
{
    ...
    class ABP_NPC_WalkPathPoint_1_C* Path;                                            // 0x0228 (size: 0x8)
    int32 CurrentPointIndex;                                                          // 0x0230 (size: 0x4)
    FVector TargetPoint;                                                              // 0x0238 (size: 0x18)
    bool WaitMode;                                                                    // 0x0250 (size: 0x1)
    class UPalActionBase* WaitAction;                                                 // 0x0258 (size: 0x8)
    FF_NPC_PathWalkArray PathArray;                                                   // 0x0260 (size: 0x10)
    FVector PrevLocation;                                                             // 0x0270 (size: 0x18)
    double StuckTime;                                                                 // 0x0288 (size: 0x8)
    double DeltaTime;                                                                 // 0x0290 (size: 0x8)
    bool IsAlreadyStuck;                                                              // 0x0298 (size: 0x1)
