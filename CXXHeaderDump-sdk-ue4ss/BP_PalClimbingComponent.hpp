...
class UBP_PalClimbingComponent_C : public UPalClimbingComponent
{
    ...
    bool IsClimbing;                                                                  // 0x00B8 (size: 0x1)
    FVector PrevClimbDirection;                                                       // 0x00C0 (size: 0x18)
    bool CanClimbing;                                                                 // 0x00D8 (size: 0x1)
    TEnumAsByte<ETraceTypeQuery> Const_RayChannel;                                    // 0x00D9 (size: 0x1)
    FName flagName;                                                                   // 0x00DC (size: 0x8)
    double DownRayCancelTimer;                                                        // 0x00E8 (size: 0x8)
    TEnumAsByte<EDrawDebugTrace::Type> DebugType;                                     // 0x00F0 (size: 0x1)
    bool TraceComplex;                                                                // 0x00F1 (size: 0x1)
    double Const_ForwardRayLength;                                                    // 0x00F8 (size: 0x8)
    double Const_UpRayLength;                                                         // 0x0100 (size: 0x8)
    double Const_RightRayLength;                                                      // 0x0108 (size: 0x8)
    double Const_OffsetBack;                                                          // 0x0110 (size: 0x8)
    bool UpAtTopMode;                                                                 // 0x0118 (size: 0x1)
    class UCurveVector* UpToTopMoveCurve;                                             // 0x0120 (size: 0x8)
    double UpToTopTimer;                                                              // 0x0128 (size: 0x8)
    FVector UpToTopFromPlayer;                                                        // 0x0130 (size: 0x18)
    FVector UpToTopStartPos;                                                          // 0x0148 (size: 0x18)
    bool IsEnding;                                                                    // 0x0160 (size: 0x1)
