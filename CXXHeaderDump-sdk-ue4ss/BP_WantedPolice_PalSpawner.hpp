...
class ABP_WantedPolice_PalSpawner_C : public APalNPCSpawnerBase
{
    ...
    class UPalIndividualCharacterHandle* DespawnHandle;                               // 0x0560 (size: 0x8)
    TArray<FVector> SpawnLocations;                                                   // 0x0568 (size: 0x10)
    int32 SpawnIndex;                                                                 // 0x0578 (size: 0x4)
    int32 UseIndex;                                                                   // 0x057C (size: 0x4)
    TSubclassOf<class APalAIController> ControllerClass;                              // 0x0580 (size: 0x8)
    TSubclassOf<class UPalAIActionBase> DefaultActionClass;                           // 0x0588 (size: 0x8)
    class UBP_WorldSecurityPoliceSpawner_C* PoliceSpawnerModel;                       // 0x0590 (size: 0x8)
    TArray<class UPalIndividualCharacterHandle*> OwnedHandles;                        // 0x0598 (size: 0x10)
