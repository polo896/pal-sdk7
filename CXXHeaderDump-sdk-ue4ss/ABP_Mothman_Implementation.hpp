#ifndef UE4SS_SDK_ABP_Mothman_Implementation_HPP
#define UE4SS_SDK_ABP_Mothman_Implementation_HPP
...
class UABP_Mothman_Implementation_C : public UPalAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_Mothman_Implementation(int32 EntryPoint);
}; // Size: 0x11C8
