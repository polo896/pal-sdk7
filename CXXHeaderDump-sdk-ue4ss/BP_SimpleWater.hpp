...
class ABP_SimpleWater_C : public AActor
{
    ...
    class UBoxComponent* SwimmingVolume;                                              // 0x02A0 (size: 0x8)
    class UHierarchicalInstancedStaticMeshComponent* HierarchicalInstancedStaticMesh; // 0x02A8 (size: 0x8)
    int32 TileCount;                                                                  // 0x02B0 (size: 0x4)
    double MeshScaleOffset;                                                           // 0x02B8 (size: 0x8)
    class UStaticMesh* WaterPlaneMesh;                                                // 0x02C0 (size: 0x8)
    class UMaterialInterface* WaterMaterial;                                          // 0x02C8 (size: 0x8)
    FVector OceanMin;                                                                 // 0x02D0 (size: 0x18)
    FVector OceanMax;                                                                 // 0x02E8 (size: 0x18)
    FVector SwimVolumeScale;                                                          // 0x0300 (size: 0x18)
    FVector SwimVolumeLocation;                                                       // 0x0318 (size: 0x18)
    double Depth;                                                                     // 0x0330 (size: 0x8)
    bool bWorldOceanPlane;                                                            // 0x0338 (size: 0x1)
    double FixScaleFloatingPointError;                                                // 0x0340 (size: 0x8)
