...
class UWBP_PalStatusPopup_C : public UPalUserWidgetOverlayUI
{
    ...
    class UWBP_MainMenu_bg_C* WBP_MainMenu_bg;                                        // 0x0488 (size: 0x8)
    class UWBP_Menu_btn_C* WBP_Menu_btn;                                              // 0x0490 (size: 0x8)
    class UWBP_PalStatus_C* WBP_PalStatus;                                            // 0x0498 (size: 0x8)
    class UBP_InGamePalStatusModel_C* StatusModel;                                    // 0x04A0 (size: 0x8)
    FDataTableRowHandle BackGroundTextID;                                             // 0x04A8 (size: 0x10)
