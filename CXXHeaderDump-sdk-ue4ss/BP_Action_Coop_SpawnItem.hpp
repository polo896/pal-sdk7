...
class UBP_Action_Coop_SpawnItem_C : public UPalActionBase
{
    ...
    class UAnimInstance* AnimInst;                                                    // 0x0168 (size: 0x8)
    class APalCharacter* ActionCharacter;                                             // 0x0170 (size: 0x8)
    class UAnimMontage* ChargeMontage;                                                // 0x0178 (size: 0x8)
    bool IsFnishByAbortMontage;                                                       // 0x0180 (size: 0x1)
    class UPalFacialComponent* Facial;                                                // 0x0188 (size: 0x8)
    EPalFacialEyeType ChargeFacialEye;                                                // 0x0190 (size: 0x1)
    FTimerHandle ChargeTimer;                                                         // 0x0198 (size: 0x8)
    class UAnimMontage* FunMontage;                                                   // 0x01A0 (size: 0x8)
    EPalFacialEyeType FunFacialEye;                                                   // 0x01A8 (size: 0x1)
