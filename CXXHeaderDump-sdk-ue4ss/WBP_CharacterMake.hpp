...
class UWBP_CharacterMake_C : public UPalUICharacterMakeBase
{
    ...
    class UWBP_CharaCre_C* WBP_CharaCre;                                              // 0x0490 (size: 0x8)
    class UWBP_CharaCre_BG_C* WBP_CharaCre_BG;                                        // 0x0498 (size: 0x8)
    class UWBP_PalKeyGuideIcon_C* WBP_PalKeyGuideIcon;                                // 0x04A0 (size: 0x8)
    class UWBP_PalKeyGuideIcon_C* WBP_PalKeyGuideIcon_1;                              // 0x04A8 (size: 0x8)
    class UWBP_PalKeyGuideIcon_C* WBP_PalKeyGuideIcon_2;                              // 0x04B0 (size: 0x8)
    class UWBP_PalKeyGuideIcon_C* WBP_PalKeyGuideIcon_3;                              // 0x04B8 (size: 0x8)
    class UWBP_PalPlayerInframeRender_C* WBP_PalPlayerInframeRender;                  // 0x04C0 (size: 0x8)
    FPalDataTableRowName_UIInputAction MouseZoomInInputAction;                        // 0x04C8 (size: 0x8)
    FPalDataTableRowName_UIInputAction MouseZoomOutInputAction;                       // 0x04D0 (size: 0x8)
    FPalPlayerDataCharacterMakeInfo MakeInfo;                                         // 0x04D8 (size: 0x208)
    TEnumAsByte<E_UICharacterMakeCategory::Type> NowDisplayCategory;                  // 0x06E0 (size: 0x1)
    FPalDataTableRowName_UIInputAction DecideInputAction;                             // 0x06E4 (size: 0x8)
    FPalDataTableRowName_UIInputAction RandomizeInputAction;                          // 0x06EC (size: 0x8)
    FPalDataTableRowName_UIInputAction PrevCategoryInputAction;                       // 0x06F4 (size: 0x8)
    FPalDataTableRowName_UIInputAction NextCategoryInputAction;                       // 0x06FC (size: 0x8)
    TEnumAsByte<E_UICharacterMakeCategory::Type> LastActivatedCategory;               // 0x0704 (size: 0x1)
    double SVMax;                                                                     // 0x0708 (size: 0x8)
    class UPalHUDDispatchParameter_CharacterMake* DispaltchParameter;                 // 0x0710 (size: 0x8)
    FText CachedPlayerName;                                                           // 0x0718 (size: 0x18)
    double RotationSpeed_Pad;                                                         // 0x0730 (size: 0x8)
    double RotationSpeed_MouseDrag;                                                   // 0x0738 (size: 0x8)
    double ZoomSpeed_Pad;                                                             // 0x0740 (size: 0x8)
    double ZoomRate_WheelTrigger;                                                     // 0x0748 (size: 0x8)
    double CachedAnalogValueX;                                                        // 0x0750 (size: 0x8)
    double CachedAnalogValueY;                                                        // 0x0758 (size: 0x8)
    FVector CameraRelativeLocation;                                                   // 0x0760 (size: 0x18)
    bool IsMLBDown;                                                                   // 0x0778 (size: 0x1)
    double MaxZoomCameraOffset_BodySetting;                                           // 0x0780 (size: 0x8)
    double MaxZoomCameraOffset_HeadSetting;                                           // 0x0788 (size: 0x8)
    FDataTableRowHandle CompleteCheckMsgID;                                           // 0x0790 (size: 0x10)
    bool IsRTriggerDown;                                                              // 0x07A0 (size: 0x1)
    bool IsLTriggerDown;                                                              // 0x07A1 (size: 0x1)
    double CameraUpDownSpeed_ForPad;                                                  // 0x07A8 (size: 0x8)
    class UPalHUDDispatchParameter_FadeWidget* FadeOutParameter;                      // 0x07B0 (size: 0x8)
    FVector DefaultHeadCameraLocation;                                                // 0x07B8 (size: 0x18)
    FVector DefaultBodyCameraLocation;                                                // 0x07D0 (size: 0x18)
    FPalDataTableRowName_UIInputAction ToggleEquipDisplayInputAction;                 // 0x07E8 (size: 0x8)
    FPalDataTableRowName_UIInputAction PlaySampleVoiceInInputAction;                  // 0x07F0 (size: 0x8)
    FPalUIActionBindData PlaySampleVoiceActionHandle;                                 // 0x07F8 (size: 0x4)
    bool IsCachingMakeData;                                                           // 0x07FC (size: 0x1)
    class UBP_PalPlayerDataCharacterMake_C* CharacterMakeData;                        // 0x0800 (size: 0x8)
    FName flagName;                                                                   // 0x0808 (size: 0x8)
    bool NowDisplayEquip;                                                             // 0x0810 (size: 0x1)
    bool bCompletedMake;                                                              // 0x0811 (size: 0x1)
