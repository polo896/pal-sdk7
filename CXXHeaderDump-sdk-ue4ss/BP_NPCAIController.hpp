...
class ABP_NPCAIController_C : public APalAIController
{
    ...
    class UBP_OtomoPalHolderComponentForNPC_C* BP_OtomoPalHolderComponentForNPC;      // 0x0570 (size: 0x8)
    class UPalAISensorComponent* PalAISensor;                                         // 0x0578 (size: 0x8)
    class UBP_AIADamageReaction_C* BP_AIADamageReaction;                              // 0x0580 (size: 0x8)
    TSubclassOf<class UPalAIActionBase> DefaultActionClass;                           // 0x0588 (size: 0x8)
    class UPalNPCAIWeaponHandle* WeaponHandle;                                        // 0x0590 (size: 0x8)
    class UBP_PalIncidentNotifyListener_C* IncidentNotifyListener;                    // 0x0598 (size: 0x8)
    TArray<FName> Filter Incident Ids;                                                // 0x05A0 (size: 0x10)
    FF_NPC_PathWalkArray PathWalk;                                                    // 0x05B0 (size: 0x10)
    FName OtomoName;                                                                  // 0x05C0 (size: 0x8)
    TSubclassOf<class UPalNPCAIWeaponHandle> WeaponHandleClass;                       // 0x05C8 (size: 0x8)
    bool DisableDropItem;                                                             // 0x05D0 (size: 0x1)
