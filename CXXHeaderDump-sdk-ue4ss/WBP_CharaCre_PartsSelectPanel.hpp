...
class UWBP_CharaCre_PartsSelectPanel_C : public UUserWidget
{
    ...
    TMap<FName, UWBP_CharaCre_PartsSelect_sq_C*> ButtonMap;                           // 0x0298 (size: 0x50)
    ...
    void AddPreset(FName PresetName, TSoftObjectPtr<class UTexture2D> SoftIconTexture);
    void AddMeshPresets(TMap<FName, FPalCharacterCreationMeshPresetDataRow> PresetMap);
    void Construct();
