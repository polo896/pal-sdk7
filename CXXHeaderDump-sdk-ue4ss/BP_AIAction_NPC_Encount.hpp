...
class UBP_AIAction_NPC_Encount_C : public UPalAIActionBase
{
    ...
    class AActor* TrgetActor;                                                         // 0x0140 (size: 0x8)
    bool Propagation;                                                                 // 0x0148 (size: 0x1)
    class UPalShooterComponent* Shooter;                                              // 0x0150 (size: 0x8)
    class UBP_OtomoPalHolderComponent_C* OtomoHolder;                                 // 0x0158 (size: 0x8)
