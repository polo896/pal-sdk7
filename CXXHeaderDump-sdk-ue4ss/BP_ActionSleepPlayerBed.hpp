...
class UBP_ActionSleepPlayerBed_C : public UPalAction_SleepPlayerBed
{
    ...
    bool IsNightSkipStarted;                                                          // 0x0210 (size: 0x1)
    double FadeInTime;                                                                // 0x0218 (size: 0x8)
    double FadeOutTime;                                                               // 0x0220 (size: 0x8)
    float SleepEndDelay;                                                              // 0x0228 (size: 0x4)
    bool IsSleeping;                                                                  // 0x022C (size: 0x1)
    FName flagName;                                                                   // 0x0230 (size: 0x8)
    bool GetupDelay;                                                                  // 0x0238 (size: 0x1)
    float GetupPlayerCameraAngleX;                                                    // 0x023C (size: 0x4)
    float GetupPlayerCameraAngleZ;                                                    // 0x0240 (size: 0x4)
    class ABP_PlayerBedCamera_C* BedCamera;                                           // 0x0248 (size: 0x8)
    class AActor* PrevViewTarget;                                                     // 0x0250 (size: 0x8)
    bool IsFade;                                                                      // 0x0258 (size: 0x1)
