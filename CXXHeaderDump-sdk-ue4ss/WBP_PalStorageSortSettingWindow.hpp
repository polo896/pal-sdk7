...
class UWBP_PalStorageSortSettingWindow_C : public UPalUIPalBoxSortWindow
{
    ...
    TMap<class EPalElementType, class UWBP_PalStorageSortElementFilterCheckBox_C*> ElementTypeCheckBoxMap; // 0x0620 (size: 0x50)
    TArray<class UWBP_PalStorageSortTypeButton_C*> SortTypeButtonArray;               // 0x0670 (size: 0x10)
    EPalCharacterContainerSortType SelectedSortType;                                  // 0x0680 (size: 0x1)
    TMap<class EPalWorkSuitability, class UWBP_PalStorageSortWorkSuitabilityFilterCheckBox_C*> WorkSuitabilityCheckBoxMap; // 0x0688 (size: 0x50)
