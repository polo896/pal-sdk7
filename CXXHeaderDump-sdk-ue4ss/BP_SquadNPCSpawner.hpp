...
class ABP_SquadNPCSpawner_C : public ABP_MonoNPCSpawner_C
{
    ...
    TArray<UPalIndividualCharacterHandle*> SpawnedHandleList;                         // 0x0610 (size: 0x10)
    TArray<FF_NPCOnePointSpawnInfo> SpawnInfoList;                                    // 0x0620 (size: 0x10)
    bool IsLoadingFlag;                                                               // 0x0630 (size: 0x1)
    TArray<UPalIndividualCharacterHandle*> SpawnedOtomoHandleList;                    // 0x0638 (size: 0x10)
    ...
    TArray<UPalIndividualCharacterHandle*> Handles;                                   // 0x0660 (size: 0x10)
