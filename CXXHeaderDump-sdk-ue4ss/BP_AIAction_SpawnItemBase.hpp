...
class UBP_AIAction_SpawnItemBase_C : public UPalAIActionBase
{
    ...
    int32 SpawnCount;                                                                 // 0x0140 (size: 0x4)
    class APalCharacter* ActionCharacter;                                             // 0x0148 (size: 0x8)
    FPalStaticItemIdAndNum SpawnItemInfo;                                             // 0x0150 (size: 0xC)
    FName SpawnSocketName;                                                            // 0x015C (size: 0x8)
    FVector SpawnLocationOffset;                                                      // 0x0168 (size: 0x18)
    FRotator SpawnItemRotator;                                                        // 0x0180 (size: 0x18)
