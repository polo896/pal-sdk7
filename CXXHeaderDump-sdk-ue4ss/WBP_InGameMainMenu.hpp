...
class UWBP_InGameMainMenu_C : public UPalUserWidgetOverlayUI
{
    ...
    class UCanvasPanel* CanvasPanel_106;                                              // 0x0488 (size: 0x8)
    class UWBP_MainMenu_C* WBP_MainMenu;                                              // 0x0490 (size: 0x8)
    class UWBP_MainMenu_bg_C* WBP_MainMenu_bg;                                        // 0x0498 (size: 0x8)
    class UWBP_Menu_btn_C* WBP_Menu_btn;                                              // 0x04A0 (size: 0x8)
    class UPalUserWidget* CurrentContentWidget;                                       // 0x04A8 (size: 0x8)
    FPalDataTableRowName_UIInputAction NextTabActionName;                             // 0x04B0 (size: 0x8)
    FPalDataTableRowName_UIInputAction PrevTabActionName;                             // 0x04B8 (size: 0x8)
    FPalDataTableRowName_UIInputAction CloseMenuActionName;                           // 0x04C0 (size: 0x8)
    TMap<TEnumAsByte<EPalUIInGameMainMenuTabType::Type>, FDataTableRowHandle> TitleMsgIDMap; // 0x04C8 (size: 0x50)
    bool LockCurrentTab;                                                              // 0x0518 (size: 0x1)
    bool bDisableCancelOnce;                                                          // 0x0519 (size: 0x1)
    FWBP_InGameMainMenu_COnRequestOpenMap_ByQuest OnRequestOpenMap_ByQuest;           // 0x0520 (size: 0x10)
    void OnRequestOpenMap_ByQuest(FName QuestId);
    FPalDataTableRowName_UIInputAction OpenCharacterMenuActionName_Another;           // 0x0530 (size: 0x8)
    TEnumAsByte<EPalUIInGameMainMenuTabType::Type> CurrentTabType;                    // 0x0538 (size: 0x1)
    FPalDataTableRowName_UIInputAction OpenPalStatusActionName;                       // 0x053C (size: 0x8)
