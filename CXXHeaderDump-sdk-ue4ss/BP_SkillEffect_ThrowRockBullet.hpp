...
class ABP_SkillEffect_ThrowRockBullet_C : public APalSkillEffectBase
{
    ...
    double Speed;                                                                     // 0x0370 (size: 0x8)
    double AddImplse;                                                                 // 0x0378 (size: 0x8)
    TSubclassOf<class AActor> GroundEffect;                                           // 0x0380 (size: 0x8)
    FBP_SkillEffect_ThrowRockBullet_CNewEventDispatcher_0 NewEventDispatcher_0;       // 0x0388 (size: 0x10)
    void NewEventDispatcher_0();
    TSubclassOf<class AActor> PredictedTargetClass;                                   // 0x0398 (size: 0x8)
    class AActor* PredictedTarget;                                                    // 0x03A0 (size: 0x8)
    float PredictPowerRate;                                                           // 0x03A8 (size: 0x4)
    bool NearTarget;                                                                  // 0x03AC (size: 0x1)
    FVector Out Launch Velocity;                                                      // 0x03B0 (size: 0x18)
