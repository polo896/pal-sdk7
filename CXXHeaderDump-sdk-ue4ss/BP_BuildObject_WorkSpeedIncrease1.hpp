#ifndef UE4SS_SDK_BP_BuildObject_WorkSpeedIncrease1_HPP
#define UE4SS_SDK_BP_BuildObject_WorkSpeedIncrease1_HPP

class ABP_BuildObject_WorkSpeedIncrease1_C : public APalBuildObject
{
    class UBP_BuildObjectSimulateArrowComponent_C* BP_BuildObjectSimulateArrowComponent; // 0x0750 (size: 0x8)
    class UPalMapObjectBaseCampPassiveEffectAllWorkSpeedParameterComponent* PalMapObjectBaseCampPassiveEffectAllWorkSpeedParameter; // 0x0758 (size: 0x8)
