...
class UBP_AIAction_OtomoFollow_C : public UPalAIActionBase
{
    ...
    class APawn* SelfActor;                                                           // 0x0148 (size: 0x8)
    bool IsMoveMode;                                                                  // 0x0150 (size: 0x1)
    FVector Destination;                                                              // 0x0158 (size: 0x18)
    double CurrentMoveSpeedRate;                                                      // 0x0170 (size: 0x8)
    class UPalCharacterMovementComponent* Movement;                                   // 0x0178 (size: 0x8)
    double tempDeltaTime;                                                             // 0x0180 (size: 0x8)
    TEnumAsByte<EOtomoFollowState::Type> FollowState;                                 // 0x0188 (size: 0x1)
    double FolowEndDistance;                                                          // 0x0190 (size: 0x8)
    FVector DelayedDestination;                                                       // 0x0198 (size: 0x18)
    double DefaultMaxSpeed;                                                           // 0x01B0 (size: 0x8)
    double ConstMaxSpeedRateVsPlayer;                                                 // 0x01B8 (size: 0x8)
    double CurrentSpeedVsPlayer;                                                      // 0x01C0 (size: 0x8)
    bool IsTurnMode;                                                                  // 0x01C8 (size: 0x1)
    double SprintSpeedVsPlayer;                                                       // 0x01D0 (size: 0x8)
    double DelayedTrainerYawDegree;                                                   // 0x01D8 (size: 0x8)
    double WarpTimer;                                                                 // 0x01E0 (size: 0x8)
    FVector PreSelfLocation;                                                          // 0x01E8 (size: 0x18)
    bool JumpAble;                                                                    // 0x0200 (size: 0x1)
    bool PlayerDelayJumpAble;                                                         // 0x0201 (size: 0x1)
    bool IsForceFitGoal;                                                              // 0x0202 (size: 0x1)
    float TargetLocationDistanceForward;                                              // 0x0204 (size: 0x4)
    float TargetLocationDistanceRight;                                                // 0x0208 (size: 0x4)
    int32 DebugType;                                                                  // 0x020C (size: 0x4)
