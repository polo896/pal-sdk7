#ifndef UE4SS_SDK_SK_SkyDragon_Skeleton_AnimBlueprint_UJP_HPP
#define UE4SS_SDK_SK_SkyDragon_Skeleton_AnimBlueprint_UJP_HPP
...
class USK_SkyDragon_Skeleton_AnimBlueprint_UJP_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_SK_SkyDragon_Skeleton_AnimBlueprint_UJP(int32 EntryPoint);
}; // Size: 0x740
