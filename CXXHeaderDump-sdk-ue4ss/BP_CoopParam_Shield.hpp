...
class UBP_CoopParam_Shield_C : public UActorComponent
{
    ...
    class UAnimMontage* ReadyMontage;                                                 // 0x0128 (size: 0x8)
    class UAnimMontage* AttachStartMontage;                                           // 0x0130 (size: 0x8)
    class UAnimMontage* DetachStartMontage;                                           // 0x0138 (size: 0x8)
    FName ShieldCollisionComponentTag;                                                // 0x0140 (size: 0x8)
    bool IsGrabed;                                                                    // 0x0148 (size: 0x1)
