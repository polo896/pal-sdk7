...
public:
	...
	TDelegate<void(const struct FPalInstanceID& ID)> K2Node_CreateDelegate_OutputDelegate_1;         // 0x0014(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class APalCharacter* InCharacter)> K2Node_CreateDelegate_OutputDelegate_2;        // 0x00DC(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FPalInstanceID                         K2Node_CustomEvent_ID;                             // 0x0100(0x0030)(HasGetValueTypeHash)
	class APawn*                                  CallFunc_K2_GetPawn_ReturnValue_3;                 // 0x0130(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class IBPI_GetPalAIBlackboard_C> K2Node_DynamicCast_AsBPI_Get_Pal_AIBlackboard_1; // 0x0138(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class APawn*                                  CallFunc_K2_GetPawn_ReturnValue_4;                 // 0x0170(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalStatusComponent*                    CallFunc_GetComponentByClass_ReturnValue_2;        // 0x0178(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UPalStatusBase*                         CallFunc_GetExecutionStatus_ReturnValue;           // 0x0180(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UBP_Status_HPLock_C*                    K2Node_DynamicCast_AsBP_Status_HPLock;             // 0x0188(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
