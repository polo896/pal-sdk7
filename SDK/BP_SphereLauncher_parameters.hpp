...
public:
	...
	TDelegate<void(EPalPlayerInventoryType inventoryType, int32 Index)> K2Node_CreateDelegate_OutputDelegate_1; // 0x0014(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
