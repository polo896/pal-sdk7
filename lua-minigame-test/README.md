...
**Авторзакрытие UI (новое в v0.3).** Завершение мини-игры (`OnMiniGameComplete` → RPC → замок)
...
ждёт `CloseCheckMs` (2.2 с): если `OnMiniGameComplete` не пришёл — закрывает все живые инстансы
