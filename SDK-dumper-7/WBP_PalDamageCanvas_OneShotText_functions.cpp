...
// Parameters:
// const struct FPalDamageDisplayEntry&    EntryData                                              (BlueprintVisible, BlueprintReadOnly, Parm)

void UWBP_PalDamageCanvas_OneShotText_C::Add_New_Damage_Text(const struct FPalDamageDisplayEntry& EntryData)
{
...
void UWBP_PalDamageCanvas_OneShotText_C::AddDamageTextEvent(const struct FPalDamageDisplayEntry& EntryData)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// int32                                   DIsplayDamage                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const struct FFixedPoint64&             OldHP                                                  (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
// bool*                                   bKill                                                  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_PalDamageCanvas_OneShotText_C::IsKillShot(int32 DIsplayDamage, const struct FFixedPoint64& OldHP, bool* bKill)
{
	static class UFunction* Func = nullptr;
