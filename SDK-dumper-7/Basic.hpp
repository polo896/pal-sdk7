...
namespace Offsets
{
	constexpr int32 GObjects          = 0x09520990;
	constexpr int32 AppendString      = 0x034EADA0;
	constexpr int32 GNames            = 0x09425EF8;
	constexpr int32 GWorld            = 0x0968F240;
	constexpr int32 ProcessEvent      = 0x03669B00;
