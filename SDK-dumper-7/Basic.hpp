...
namespace Offsets
{
	constexpr int32 GObjects          = 0x094F8910;
	constexpr int32 AppendString      = 0x034CF030;
	constexpr int32 GNames            = 0x093FDE78;
	constexpr int32 GWorld            = 0x09667260;
	constexpr int32 ProcessEvent      = 0x0364D960;
