...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// int32                                   CacheStep                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_Map_Body_C::SetupZoomCache(int32 CacheStep)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Map_Body_C", "SetupZoomCache");

	Params::WBP_Map_Body_C_SetupZoomCache Parms{};

	Parms.CacheStep = CacheStep;
...
void UWBP_Map_Body_C::Adjust_Zoom_Default()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Map_Body_C", "Adjust Zoom Default");
