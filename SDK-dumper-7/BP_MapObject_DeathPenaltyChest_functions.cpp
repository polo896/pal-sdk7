...
void ABP_MapObject_DeathPenaltyChest_C::GetInteractWidget(class UPalUserWidget** createdWidget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_MapObject_DeathPenaltyChest_C", "GetInteractWidget");

	Params::BP_MapObject_DeathPenaltyChest_C_GetInteractWidget Parms{};
