...
// Parameters:
// const TSet<EPalLocationType>&           Filter                                                 (BlueprintVisible, BlueprintReadOnly, Parm)

void UWBP_MapFilter_Win_C::Setup(const TSet<EPalLocationType>& Filter)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_MapFilter_Win_C", "Setup");

	Params::WBP_MapFilter_Win_C_Setup Parms{};
