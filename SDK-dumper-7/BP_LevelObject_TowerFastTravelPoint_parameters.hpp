...
public:
	...
	struct FPalOptionWorldSettings                K2Node_CustomEvent_PrevSettings;                   // 0x0038(0x0210)(ConstParm)
	struct FPalOptionWorldSettings                K2Node_CustomEvent_NewSettings;                    // 0x0248(0x0210)(ConstParm)
	struct FPalOptionWorldSettings                CallFunc_GetOptionWorldSettings_ReturnValue;       // 0x0458(0x0210)(ConstParm)
...
{
public:
	struct FPalOptionWorldSettings                PrevSettings;                                      // 0x0000(0x0210)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	struct FPalOptionWorldSettings                NewSettings;                                       // 0x0210(0x0210)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
