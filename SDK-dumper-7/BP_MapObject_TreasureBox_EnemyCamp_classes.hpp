...
// BlueprintGeneratedClass BP_MapObject_TreasureBox_EnemyCamp.BP_MapObject_TreasureBox_EnemyCamp_C
// 0x0078 (0x04C8 - 0x0450)
class ABP_MapObject_TreasureBox_EnemyCamp_C final : public APalMapObjectTreasureBox
{
public:
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_MapObject_TreasureBox_EnemyCamp_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_MapObject_TreasureBox_EnemyCamp_C")
	}
	static class ABP_MapObject_TreasureBox_EnemyCamp_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_MapObject_TreasureBox_EnemyCamp_C>();
	}
};
DUMPER7_ASSERTS_ABP_MapObject_TreasureBox_EnemyCamp_C;
