...
// BlueprintGeneratedClass BP_BuildObject_HugeKitchen.BP_BuildObject_HugeKitchen_C
// 0x0060 (0x07B0 - 0x0750)
class ABP_BuildObject_HugeKitchen_C final : public APalBuildObject
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame;                                    // 0x0750(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UPalWorkFacingComponent*                PalWorkFacing4;                                    // 0x0758(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UPalWorkFacingComponent*                PalWorkFacing3;                                    // 0x0760(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UPalWorkFacingComponent*                PalWorkFacing2;                                    // 0x0768(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UNiagaraComponent*                      NS_CookingSmoke;                                   // 0x0770(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UPalWorkFacingComponent*                PalWorkFacing1;                                    // 0x0778(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_BuildObject_HugeKitchen_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_BuildObject_HugeKitchen_C")
	}
	static class ABP_BuildObject_HugeKitchen_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_BuildObject_HugeKitchen_C>();
	}
};
DUMPER7_ASSERTS_ABP_BuildObject_HugeKitchen_C;
