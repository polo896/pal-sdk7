...
void UWBP_Title_MenuButton_C::SetAttention(bool bEnableAttention)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Title_MenuButton_C", "SetAttention");

	Params::WBP_Title_MenuButton_C_SetAttention Parms{};
