...
void UWBP_Title_WorldSettings_ListContent_C::AddText(const class FText& newText)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Title_WorldSettings_ListContent_C", "AddText");

	Params::WBP_Title_WorldSettings_ListContent_C_AddText Parms{};
