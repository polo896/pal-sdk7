...
public:
	...
	struct FPalLogAdditionalData                  K2Node_Event_inAdditionalData;                     // 0x0078(0x0078)(ConstParm)
	TSoftObjectPtr<class UTexture2D>              CallFunc_Array_Get_Item;                           // 0x00F0(0x0030)(HasGetValueTypeHash)
	...
	bool                                          CallFunc_Greater_IntInt_ReturnValue_1;             // 0x0125(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class UObject* Loaded)>        K2Node_CreateDelegate_OutputDelegate_2;            // 0x0148(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
