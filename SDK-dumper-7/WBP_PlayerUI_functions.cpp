...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    bIsSpotAiming                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_PlayerUI_C::OnChangeAimFishingSpot(bool bIsSpotAiming)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PlayerUI_C", "OnChangeAimFishingSpot");

	Params::WBP_PlayerUI_C_OnChangeAimFishingSpot Parms{};

	Parms.bIsSpotAiming = bIsSpotAiming;
