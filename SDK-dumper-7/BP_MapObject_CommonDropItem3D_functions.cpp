...
#include "BP_MapObject_CommonDropItem3D_classes.hpp"
#include "BP_MapObject_CommonDropItem3D_parameters.hpp"
...
// const struct FVector&                   CenterOfMass                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// TArray<class UMaterialInterface*>&      Material                                               (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void ABP_MapObject_CommonDropItem3D_C::SetupStaticMesh(class UStaticMesh* InStaticMesh, const struct FVector& CenterOfMass, TArray<class UMaterialInterface*>& Material)
{
	static class UFunction* Func = nullptr;
