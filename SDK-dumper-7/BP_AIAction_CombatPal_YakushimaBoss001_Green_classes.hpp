...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_AIAction_CombatPal_YakushimaBoss001_Green_C; // 0x0238(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	...
	TArray<EPalWazaID>                            WazaRoutineList;                                   // 0x0248(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
