...
public:
	...
	class UWBP_AssignBoard_C*                     WBP_AssignBoard;                                   // 0x0490(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	TSoftObjectPtr<class UWBP_AssignBoard_WorkListBase_C> LastSelectedWorkListContentWidget;         // 0x0498(0x0030)(Edit, BlueprintVisible, DisableEditOnInstance, InstancedReference, HasGetValueTypeHash)
	TSoftObjectPtr<class UWBP_AssignBoard_WorkListBase_C> LastHoveredWorkListContentWidget;          // 0x04C8(0x0030)(Edit, BlueprintVisible, DisableEditOnInstance, InstancedReference, HasGetValueTypeHash)
	EPalUIFixedAssignManageListSortType           NowSortType;                                       // 0x04F8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4F9[0x7];                                      // 0x04F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<EPalUIFixedAssignManageListSortType>   SortTypeOrder;                                     // 0x0500(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	TMap<EPalUIFixedAssignManageListSortType, struct FDataTableRowHandle> SortTypeNameMap;           // 0x0510(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FPalDataTableRowName_UIInputAction     SortInputAction;                                   // 0x0560(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
