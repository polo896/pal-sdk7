...
void UWBP_MapFilter_Content_C::SetEnable(bool IsEnable)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_MapFilter_Content_C", "SetEnable");

	Params::WBP_MapFilter_Content_C_SetEnable Parms{};
