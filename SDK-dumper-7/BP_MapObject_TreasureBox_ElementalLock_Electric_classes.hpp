...
// Package: BP_MapObject_TreasureBox_ElementalLock_Electric
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_MapObject_TreasureBox_ElementalLock_Electric_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_MapObject_TreasureBox_ElementalLock_Electric_C")
	}
	static class ABP_MapObject_TreasureBox_ElementalLock_Electric_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_MapObject_TreasureBox_ElementalLock_Electric_C>();
	}
};
DUMPER7_ASSERTS_ABP_MapObject_TreasureBox_ElementalLock_Electric_C;
